...
**Neutralitets-moaten (GRUNDARBESLUT 2026-06-19, icke-förhandlingsbart):** Arvo tar
ALDRIG en kickback, provision, partner-fee eller någon annan ersättning från en
leverantör — inte nu, inte efter bolagsregistrering, aldrig. **Vår enda intäktskälla
är success fee från kunden.** Vi är kundens obundna finansiella livvakt; i samma sekund
vi tjänar en krona på att styra en kund mot en leverantör är vår oberoende röst — och
därmed hela Zero Trust-vallgraven — död. Detta är regel 1 på affärsmodellsnivå och väger
lika tungt som integriteten (regel 1–9).

Konsekvens i koden: partner-/återförsäljarmodellen är **avgjord och förkastad**.
`licenseTierBenchmarks.arvoAnnual` (den förberedda partnerpris-vägen) ska aldrig fyllas
— allt vi visar är och förblir verifierade **publika** listpriser. Att använda en
leverantörs *publika* prislista som ankare (t.ex. Dustins publika SEK-shop, Tele2:s
listpris) är fortfarande tillåtet och önskat — det är öppen data, inte ett partnerskap.
Gränsen är knivskarp: **publik prisdata = ja; ersättning, rabatt-mot-volym eller
...
> kickback, provision eller partner-fee från en leverantör. Enda intäkten är success fee
> från kunden (se Affärsmodell). Skälet: oberoendet ÄR produkten — säljer vi vår röst
> dödar vi Zero Trust-vallgraven i samma sekund. `arvoAnnual`-vägen fylls aldrig;
> verifierade **publika** listpriser är och förblir enda ankaret. Att skrapa en
> leverantörs *publika* prislista (Dustin, Tele2 m.fl.) är öppen data och fortsatt OK —
> ett *partnerskap/ersättning* är det aldrig. Låst i bibeln (Affärsmodell) + maskinvakt
> (`scripts/claims-audit.mjs` blockerar leverantörsersättnings-/partnerskaps-copy i
> kundytor). Frågan är stängd.
