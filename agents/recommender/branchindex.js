...
export const BRANCHINDEX = {
  el: {
    ...
    eurostatBands: {
      ...
      lastVerified: '2026-08-31', basis: 'icke-hushåll, SE, allt-in exkl. moms',
      unit: 'kr_per_kwh',
      bands: [
  ...
  'saas-productivity': {
    ...
    licenseTierBenchmarks: {
      ...
      'business-basic': {
        ...
        currency: 'SEK', lastVerified: '2026-08-24', source: 'microsoft.com',
      ...
      'slack-pro': {
        ...
        currency: 'USD', lastVerified: '2026-08-31', source: 'slack.com/pricing',
      ...
      'zoom-pro': {
        ...
        currency: 'USD', lastVerified: '2026-08-24', source: 'zoom.us/pricing',
      ...
      'atlassian-jira-standard': {
        ...
        currency: 'USD', lastVerified: '2026-08-24', source: 'atlassian.com/software/jira/pricing',
      ...
      'atlassian-confluence-standard': {
        ...
        currency: 'USD', lastVerified: '2026-08-24', source: 'atlassian.com/software/confluence/pricing',
  ...
  'saas-creative': {
    ...
    adobeVerified: {
      source: 'adobe.com/se', method: 'stealth (playwright-extra)', lastVerified: '2026-08-24',
  ...
  'saas-crm': {
    ...
    licenseTierBenchmarks: {
      ...
      'zoho-crm-standard': {
        ...
        currency: 'USD', lastVerified: '2026-08-24', source: 'zoho.com/crm/zohocrm-pricing.html',
  ...
  'saas-finance': {
    ...
    fortnoxVerified: {
      source: 'fortnox-prislista', lastVerified: '2026-08-24', unit: 'kr_per_manad_exkl_moms',
