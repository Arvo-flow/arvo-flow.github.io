...
export const BRANCHINDEX = {
  el: {
    ...
    eurostatBands: {
      ...
      lastVerified: '2026-09-14', basis: 'icke-hushåll, SE, allt-in exkl. moms',
      unit: 'kr_per_kwh',
      bands: [
  ...
  'saas-productivity': {
    ...
    licenseTierBenchmarks: {
      ...
      'business-basic': {
        ...
        currency: 'SEK', lastVerified: '2026-09-14', source: 'microsoft.com',
      ...
      'slack-pro': {
        ...
        currency: 'USD', lastVerified: '2026-09-14', source: 'slack.com/pricing',
