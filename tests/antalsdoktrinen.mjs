...
// Lexern bor i `lib/kalltextlexer.js` sedan 2026-09-10 — FX-vakten behövde samma tjänst, och
// två kopior glider isär (regel 1). Re-exporten står kvar så AD-07/AD-08 och varje befintlig
// anropare når den på oförändrad adress; bevisen för lexern ÄGS fortfarande av den här filen.
// ⚠️ `export { x } from …` RE-EXPORTERAR UTAN att skapa en lokal bindning — filen använder
// funktionen själv på tre ställen, och AD-01/06/07/08 föll direkt. Import + export, alltså.
import { strippaStrangar } from '../lib/kalltextlexer.js';
export { strippaStrangar };
