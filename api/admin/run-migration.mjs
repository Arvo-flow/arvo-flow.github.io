...
export default async function handler(req, res) {
  ...
  const steps = [
    ...
    // Pipedrive — USD
    // RÄTTAD 2026-08-05: Pipedrive säljer inte längre Essential/Advanced (live-lineup: Lite/Growth/
    // Premium/Ultimate) och talen här motsade branchindex — samma produkt, två sanningar i samma repo.
    { name: 'seed:pipedrive-lite', run: () => upsertPrice({ supplier:'pipedrive', product:'Pipedrive Lite',    tier:'lite',    category:'saas-crm', usdMonthly:14.00, usdAnnual:14.00, priceUnit:'per_seat', currency:'USD', sourceType:'official_web', sourceUrl:'https://www.pipedrive.com/en/pricing', confidence:0.95, lastVerified:'2026-08-05', changedBy:'migration' }) },
    { name: 'seed:pipedrive-growth', run: () => upsertPrice({ supplier:'pipedrive', product:'Pipedrive Growth',     tier:'growth',     category:'saas-crm', usdMonthly:39.00, usdAnnual:39.00, priceUnit:'per_seat', currency:'USD', sourceType:'official_web', sourceUrl:'https://www.pipedrive.com/en/pricing', confidence:0.95, lastVerified:'2026-08-05', changedBy:'migration' }) },
