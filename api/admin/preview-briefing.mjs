      ...
      insights: [
        {
          ...
          type:        'recommendation',
          headline:    'Byte från Microsoft 365: 18 400 kr/år netto',
          subheadline: 'Räknat mot verifierat publikt listpris vid analysen den 3 september.',
          metric: {
        ...
        },
        {
          id:          crypto.randomUUID(),
          type:        'cost_trend',
          headline:    'Kostnaden hos Telia ökade 9 % sedan förra månaden',
          subheadline: 'Från 124 800 kr/år till 136 080 kr/år, räknat på två fakturor.',
          metric: {
            primary:   { value: 9,      label: '% högre kostnad' },
