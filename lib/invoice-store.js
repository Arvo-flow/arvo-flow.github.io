...
export async function storeAnalysis({
  ...
  try {
    ...
    if (id && extracted?.invoiceNumber) {
      ...
      } catch { /* kolumn ej migrerad än → numret visas när migreringen körts */ }
    }
  ...
  try {
    return await db`
      SELECT
        ...
        seat_count, price_per_seat_monthly, lead_finding_json, contract_end_date, health_score, triage_reason, contract_terms_json
