...
export const EJ_PENGAR = Object.freeze({
  ...
  tryckkurs:        'fakturans EGEN tryckta växelkurs (lib/tryckkurs.js) — samma skäl som fxRate, '
    + 'och dessutom en avläsning av pappret som aldrig får röras av en beräkning',
  tryckkursRad:     'citatet ur textlagret som kursen lästes ur — en sträng, inte ett belopp',
