 ...
 * `agare_epost`; då är avsändaren inte identiteten. Utan fingerprint gäller den gamla vägen: avsändaren.
 * Ren funktion — drainen och testerna frågar samma sak.
 */
export function jobbIdentitet(job, sha16) {
  if (job?.fingerprint) {
    const e = typeof job.agare_epost === 'string' && job.agare_epost.includes('@') ? job.agare_epost : null;
