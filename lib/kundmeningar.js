...
export const LOFTEN = {
  ...
  // RUMMETS EGEN ADRESS (2026-09-24): mottagaradressen är identiteten (lib/inkorgsadress.js, IA-01..10).
  egenAdress: {
    text: 'Allt som kommer till er adress hamnar i det här rummet och analyseras — vem som än skickar det.',
    mekanism: ['api/inbound-email.mjs', 'lib/inkorgsadress.js', 'api/inkorgsadress.mjs'],
  },
  gmailKod: {
    text: 'När Gmail skickar sin bekräftelsekod till er adress visar vi den här, så slipper ni leta efter den.',
    mekanism: ['api/inbound-email.mjs', 'api/inkorgsadress.mjs'],
  },
  personligtSvar: {
...
export const LOFTEN_UTAN_MEKANISM = [
  ...
  { monster: /resten av boken|hela (leverantörs)?reskontran|varenda avtal ni har|vad vi gjort åt det/i, skal: 'vakten ser bara det kunden skickat — hela boken kräver Fortnox-kopplingen, som inte är byggd' },
