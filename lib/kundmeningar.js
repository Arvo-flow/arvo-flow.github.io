...
export const LOFTEN = {
  ...
  inkorgskoppling: {
    ...
    mekanism: ['api/auth/gmail-callback.mjs', 'api/auth/outlook-callback.mjs'],
  },
  ...
  gratisanalys: {
    text: 'Utan abonnemang analyserar vi de fakturor ni laddar upp eller vidarebefordrar, och svarar på dem — däremellan skickar vi inga utskick.',
...
export const LOFTEN_UTAN_MEKANISM = [
  ...
  { monster: /söker (igenom )?er inkorg|bevakar (nu )?er inkorg|söker igenom era leverantörsfakturor|briefing inom en timme|arvo hittar allt/i, skal: 'ingen kod läser inkorgen efter kopplingen — bara en räkning när den görs (LOFTEN.inkorgskoppling)' },
