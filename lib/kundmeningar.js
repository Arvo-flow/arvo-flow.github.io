...
export const LOFTEN_UTAN_MEKANISM = [
  ...
  { monster: /söker (igenom )?er inkorg|bevakar (nu )?er inkorg|söker igenom era leverantörsfakturor|briefing inom en timme/i, skal: 'ingen kod läser inkorgen efter kopplingen — bara en räkning när den görs (LOFTEN.inkorgskoppling)' },
