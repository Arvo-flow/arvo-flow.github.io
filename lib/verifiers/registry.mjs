...
import teliaVaxel from './telia-vaxel.mjs';
import fortnoxLon from './fortnox-lon.mjs';
import slack from './slack.mjs';
import zoom from './zoom.mjs';
import atlassian from './atlassian.mjs';
import hubspot from './hubspot.mjs';
import zohoCrm from './zoho.mjs';
import pipedrive from './pipedrive.mjs';
// Villkorsvakten: samma fabrik, men riktad mot AVTALSREGLERNA i stället för priser.
// Prisboken fick 17 vakter efter 16 obevakade dygn; villkorsboken hade noll — trots att den
// styr uppsägningsdatumet, där ett fel inte går att ta tillbaka.
import villkorsbok from './villkorsbok.mjs';
