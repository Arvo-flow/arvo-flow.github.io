...
// Riktiga gatuadresser maximerar träffbilden — flera transportörer kräver en serviceadress
// (inte bara postnummer) för att returnera en offert.
const REPRESENTATIVE = {
  fromStreet: 'Sveavägen 44', fromZip: '11134', fromCity: 'Stockholm',
  toStreet: 'Kungsportsavenyen 1', toZip: '41136', toCity: 'Göteborg',
  weightKg: 5, valueSek: 1000,
};
