...
export default {
  ...
  bevakadeTiers: TIERS.map(([, key]) => key),
  ...
  fangar: 'Google ändrar sitt publika USD-listpris på workspace.google.com.',
  blind: 'Svensk SEK-prissättning — Google publicerar inget publikt SEK-pris, så en förändring som bara slår mot svenska kunder är osynlig för vakten (därav google-sek-grinden).',
  needsBrowser: false,
  schedule: '30 5 * * 1',
  async run() {
