...
const TIER_NYCKEL = 'zoho-crm-standard';
...
export default {
  ...
  bevakadKategori: 'saas-crm',
  // VAKTKONTRAKTET (lib/vaktkontrakt.js): den fråga som ska ställas innan något kallas vakt.
  fangar: 'Zoho ändrar Standard-planens publika USD-listpris.',
  blind: 'Regionala prislistor (t.ex. indisk eller EU-specifik vy) som kan avvika från den sida vakten läser.',
  needsBrowser: true,
  schedule: '0 5 * * 1',
  async run() {
