...
export const ENDPOINTYTOR = {
  ...
  'api/auth/gmail-callback.mjs': { klass: 'mejlyta', skal: 'OAuth-retur; kundens text är kopplingsmejlet (LOFTEN.inkorgskoppling)' },
  'api/auth/gmail-init.mjs': { klass: 'ingen_prisdom', skal: 'omdirigering till Googles samtycke' },
  ...
  'api/cron/drain-ingest.mjs': { klass: 'intern', grind: 'CRON_SECRET', skal: 'köns drain; grinden är fail-open när hemligheten saknas (bibeln, skuld #8)' },
  ...
  'api/cron/send-reminders.mjs': { klass: 'mejlyta',
    skal: 'OGRINDAD, mätt 2026-09-24: vem som helst kan anropa loopen. Varje mejl skickas en gång per analys (sent_at), så ett anrop kan inte skicka ett mejl som inte redan är moget. Grindas med cronAnropTillatet när CRON_SECRET är bekräftad i Vercel — annars nekas Vercels egen cron och påminnelserna tystnar (skuld #8).' },
  ...
  'api/prospect.mjs': { klass: 'oreviderad',
    pastar: 'Serverar prospektbriefingen: samma estimat som prospektmejlet (outbound-estimator → livedata), etiketterna rättade, underlaget inte.' },
  ...
  'api/reveal.mjs': { klass: 'oreviderad',
    pastar: 'Dörrens avslöjande: fynden formuleras i lib/domain-intel.js och lib/business-intel.js, inte i registret. KM-05 skannar deras former (båda ligger i lib/), men meningarna är deras egna.' },
  ...
  'api/track-outcome.mjs': { klass: 'ingen_prisdom',
    skal: 'OGRINDAD skrivväg till arvo_outcomes, mätt 2026-09-24: ingen kundyta och inget arvode läser tabellen (bara den oanropade getCalibrationData). Kandidat för borttagning.' },
