...
export const MEJLYTOR = {
  ...
  'scripts/probe-rumsadress.mjs': { mottagare: 'intern', klass: 'ingen_prisdom', skal: 'mätsond: två mejl med en repo-PDF till Arvos egen mottagningsdomän (inbox.arvoflow.se); svaret går till testidentiteten, aldrig till en kund' },
