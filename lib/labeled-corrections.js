...
export async function getCorrections({ limit = 100, category = null, field = null, correctedBy = null } = {}) {
  ...
  try {
    return await db`
      ...
      LEFT JOIN invoice_analyses ia ON ia.id = lc.analysis_id   -- liggare: internt: flywheelns
      -- few-shot-underlag — raderna blir AI-exempel, aldrig ett kundsynligt tal, och en arkiverad
      -- analys är fortfarande en giltig tolkningslärdom
