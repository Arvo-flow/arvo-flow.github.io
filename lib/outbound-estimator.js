...
async function estimateMobil(segment, sizeBucket, employees, industry) {
  ...
  // Typical cost: prisbokens median när den bär — annars Tele2 Obegränsad 279 kr/mån (24 mån).
  // Arvo-priset är alltid det VERIFIERADE listpriset (Tele2 entré 60 GB, 239 kr/mån) — vårt löfte.
  ...
  const arvoPerSim     = bench.p25;                    // kr/yr per SIM (Tele2 60 GB 239 kr/mån)
  ...
  return {
    ...
    // kundmening-ok: prospektskulden (lib/kundytor.js SKULD) — estimatorn läser kohortens livedata, och texten säger just det
