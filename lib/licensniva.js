...
// `ms\s*365`: «MS 365 Business Standard» tystades medan «MS365 Business Standard» gick igenom —
// samma stavning, olika utfall, av en saknad `\s*` (granskningen 8 sep).
const FAMILJ = /\b(?:microsoft\s*365|microsoft365|m365|ms\s*365)\b/i;
...
const NIVAER = [
  ...
  // ── MODULHUVUDET LOVADE EN REGEL, KODEN KÖRDE TVÅ (rättat 2026-09-08, granskningens fynd 6) ──
  // Här stod familjen INBAKAD i mönstret, alltså krävdes den OMEDELBART INTILL nivån — medan
  // business-nivåerna nöjer sig med `kravFamilj: true`, familjen var som helst i texten. Följden,
  // mätt: «Microsoft 365 Enterprise E3» — produktens OFFICIELLA namn — lästes som null, liksom
  // «M365 Enterprise E3 25 st» och «E3 (Microsoft 365)». Vi tystnade alltså på de rader som är
  // MEST entydiga. Samma krav för alla nivåer nu; «Office 365 E3» stoppas av DISKVALIFICERAR,
  // och ett bart «E3» av kravFamilj — precis som förut.
  { nyckel: 'e3', re: /\bE3\b/i, namn: 'Microsoft 365 E3', kravFamilj: true },
  { nyckel: 'e5', re: /\bE5\b/i, namn: 'Microsoft 365 E5', kravFamilj: true },
];
