...
export const REVIDERADE_KATEGORIER = new Map([
  ...
  ['saas-productivity', 'tests/saas-like-for-like.mjs + tests/saas-tier-detection.mjs + tests/balanskrav.mjs (NMIT 8840219) + tests/google-workspace-recommendation.mjs (google-sek-grind)'],
