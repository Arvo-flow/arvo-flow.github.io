...
// EXPORTERAD (2026-08-24) så att kundmailets grind (lib/larmunderlag.js) kan IMPORTERA
// konfidensgolvet i stället för att kopiera det. En kopia kan glida isär — och då ställer
// kundytan tyst lägre beviskrav än prisboken igen, vilket var hela H2-fyndet.
export const LARMTROSKLAR = Object.freeze({ minConfidence: 0.85 });

const DEFAULTS = {
  minConfidence: LARMTROSKLAR.minConfidence,   // AI-konfidensgolv för 'verified'
