...
export function buildBusinessFindings(facts, { now = new Date() } = {}) {
  ...
  if (k && k.companies >= STORKONCERN_GRANS) {
    f.push({
      ...
      detail: `${k.parentName ? `Närmaste ägare i strukturen: ${k.parentName} — ` : ''}${k.companies} bolag i ägarstrukturen. Ert bokslut och era avtal läser vi för er juridiska enhet — aldrig för portföljen.`,
