...
const FINGERPRINTS = [
  // ── Telekom ───────────────────────────────────────────────────────────────
  {
    ...
    expectedCategories: ['mobil', 'bredband', 'molnvaxel'],
  },
  {
    key: 'telenor',
    namePatterns: [/\btelenor\b/i],
    // Telenor LINK är en molnväxel — fixturen telenor-molnvaxel-stor.pdf finns i test-pdfs/.
    expectedCategories: ['mobil', 'bredband', 'molnvaxel'],
  },
  {
    key: 'tele2',
  ...
  },
  {
    ...
    // Fixturen tre-mobil-molnvaxel.pdf finns i test-pdfs/.
    expectedCategories: ['mobil', 'molnvaxel'],
  },
  {
    key: 'bahnhof',
  ...
  {
    key: 'lime',
    namePatterns: [/\blime\b.*\bcrm\b/i, /\blime technologies\b/i, /\blimecrm\b/i],
    expectedCategories: ['saas-crm'],
  },
  {
    key: 'pipedrive',
    namePatterns: [/\bpipedrive\b/i],
    expectedCategories: ['saas-crm'],
  },
  {
    key: 'superoffice',
    namePatterns: [/\bsuperoffice\b/i],
    expectedCategories: ['saas-crm'],
  },
  {
    key: 'fortnox',
