...
export function resolveContractRules(extracted = {}, villkorsbokPost = null) {
  ...
  if (villkorsbokPost) {
    return { uppsagningstidMan: villkorsbokPost.uppsagningstidMan, forlangningMan: villkorsbokPost.forlangningMan ?? null, kalla: 'villkorsbok' };
  }
  return { uppsagningstidMan: null, forlangningMan: null, kalla: null };
}
