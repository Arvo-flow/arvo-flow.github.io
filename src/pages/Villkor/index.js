    ...
    <Body>
      <Summary>
        ...
        <ul>
          ...
          <li>
            <Icon name="check" size={16} stroke={2.4} />
            <div><strong>Besparingsarvode.</strong> Vi tar ingen fast avgift. Vårt arvode är
      ...
      <Clause>
        ...
        <p><strong>1.3 Besparingsarvode.</strong> Det rörliga arvode om 20 % av Besparingsunderlaget
