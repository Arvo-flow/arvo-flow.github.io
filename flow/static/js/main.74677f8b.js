...
`,Lx=vd.div`
  ...
  margin-bottom: 56px;
  text-align: left;
  animation: ${Dx} 0.75s cubic-bezier(0.34, 1.46, 0.64, 1) both;
  box-shadow:
...
`,_v=vd.div`
  ...
  color: #1B7A6E;
  margin-bottom: 8px;
  animation: ${Tx} 0.55s cubic-bezier(0.34,1.46,0.64,1) both;
`,Nv=vd.h3`
  margin: 0;
  font-family: 'Playfair Display', Georgia, 'Times New Roman', serif;
  font-size: 26px;
