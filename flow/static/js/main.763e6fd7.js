/*! For license information please see main.763e6fd7.js.LICENSE.txt */
...
`,iv=vd.h1`
  ...
  line-height: 1.10;
  letter-spacing: -.02em;
  animation: ${Kx} 0.8s 0.28s both ease-out;
...
`,ov=vd.p`
  ...
  color: rgba(255,255,255,0.45);
  line-height: 1.55;
  animation: ${Kx} 0.8s 0.42s both ease-out;
`,sv=vd.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: 14px;
  animation: ${Kx} 0.8s 0.56s both ease-out;
`,lv=vd.a`
  display: inline-flex;
  align-items: center;
