...
`,Du=["e-postpostur","Bolagsverket","certifikatregistret","dom\xe4nregistret","prisboken"],Fu=Du.join(" \xb7 "),Ou=null!==($u=["noll","ett","tv\xe5","tre","fyra","fem","sex","sju","\xe5tta","nio"][Du.length])&&void 0!==$u?$u:String(Du.length);function Tu(e){let{email:t}=e;const n=(String(t||"").split("@")[1]||"").toLowerCase(),[a,i]=(0,r.useState)(0);return(0,r.useEffect)(()=>{const e=performance.now(),t=setInterval(()=>i((performance.now()-e)/1e3),100);return()=>clearInterval(t)},[]),(0,$d.jsxs)(Au,{"aria-live":"polite",children:[(0,$d.jsxs)("div",{className:"rw-eyebrow",children:["Underlag",n?` \xb7 ${n}`:""]}),(0,$d.jsx)("div",{className:"rw-beam",children:(0,$d.jsx)("span",{})}),(0,$d.jsxs)("div",{className:"rw-status",children:[(0,$d.jsx)("span",{children:"l\xe4ser \xf6ppna k\xe4llor"}),(0,$d.jsxs)("span",{className:"rw-t",children:[a.toFixed(1)," s"]})]}),(0,$d.jsx)("div",{className:"rw-sources",children:Fu}),(0,$d.jsxs)("div",{className:"rw-skel",children:[(0,$d.jsx)("div",{className:"l1",style:{width:"72%"}}),(0,$d.jsx)("div",{className:"l2",style:{width:"92%"}})]}),(0,$d.jsxs)("div",{className:"rw-skel",children:[(0,$d.jsx)("div",{className:"l1",style:{width:"58%"}}),(0,$d.jsx)("div",{className:"l2",style:{width:"84%"}})]}),(0,$d.jsxs)("div",{className:"rw-skel",children:[(0,$d.jsx)("div",{className:"l1",style:{width:"66%"}}),(0,$d.jsx)("div",{className:"l2",style:{width:"78%"}})]})]})}function Pu(e){let{email:t,setEmail:n,onSubmit:r,loading:a,reveal:i,note:o,pending:s,onValjBolag:l}=e;return(0,$d.jsxs)($d.Fragment,{children:[(0,$d.jsxs)(_u,{onSubmit:r,children:[(0,$d.jsx)("div",{className:"rp-k",children:"Innan f\xf6rsta fakturan"}),(0,$d.jsxs)("p",{className:"rp-lede",children:["Era leverant\xf6rer har redan bildat sig en uppfattning om er \u2014 och priss\xe4tter efter den. Skriv in er ",(0,$d.jsx)("b",{children:"f\xf6retagsmejl"}),", s\xe5 visar vi p\xe5 sekunder vad de ser, ur \xf6ppna k\xe4llor."]}),(0,$d.jsxs)("div",{className:"rp-row",children:[(0,$d.jsx)("input",{type:"email",inputMode:"email",autoComplete:"email",placeholder:"namn@ertbolag.se",value:t,onChange:e=>n(e.target.value),disabled:a}),(0,$d.jsx)("button",{type:"submit",disabled:a||!t.trim(),children:a?"\xd6ppnar\u2026":"\xd6ppna underlaget \u2192"})]}),o&&(0,$d.jsx)("p",{className:"rp-note",children:o})]}),a&&(0,$d.jsx)(Tu,{email:t}),!a&&i&&(0,$d.jsx)(Lu,{domain:i.domain,findings:i.findings,pending:s,identity:i.identity,onValjBolag:l})]})}function Lu(e){var t;let{domain:n,findings:a,pending:i,identity:o,onValjBolag:s}=e;const[l,c]=r.useState(!1);if(!n||null===a||void 0===a||!a.length)return null;const d=null!==(t=null===o||void 0===o?void 0:o.candidates)&&void 0!==t?t:[],u=d.length>1&&"function"===typeof s;return(0,$d.jsxs)(Nu,{className:"rv-card",children:[(0,$d.jsxs)("div",{className:"rv-eyebrow",children:["Underlag \xb7 ",n]}),a.map((e,t)=>(0,$d.jsxs)("div",{className:"rv-find",style:{animationDelay:.14*t+"s"},children:[(0,$d.jsx)("div",{className:"rv-title",children:e.title}),e.detail&&(0,$d.jsx)("div",{className:"rv-detail",children:e.detail}),(0,$d.jsxs)("div",{className:"rv-source",children:[(0,$d.jsx)("b",{children:"K\xe4lla:"})," ",e.source]})]},t)),(null===o||void 0===o?void 0:o.confirmedName)&&!l&&(0,$d.jsxs)("p",{className:"rv-ident",children:["G\xe4ller ",(0,$d.jsx)("b",{children:o.confirmedName})," ",(0,$d.jsx)("code",{children:Su(o.confirmed)}),o.byHuman&&" \xb7 bekr\xe4ftat av er",u&&(0,$d.jsxs)($d.Fragment,{children:[". Inte ert bolag?",(0,$d.jsx)("button",{type:"button",onClick:()=>c(!0),children:"Byt \u2192"})]})]}),!(null!==o&&void 0!==o&&o.confirmedName)&&u&&!l&&(0,$d.jsxs)("p",{className:"rv-ident",children:["Vi l\xe4ste allt som g\xe5r utan att veta vilka ni \xe4r. ",(0,$d.jsxs)("b",{children:["Flera bolag heter n\xe5got med"," ",(()=>{const e=n.split(".")[0];return e.charAt(0).toUpperCase()+e.slice(1)})()]}),", och vi gissar aldrig vilket som \xe4r ert.",(0,$d.jsx)("button",{type:"button",onClick:()=>c(!0),children:"S\xe4g vilket \u2014 s\xe5 l\xe4ser vi resten \u2192"})]}),l&&(0,$d.jsxs)("div",{className:"rv-aperture",children:[(0,$d.jsxs)("div",{className:"ap-k",children:[(0,$d.jsx)("span",{children:"Vilket bolag \xe4r ni?"}),(0,$d.jsxs)("span",{children:[o.readCount?`${o.readCount} l\xe4sta \xb7 `:"",d.length," m\xf6jliga"]})]}),d.map((e,t)=>(0,$d.jsxs)("button",{type:"button",className:"ap-row",style:{animationDelay:.07*t+"s"},onClick:()=>{c(!1),s(e.orgnr)},children:[(0,$d.jsx)("span",{className:"ap-org",children:Su(e.orgnr)}),(0,$d.jsxs)("span",{children:[(0,$d.jsx)("span",{className:"ap-namn",children:e.legalName}),(e.ort||e.bransch)&&(0,$d.jsx)("span",{className:"ap-var",children:[e.ort,e.bransch].filter(Boolean).join(" \xb7 ")})]})]},e.orgnr)),(0,$d.jsx)("p",{className:"ap-foot",children:"Vi l\xe4ste hela registret och l\xe4t bli att v\xe4lja \xe5t er \u2014 ett bolagsnamn som liknar en dom\xe4n \xe4r inte ett \xe4garbevis. Ert svar \xe4r det."})]}),i&&(0,$d.jsx)("div",{className:"rv-receipt",style:{borderStyle:"dashed"},children:"Djupare register arbetar fortfarande \u2014 certifikatregistret svarar l\xe5ngsamt. Fler rader kan landa h\xe4r."}),!i&&(0,$d.jsxs)("div",{className:"rv-receipt",children:[(0,$d.jsxs)("b",{children:[Ou," \xf6ppna register"]})," l\xe4sta \u2014 ",Fu," \xb7 innan ni delat n\xe5got"]}),(0,$d.jsxs)("p",{className:"rv-foot",children:["Allt ovan \xe4r ",(0,$d.jsx)("b",{children:"offentlig information"})," \u2014 innan ni loggat in, utan att ni l\xe4mnat ifr\xe5n er n\xe5got. T\xe4nk er vad vakten ser den dag ni delar en faktura."]})]})}const Ru={platform:0,suppliers:1,koncern:2,spoofing:3,business:4,trend:5,cross:6,heritage:7,onboarding:8,domain:9,cert:10,dmarc:11},Iu=new Set(["market","bridge","infra"]);function Bu(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:3;return Array.isArray(e)?e.filter(e=>e&&e.title&&!Iu.has(e.kind)).slice().sort((e,t)=>{var n,r;return(null!==(n=Ru[e.kind])&&void 0!==n?n:99)-(null!==(r=Ru[t.kind])&&void 0!==r?r:99)}).slice(0,t).map(e=>function(e){let t=String(e||"").trim();return t?(t=t.split(/\s+[\u2014\u2013]\s+/)[0],t=t.split(":")[0].trim(),t=t.replace(/^Ni\s+/,"ni "),t.charAt(0).toLowerCase()+t.slice(1)):""}(e.title)).filter(Boolean):[]}const Mu={2:"tv\xe5",3:"tre",4:"fyra",5:"fem",6:"sex",7:"sju",8:"\xe5tta",9:"nio",10:"tio",11:"elva",12:"tolv"};function Uu(e){const t=(e||[]).filter(Boolean).map(e=>{return`att ${t=e,String(t||"").replace(/\b(\d{1,2})\s+(?=[a-z\xe5\xe4\xf6])/g,(e,t)=>{const n=Mu[Number(t)];return n?`${n} `:e})}`;var t});return function(e){const t=(e||[]).filter(Boolean);return 0===t.length?"":1===t.length?t[0]:`${t.slice(0,-1).join(", ")} och ${t[t.length-1]}`}(t)}const Vu=wd.font.mono,Ku=wd.font.display,Hu=wd.dossier,Wu=hd`
...
`,Gu=vd.section`
  ...
  .eyebrow {
    font-family: ${Vu}; font-size: 10px; letter-spacing: .32em; text-transform: uppercase;
  ...
  .proof {
    font-family: ${Vu}; font-size: 9.5px; letter-spacing: .22em; text-transform: uppercase;
...
`,Qu=vd.div`
  ...
  padding-bottom: 15px;
  .k-num {
    font-family: ${Vu}; font-size: 10px; letter-spacing: .3em; text-transform: uppercase;
    color: ${e=>{let{$light:t}=e;return t?wd.color.brand:Hu.teal}};
  }
  .k-note {
    font-family: ${Vu}; font-size: 9px; letter-spacing: .2em; text-transform: uppercase;
...
`,ep=vd.div`
  ...
  .a-plabel { display: block; font-family: ${Vu}; font-size: 9px; letter-spacing: .24em;
  ...
  .a-eyebrow { font-family: ${Vu}; font-size: 9.5px; letter-spacing: .24em; text-transform: uppercase; color: ${Hu.teal};
  ...
  .a-count { font-family: ${Vu}; font-size: 9.5px; color: ${Hu.faintOnDark}; }
  ...
  .a-days { font-family: ${Vu}; font-size: 12px; width: 84px; flex-shrink: 0;
  ...
  .a-caption {
    text-align: center; font-family: ${Vu}; font-size: 9.5px; letter-spacing: .18em;
...
`,ap=vd.div`
  ...
  .pc-k { font-family: ${Vu}; font-size: 9px; letter-spacing: .24em; text-transform: uppercase; }
  .dark .pc-k { color: ${Hu.tealBright}; }
  .lightc .pc-k { color: ${wd.color.brand}; }
  .pc-pris { font-family: ${Vu}; font-size: 26px; margin: 14px 0 4px; }
...
`,ip=vd.div`
  ...
  .f-q .f-plus { font-family: ${Vu}; color: ${wd.color.mutedSoft}; font-size: 15px; flex-shrink: 0;
...
`,Gx=vd.div`
  ...
  margin-bottom: 56px;
  text-align: left;
  animation: ${Ux} 0.75s cubic-bezier(0.34, 1.46, 0.64, 1) both;
  box-shadow:
...
`,Jx=vd.span`
  ...
  background: #1DB09A;
  flex-shrink: 0;
  animation: ${Vx} 2.2s ease-in-out infinite;
`,Qx=vd.span`
  font-size: 12px;
  font-weight: 600;
  color: rgba(255,255,255,0.45);
