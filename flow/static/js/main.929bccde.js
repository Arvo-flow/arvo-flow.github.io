...
`,Eu=vd.div`
  ...
  .br-h {
    font-family: ${e=>{let{theme:t}=e;return t.font.display}}; font-weight: 600; font-size: 21px;
    line-height: 1.25; color: ${e=>{let{theme:t}=e;return t.dossier.inkOnDark}};
    em { font-style: italic; color: ${e=>{let{theme:t}=e;return t.dossier.tealBright}}; }
  }
  .br-p { margin-top: 9px; font-size: 13.5px; line-height: 1.6; color: ${e=>{let{theme:t}=e;return t.dossier.mutedOnDark}}; }
  ...
  .br-adr {
    ...
    .br-mail {
      ...
      border-radius: ${e=>{let{theme:t}=e;return t.size.radius.md}};
      border: 1px solid ${e=>{let{theme:t}=e;return t.dossier.hairlineOnDark}};
      background: ${e=>{let{theme:t}=e;return t.dossier.bg}};
      font-family: ${e=>{let{theme:t}=e;return t.font.mono}}; font-size: 14px;
  ...
  .br-avtal {
    margin-top: 15px; padding-top: 14px; border-top: 1px solid ${e=>{let{theme:t}=e;return t.dossier.hairlineOnDark}};
    font-size: 12.5px; line-height: 1.6; color: ${e=>{let{theme:t}=e;return t.dossier.mutedOnDark}};
    b { color: ${e=>{let{theme:t}=e;return t.dossier.inkOnDark}}; }
  }
  .br-alt {
    margin-top: 11px; font-size: 12.5px; color: ${e=>{let{theme:t}=e;return t.dossier.faintOnDark}};
...
`;function Cf(e){let{finding:t,extraCount:n=0,variant:r="light",eyebrow:a}=e;if(!t||!t.title)return null;const i="watch"===t.tone?"watch":"leak",o=null!==a&&void 0!==a?a:"watch"===i?"Avtalsbevakning":"dossier"===r?"Fynd p\xe5 era fakturor":"Fynd p\xe5 er faktura",s=t.annualImpact>0;return(0,$d.jsxs)(zf,{$variant:r,$tone:i,children:[(0,$d.jsx)("div",{className:"fc-eyebrow",children:o}),(0,$d.jsxs)("div",{className:"fc-row",children:[(0,$d.jsx)("div",{className:"fc-title",children:t.title}),s?(0,$d.jsxs)("div",{className:"fc-impact",children:[(l=t.annualImpact,new Intl.NumberFormat("sv-SE",{maximumFractionDigits:0}).format(l))," kr/\xe5r"]}):t.metricText?(0,$d.jsx)("div",{className:"fc-impact",children:t.metricText}):null]}),t.lineDescription&&(0,$d.jsxs)("div",{className:"fc-line",children:["\u201d",t.lineDescription,"\u201d"]}),(0,$d.jsx)("p",{className:"fc-text",children:t.text}),n>0&&(0,$d.jsxs)("p",{className:"fc-more",children:[(0,$d.jsxs)("strong",{children:["+",n," fler fynd"]})," p\xe5 fakturan \u2014 vi g\xe5r igenom dem i er genomg\xe5ng."]})]});var l}const Af=jd`
  from { opacity: 0; transform: translateY(14px); }
  to { opacity: 1; transform: translateY(0); }
`,Df=jd`
...
`,em=vd.li`
  ...
  div.bullet {
    ...
    animation: ${e=>{let{$state:t}=e;return"active"===t?Ff:"none"}} 1.6s ease-in-out infinite;
    flex-shrink: 0;
  }
  div.label {
    font-size: 14.5px;
...
`),nm=vd.div`
  ...
  &::after {
    ...
    animation: ${Tf} 3.6s ease-in-out 1.2s infinite;
    pointer-events: none;
  }
...
`,vd.div`
  ...
  animation: ${Af} 0.5s ease 0.08s both;
...
`,zm=vd.div`
  ...
  animation: ${Af} 0.5s ease 0.16s both;
  ...
  .preview-live-dot {
    ...
    background: ${e=>{let{theme:t}=e;return t.color.brand}};
    box-shadow: 0 0 0 3px ${e=>{let{theme:t}=e;return t.color.brandSoft}};
    animation: ${Pf} 2s ease-in-out infinite;
    margin-right: 7px;
...
`,Cm=vd.div`
  ...
  animation: ${Af} 0.5s ease 0.24s both;
...
`;function Jm(e){let{email:t,onLogout:n}=e;const[a,i]=(0,r.useState)(""),[o,s]=(0,r.useState)(!1),[l,c]=(0,r.useState)(!1);if(t)return(0,$d.jsxs)(Ym,{children:[(0,$d.jsxs)("span",{className:"ab-who",children:[(0,$d.jsx)("span",{className:"ab-dot"}),"Inloggad som ",(0,$d.jsx)("b",{children:t})]}),(0,$d.jsx)("button",{className:"ab-out",onClick:n,children:"Logga ut"})]});return(0,$d.jsx)(Ym,{children:(0,$d.jsxs)("form",{onSubmit:async function(e){e.preventDefault();const t=a.trim();if(t&&!l){c(!0);try{await fetch("/api/auth/request-magic-link",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t,dest:"portfolio"})}),s(!0)}catch{s(!0)}finally{c(!1)}}},children:[(0,$d.jsx)("div",{className:"ab-k",children:"Redan kund?"}),o?(0,$d.jsxs)("p",{className:"ab-msg",children:["Kolla er inkorg \u2014 en inloggningsl\xe4nk \xe4r p\xe5 v\xe4g till ",(0,$d.jsx)("b",{children:a.trim()}),". Den \xf6ppnar ert kontor p\xe5 vilken enhet som helst."]}):(0,$d.jsxs)($d.Fragment,{children:[(0,$d.jsx)("input",{type:"email",inputMode:"email",autoComplete:"email",placeholder:"Logga in med er f\xf6retagsmejl",value:a,onChange:e=>i(e.target.value),disabled:l}),(0,$d.jsx)("button",{className:"ab-in",type:"submit",disabled:l||!a.trim(),children:l?"Skickar\u2026":"Skicka l\xe4nk"})]})]})})}const Qm=wd.font.mono,Xm=wd.font.display,Zm=jd`from { opacity:0; transform:translateY(22px); } to { opacity:1; transform:translateY(0); }`,eh=jd`to { transform: rotate(360deg); }`,th=(jd`0%,100% { opacity:.25; } 50% { opacity:1; }`,jd`0%,100% { opacity:.6; } 50% { opacity:1; }`),nh=(jd`0% { background-position:-200% 0; } 100% { background-position:200% 0; }`,function(){return hd`opacity:0; animation:${Zm} .7s ${arguments.length>0&&void 0!==arguments[0]?arguments[0]:0}s cubic-bezier(0.16,1,0.3,1) forwards;`}),rh=vd.main`
  min-height: 100vh;
...
`,ih=(vd.div`
  ...
  display: inline-flex; align-items: center; gap: 8px;
  font-family: ${Qm}; font-size: 10px; letter-spacing: .26em; text-transform: uppercase;
...
`),oh=vd.div`
  .brand {
    font-family: ${Qm}; font-size: 11px; font-weight: 600;
  ...
  h1 {
    font-family: ${Xm}; font-weight: 700; line-height: 1.02; letter-spacing: -.03em;
...
`,sh=vd.div`
  ...
  .dial-center {
    ...
    .dial-time { font-family: ${Qm}; font-size: 19px; color: ${wd.dossier.inkOnDark}; font-feature-settings: 'tnum'; }
    .dial-k { font-family: ${Qm}; font-size: 7.5px; letter-spacing: .24em; text-transform: uppercase; color: ${wd.dossier.faintOnDark}; }
  }
  .radar-title {
    font-family: ${Qm}; font-size: 10px; letter-spacing: .22em; text-transform: uppercase;
  ...
  .rgroup-label { font-family: ${Qm}; font-size: 9.5px; letter-spacing: .2em; text-transform: uppercase;
  ...
  .rstat {
    ...
    span.v { font-family: ${Qm}; color: ${wd.dossier.inkOnDark}; font-feature-settings:'tnum'; }
  }
  .radar-foot {
...
`,lh=vd.section`
  ...
  .eyebrow {
    font-family: ${Qm}; font-size: 11px; letter-spacing: .26em; text-transform: uppercase;
  ...
  h2 {
    font-family: ${Xm}; font-weight: 600; letter-spacing: -.02em;
...
`,ch=vd.span`
  display: inline-flex; align-items: center; gap: 8px;
  font-family: ${Qm}; font-size: 11px; letter-spacing: .04em;
...
`,ph=vd.div`
  ...
  .card-eyebrow {
    font-family: ${Qm}; font-size: 10px; letter-spacing: .24em; text-transform: uppercase;
...
`,fh=vd(ph)`
  ...
  h3 {
    font-family: ${Xm}; font-weight: 600; font-size: clamp(21px, 2.6vw, 27px);
  ...
  .barrow {
    ...
    .amt { font-family: ${Qm}; font-feature-settings:'tnum'; color: ${wd.dossier.inkOnDark};
      white-space: nowrap; }
...
`,mh=vd(ph)`
  ...
  .idx-num {
    font-family: ${Qm}; font-weight: 700; font-size: 72px; line-height: .9;
    letter-spacing: -.04em; font-feature-settings:'tnum';
    background: ${wd.dossier.numberGradient};
    -webkit-background-clip: text; background-clip: text; -webkit-text-fill-color: transparent;
  }
  .idx-denom { font-family: ${Qm}; font-size: 22px; font-weight: 500; letter-spacing: -.02em;
    color: ${wd.dossier.faintOnDark}; padding-bottom: 8px; }
  .idx-delta {
    font-family: ${Qm}; font-size: 13px; color: ${wd.dossier.tealBright};
  ...
  .mkt-k { font-family: ${Qm}; font-size: 10px; letter-spacing: .18em; text-transform: uppercase;
    color: ${wd.dossier.faintOnDark}; margin-bottom: 9px; }
  .mkt-track {
  ...
  .mkt-scale { display: flex; justify-content: space-between;
    font-family: ${Qm}; font-size: 9.5px; letter-spacing: .08em; text-transform: uppercase;
    color: ${wd.dossier.faintOnDark};
...
`,hh=vd(ph)`
  ...
  .cal-prob {
    font-family: ${Qm}; font-size: 15px; font-weight: 600; font-feature-settings:'tnum';
  ...
  .cal-when {
    font-family: ${Qm}; font-size: 11px; letter-spacing: .1em; text-transform: uppercase;
...
`,gh=vd(ph)`
  ...
  .rcpt .day { font-family: ${Qm}; font-size: 11px; letter-spacing: .14em; text-transform: uppercase;
...
`,xh=vd(ph)`
  ...
  .tally-k { font-family: ${Qm}; font-size: 10px; letter-spacing: .24em; text-transform: uppercase;
    color: ${wd.dossier.teal}; margin-bottom: 14px; }
  .tally-num { font-family: ${Xm}; font-weight: 600; font-size: clamp(36px, 6vw, 52px);
...
`,vh=vd.section`
  ...
  ${nh(.24)}
  .h-eyebrow { font-family: ${Qm}; font-size: 10px; letter-spacing: .24em; text-transform: uppercase;
    color: ${wd.dossier.teal}; margin-bottom: 18px; }
  .h-row {
  ...
  .h-cost { font-family: ${Qm}; font-size: 13.5px; color: ${wd.dossier.mutedOnDark};
    font-feature-settings:'tnum'; white-space: nowrap;
    @media (max-width:560px){ grid-column:2; grid-row:1; } }
  .h-state { font-family: ${Qm}; font-size: 10.5px; letter-spacing: .1em; text-transform: uppercase;
...
`,bh=vd.div`
  ...
  .mark { font-family: ${Qm}; font-size: 11px; letter-spacing: .36em; text-indent: .36em;
    color: ${wd.dossier.faintOnDark}; }
  .tagline { font-family: ${Xm}; font-style: italic; font-size: 16px;
...
`,yh=vd.button`
  ...
  .h-badge { font-family:${Qm}; font-size:13px; letter-spacing:.06em;
...
`,jh=vd.div`
  ...
  span.v { position:absolute; inset:0; display:flex; align-items:center; justify-content:center;
    font-family:${Qm}; font-size:15px; font-weight:700; font-feature-settings:'tnum'; }
`,wh=vd.div`
  padding:6px 0 24px; animation:${Zm} .28s ease both;
  display:flex; flex-direction:column; gap:18px;

  /* Arvo bedömer — bara omdömet (score-ringen bor i radhuvudet, ej dubblerad) */
  .diag { padding:0 2px; }
  .diag .dbody .dtop { font-family:${Qm}; font-size:10px; letter-spacing:.18em; text-transform:uppercase;
  ...
  .fact { display:flex; justify-content:space-between; align-items:baseline; gap:14px;
    ...
    dd { font-family:${Qm}; color:${wd.dossier.inkOnDark}; font-feature-settings:'tnum'; margin:0; } }
`,Sh=(vd.div`
  ...
  .si-k { font-family:${Qm}; font-size:10px; letter-spacing:.24em; text-transform:uppercase;
    color:${wd.dossier.teal}; margin-bottom:14px; }
  ...
  .si-n { flex-shrink:0; width:22px; height:22px; border-radius:50%;
    ...
    font-family:${Qm}; font-size:11px; font-weight:600; display:flex; align-items:center; justify-content:center; }
  ...
  .si-offer { display:flex; align-items:baseline; gap:8px; margin-bottom:6px;
    ...
    .old { font-family:${Qm}; font-size:13px; color:${wd.dossier.faintOnDark};
      text-decoration:line-through; }
    .arr { color:${wd.dossier.faintOnDark}; }
    .new { font-family:${Qm}; font-size:20px; font-weight:700; font-feature-settings:'tnum';
      color:${wd.dossier.tealBright}; }
...
`,vd.div`
  ...
  .st-k { font-family:${Qm}; font-size:10px; letter-spacing:.24em; text-transform:uppercase;
    color:${wd.dossier.teal}; margin-bottom:14px; }
  ...
  .st-tag { font-family:${Qm}; font-size:9px; letter-spacing:.12em; text-transform:uppercase;
...
`),$h=vd.div`
  ...
  .sv-eyebrow { display:flex; align-items:center; gap:9px; font-family:${Qm}; font-size:10px;
  ...
  .sv-dom { font-family:${Xm}; font-weight:500; font-size:clamp(20px,2.6vw,25px); line-height:1.22;
  ...
  .sv-proof > summary { list-style:none; cursor:pointer; font-family:${Qm}; font-size:10px;
  ...
  .sv-lbl { font-family:${Qm}; font-size:9.5px; letter-spacing:.2em; text-transform:uppercase;
  ...
  .sv-sup { display:flex; align-items:center; gap:8px; flex-wrap:wrap; font-size:13.5px; font-weight:600;
    color:${wd.dossier.inkOnDark}; }
  .sv-tag { font-family:${Qm}; font-size:9px; letter-spacing:.12em; text-transform:uppercase;
  ...
  .sv-v { font-family:${Qm}; font-size:13px; color:${wd.dossier.inkOnDark}; font-feature-settings:'tnum'; white-space:nowrap; }
...
`,Nh=vd.div`
  ...
  .al-eyebrow { display:flex; align-items:center; justify-content:space-between; gap:8px;
    font-family:${Qm}; font-size:10px; letter-spacing:.2em; text-transform:uppercase;
  ...
  .al-deadline { padding:12px 14px; border:1px solid rgba(43,196,172,.28);
    ...
    .al-date { font-family:${Qm}; font-size:15px; color:${wd.dossier.inkOnDark}; font-feature-settings:'tnum'; }
    .al-days { font-family:${Qm}; color:${wd.dossier.tealBright}; }
  ...
  .al-angra { display:block; cursor:pointer; background:none; border:none; padding:0; margin-top:4px;
    font-family:${Qm}; font-size:9.5px; letter-spacing:.14em; text-transform:uppercase;
  ...
  .al-citat { margin-top:12px;
    summary { cursor:pointer; font-family:${Qm}; font-size:10.5px; letter-spacing:.14em;
    ...
    .al-c { margin:10px 0 0; padding-left:12px; border-left:2px solid ${wd.dossier.hairlineOnDark};
      ...
      small { display:block; font-family:${Qm}; font-size:9.5px; letter-spacing:.12em;
...
`,_h=vd.div`
  ...
  border:1px solid ${wd.dossier.hairlineOnDark}; border-radius:${wd.size.radius.md};
  .au-eyebrow { font-family:${Qm}; font-size:10px; letter-spacing:.2em; text-transform:uppercase;
    color:${wd.dossier.faintOnDark}; margin-bottom:8px; }
  .au-txt { margin:0 0 12px; font-size:12.5px; line-height:1.55; color:${wd.dossier.mutedOnDark}; }
  ${Sh}
`,Eh=vd.section`
  margin-top:40px;
  .w-eyebrow { font-family:${Qm}; font-size:11px; letter-spacing:.24em; text-transform:uppercase;
  ...
  .w-kind { font-family:${Qm}; font-size:9.5px; letter-spacing:.14em; text-transform:uppercase;
  ...
  .w-list { font-family:${Qm}; font-size:12px; letter-spacing:.02em; color:${wd.dossier.faintOnDark};
    margin-bottom:10px; line-height:1.7; }
  .w-action { font-size:12.5px; color:${wd.dossier.teal}; display:flex; gap:7px; align-items:baseline;
    .w-arrow { font-family:${Qm}; } }
`,zh=vd.a`
...
`,Ch=vd.div`
  ...
  ${nh(.1)}
  .iq-k { font-family:${Qm}; font-size:10px; letter-spacing:.24em; text-transform:uppercase;
    color:${wd.dossier.teal}; margin-bottom:14px; }
  h3 { font-family:${Xm}; font-weight:600; font-size:clamp(22px,3.2vw,30px); line-height:1.16;
  ...
  .iq-price { font-family:${Qm}; font-size:19px; font-weight:600; letter-spacing:-.01em;
...
`,Dh=(vd.div`
  ...
  ${nh(.06)}
  .cm-eyebrow { font-family:${Qm}; font-size:10px; letter-spacing:.24em; text-transform:uppercase;
    color:${wd.dossier.teal}; margin-bottom:16px; }
  ...
  .cm-tag { font-family:${Qm}; font-size:8.5px; letter-spacing:.12em; text-transform:uppercase;
  ...
  .cm-verified { font-family:${Qm}; font-size:9px; letter-spacing:.07em; text-transform:uppercase;
...
`,vd.div`
  ...
  .door.primary { border-color:rgba(43,196,172,.42);
    ...
    box-shadow:0 0 0 1px rgba(43,196,172,.10); }
  .door-k { font-family:${Qm}; font-size:10px; letter-spacing:.24em; text-transform:uppercase;
    color:${wd.dossier.teal}; margin-bottom:12px; display:flex; align-items:center; gap:9px; }
  .door-tag { font-family:${Qm}; font-size:8.5px; letter-spacing:.12em; text-transform:uppercase;
    color:${wd.dossier.bg}; background:${wd.dossier.teal}; border-radius:${wd.size.radius.pill};
    padding:3px 8px; }
  .door h4 { font-family:${Xm}; font-weight:600; font-size:18px; letter-spacing:-.01em;
...
`,Oh=vd.button`
  ...
  font-family:${Qm}; font-size:14px; letter-spacing:.01em; color:${wd.dossier.tealBright};
  ...
  .ac-copy { flex-shrink:0; display:inline-flex; align-items:center; gap:6px;
    font-family:${Qm}; font-size:10px; letter-spacing:.12em; text-transform:uppercase;
    color:${wd.dossier.faintOnDark}; }
...
`,Ph=vd.div`
  ...
  .dp-stat { font-family:${Qm}; font-size:11px; letter-spacing:.06em; white-space:nowrap; }
