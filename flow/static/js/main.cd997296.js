...
`,wj=vd.span`
  font-size: 13px;
  font-weight: 600;
  color: ${e=>{let{$highlight:t}=e;return t?"#1DB09A":"rgba(255,255,255,0.60)"}};
  text-align: right;
`,Sj=vd.div`
  background: #060D0A;
  border-top: 1px solid rgba(255,255,255,0.06);
...
`,Ij=vd.span`
  font-size: 13px;
  font-weight: 600;
  color: ${e=>{let{$highlight:t}=e;return t?"#1B7A6E":"rgba(14,26,23,0.65)"}};
  text-align: right;
`,Bj=vd.div`
  background: #060D0A;
  border-top: 1px solid rgba(255,255,255,0.06);
...
`,Jj=vd.div`
  ...
  justify-content: center;
  gap: 16px;
`,Xj=vd.div`display: flex; gap: 8px;`,Zj=vd.div`
  width: 8px; height: 8px;
  border-radius: 50%;
  background: #1DB09A;
...
`,iw=vd.a`
  ...
  padding-bottom: 2px;
`,ow=e=>null!=e?new Intl.NumberFormat("sv-SE",{maximumFractionDigits:0}).format(e):"\u2013",lw={microsoft365:"Microsoft 365",google:"Google Workspace",zoho:"Zoho Mail",other:"Anpassad e-postl\xf6sning"},sw=["januari","februari","mars","april","maj","juni","juli","augusti","september","oktober","november","december"];function cw(e){if(!e)return null;const[t,r]=e.split("-");return`${sw[parseInt(r)-1]} ${t}`}function dw(e){if(!e)return"";return new Date(e).toLocaleDateString("sv-SE",{day:"numeric",month:"long",year:"numeric"})}function uw(){var e,t,r;const{token:a}=ho(),[i,o]=(0,n.useState)("loading"),[l,s]=(0,n.useState)(null),[c,d]=(0,n.useState)(!1);(0,n.useEffect)(()=>{a?fetch(`/api/prospect?token=${encodeURIComponent(a)}`).then(e=>e.json()).then(e=>{e.ok?(s(e.prospect),o("ready")):o("error")}).catch(()=>o("error")):o("error")},[a]);const u=e=>{c||(d(!0),fetch(`/api/prospect?token=${encodeURIComponent(a)}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({action:e})}).catch(()=>{}))};if("loading"===i)return(0,$d.jsxs)(Jj,{children:[(0,$d.jsx)(Xj,{children:[0,1,2].map(e=>(0,$d.jsx)(Zj,{$i:e},e))}),(0,$d.jsx)(ew,{children:"H\xe4mtar er analys\u2026"})]});if("error"===i)return(0,$d.jsxs)(tw,{children:[(0,$d.jsx)(rw,{children:"\ud83d\udd12"}),(0,$d.jsx)(nw,{children:"Analysen hittades inte"}),(0,$d.jsx)(aw,{children:"L\xe4nken kan ha g\xe5tt ut eller \xe4r ogiltig. Analysera er faktura direkt \u2014 det tar 2 minuter."}),(0,$d.jsx)(iw,{href:"/testa-faktura",children:"Analysera en faktura \u2192"})]});const{companyName:p,industry:h,employees:f,estimates:m,generatedAt:g}=l,x=null!==(e=null===m||void 0===m?void 0:m.categories)&&void 0!==e?e:[],v=(null===m||void 0===m?void 0:m.hasEstimates)&&((null===m||void 0===m?void 0:m.totalSavingLow)>0||x.length>0),b=null===m||void 0===m?void 0:m.mxPlatform,y=null===m||void 0===m?void 0:m.mxSince,k=null===m||void 0===m?void 0:m.domainRegistered,j=null===m||void 0===m?void 0:m.foundedYear,w=null!==(t=null===m||void 0===m?void 0:m.findings)&&void 0!==t?t:[],S=($=y)?Math.round((Date.now()-new Date($).getTime())/2630016e3):0;var $;const z=null!==(r=lw[b])&&void 0!==r?r:b,E=w.length>0,_=[];w.forEach(e=>_.push({text:e,key:e})),!E&&y?_.push({text:`${z}-konfiguration of\xf6r\xe4ndrad sedan ${cw(y)} \u2014 ${S} m\xe5nader`,key:"mxSince"}):!E&&b&&_.push({text:`${z} identifierat f\xf6r er dom\xe4n \xb7 ${f} licenser`,key:"mxPlatform"});const N=_.length>0,A=E?"IDENTIFIERAT FYND":"INFRASTRUKTURANALYS",C=E&&(b||k||y);return(0,$d.jsxs)(oj,{children:[(0,$d.jsx)(lj,{children:(0,$d.jsxs)(sj,{children:[(0,$d.jsxs)(cj,{children:[(0,$d.jsx)(dj,{children:"Konfidentiell analys"}),(0,$d.jsx)(uj,{children:dw(g)})]}),(0,$d.jsx)(pj,{children:p}),(0,$d.jsxs)(hj,{children:[h&&(0,$d.jsx)("span",{children:h}),h&&f&&(0,$d.jsx)(fj,{children:"\xb7"}),f&&(0,$d.jsxs)("span",{children:[f," anst\xe4llda"]}),j&&(0,$d.jsxs)($d.Fragment,{children:[(0,$d.jsx)(fj,{children:"\xb7"}),(0,$d.jsxs)("span",{children:["Grundat ",j]})]})]})]})}),N&&(0,$d.jsxs)(mj,{children:[(0,$d.jsx)(gj,{children:A}),_.map((e,t)=>(0,$d.jsxs)(xj,{$i:t,children:[(0,$d.jsx)(vj,{children:"\u2605"}),(0,$d.jsx)(bj,{children:e.text})]},e.key)),C&&(0,$d.jsxs)(yj,{children:[b&&(0,$d.jsxs)(kj,{children:[(0,$d.jsx)(jj,{children:"E-postplattform"}),(0,$d.jsx)(wj,{children:z})]}),y&&(0,$d.jsxs)(kj,{children:[(0,$d.jsx)(jj,{children:"Konfiguration sedan"}),(0,$d.jsxs)(wj,{$highlight:!0,children:[cw(y)," \u2014 ",S," m\xe5n"]})]}),k&&(0,$d.jsxs)(kj,{children:[(0,$d.jsx)(jj,{children:"Dom\xe4n registrerad"}),(0,$d.jsx)(wj,{children:cw(k)})]})]})]}),v&&(0,$d.jsxs)(Sj,{children:[(0,$d.jsx)(gj,{children:"Ber\xe4knad kostnadspremie"}),(0,$d.jsxs)($j,{children:[ow(m.totalSavingLow),"\u2013",ow(m.totalSavingHigh)," ",(0,$d.jsx)("span",{style:{fontSize:"0.42em",letterSpacing:"0em",fontWeight:700},children:"kr/\xe5r"})]}),b&&f&&(0,$d.jsxs)(zj,{children:["Baserat p\xe5 ",f," licenser \xd7 marknadspris ",z]}),(0,$d.jsx)(Ej,{children:"Er faktiska avtalskostnad ser vi inte f\xf6rr\xe4n ni delar er faktura"})]}),x.length>0&&(0,$d.jsxs)(Dj,{children:[(0,$d.jsx)(Lj,{children:"Kostnadsanalys per kategori"}),x.map((e,t)=>(0,$d.jsxs)(_j,{children:[(0,$d.jsx)(Nj,{children:e.label}),(0,$d.jsxs)(Rj,{children:[(0,$d.jsx)(Oj,{children:"m365"===e.category?"Uppskattade licenser":"Uppskattade abonnemang"}),(0,$d.jsxs)(Ij,{children:[e.estimatedSims," st"]})]}),(0,$d.jsxs)(Rj,{children:[(0,$d.jsx)(Oj,{children:"Typisk marknadskostnad"}),(0,$d.jsxs)(Ij,{children:[ow(e.typicalLow),"\u2013",ow(e.typicalHigh)," kr/\xe5r"]})]}),(0,$d.jsxs)(Rj,{children:[(0,$d.jsx)(Oj,{children:"Arvo-priset (verifierat listpris)"}),(0,$d.jsxs)(Ij,{$highlight:!0,children:[ow(e.arvoAnnual)," kr/\xe5r"]})]}),(0,$d.jsxs)(Rj,{children:[(0,$d.jsx)(Oj,{children:"m365"===e.category?"Pris per licens":"Pris per abonnemang"}),(0,$d.jsxs)(Ij,{children:[e.pricePerSim.arvo," kr/m\xe5n"," ",(0,$d.jsxs)("span",{style:{color:"rgba(14,26,23,0.28)",fontWeight:400,fontSize:11},children:["(typiskt ",e.pricePerSim.typical," kr/m\xe5n)"]})]})]}),(0,$d.jsxs)(Aj,{children:[(0,$d.jsx)(Cj,{children:"Potentiell besparing"}),(0,$d.jsxs)(Fj,{children:["upp till ",ow(e.savingHigh)," kr/\xe5r"]})]}),(0,$d.jsx)(Tj,{children:e.sourceNote})]},t))]}),(0,$d.jsxs)(Bj,{children:[(0,$d.jsxs)(Pj,{children:["Arvo har analyserat den publika DNS-konfigurationen f\xf6r ",p,"s dom\xe4n. Ingen data har inh\xe4mtats fr\xe5n er eller era leverant\xf6rer utan ert tillst\xe5nd. Er faktiska avtalskostnad k\xe4nner vi inte till f\xf6rr\xe4n ni visar oss er faktura."]}),(0,$d.jsxs)(Mj,{children:[(0,$d.jsx)(Vj,{href:"/testa-faktura",onClick:()=>u("upload"),children:"Verifiera er kostnad \u2014 ladda upp faktura"}),(0,$d.jsx)(Uj,{children:"Kostnadsfritt \xb7 2 minuter \xb7 Ingen registrering kr\xe4vs"})]}),(0,$d.jsx)(Kj,{}),(0,$d.jsxs)(Hj,{children:[(0,$d.jsx)(Wj,{href:"/intelligence#aktivera",onClick:()=>u("activate"),children:"Aktivera Arvo Intelligence \u2014 1 995 kr/m\xe5n"}),(0,$d.jsx)(qj,{children:"L\xf6pande bevakning \xb7 Ingen bindningstid \xb7 Arvo b\xf6rjar bevaka er inom 24 timmar"})]})]}),(0,$d.jsxs)(Yj,{children:[(0,$d.jsx)(Gj,{children:"arvoflow.se"}),(0,$d.jsx)(Qj,{children:"Arvo Intelligence"})]})]})}"scrollRestoration"in window.history&&(window.history.scrollRestoration="manual");const pw=()=>{const{pathname:e}=so();return(0,n.useEffect)(()=>{window.scrollTo(0,0)},[e]),null},hw=()=>(0,$d.jsxs)(dd,{theme:wd,children:[(0,$d.jsx)(Sd,{}),(0,$d.jsx)(gl,{basename:"/flow",children:(0,$d.jsxs)(Nd,{children:[(0,$d.jsx)(pw,{}),(0,$d.jsxs)(Lo,{children:[(0,$d.jsx)(Po,{path:"/",element:(0,$d.jsx)(Kp,{})}),(0,$d.jsx)(Po,{path:"/connect",element:(0,$d.jsx)(xh,{})}),(0,$d.jsx)(Po,{path:"/scanning",element:(0,$d.jsx)(Dh,{})}),(0,$d.jsx)(Po,{path:"/insights",element:(0,$d.jsx)(bf,{})}),(0,$d.jsx)(Po,{path:"/opportunity/:id",element:(0,$d.jsx)(Yf,{})}),(0,$d.jsx)(Po,{path:"/bias",element:(0,$d.jsx)(dm,{})}),(0,$d.jsx)(Po,{path:"/villkor",element:(0,$d.jsx)(zm,{})}),(0,$d.jsx)(Po,{path:"/integritet",element:(0,$d.jsx)(Em,{})}),(0,$d.jsx)(Po,{path:"/cookies",element:(0,$d.jsx)(_m,{})}),(0,$d.jsx)(Po,{path:"/testa-faktura",element:(0,$d.jsx)(Ig,{})}),(0,$d.jsx)(Po,{path:"/portfolio",element:(0,$d.jsx)(Hx,{})}),(0,$d.jsx)(Po,{path:"/admin",element:(0,$d.jsx)(fv,{})}),(0,$d.jsx)(Po,{path:"/utfall",element:(0,$d.jsx)(zv,{})}),(0,$d.jsx)(Po,{path:"/arvo-score",element:(0,$d.jsx)(eb,{})}),(0,$d.jsx)(Po,{path:"/briefing/:token",element:(0,$d.jsx)(ly,{})}),(0,$d.jsx)(Po,{path:"/intelligence",element:(0,$d.jsx)(uk,{})}),(0,$d.jsx)(Po,{path:"/aktivera",element:(0,$d.jsx)(tj,{})}),(0,$d.jsx)(Po,{path:"/prospect/:token",element:(0,$d.jsx)(uw,{})}),(0,$d.jsx)(Po,{path:"*",element:(0,$d.jsx)(To,{to:"/",replace:!0})})]})]})})]});!function(){var e;const t={NODE_ENV:"production",PUBLIC_URL:"/flow",WDS_SOCKET_HOST:void 0,WDS_SOCKET_PATH:void 0,WDS_SOCKET_PORT:void 0,FAST_REFRESH:!0}.REACT_APP_SENTRY_DSN;t&&ri({dsn:t,environment:null!==(e="production")?e:"production",release:{NODE_ENV:"production",PUBLIC_URL:"/flow",WDS_SOCKET_HOST:void 0,WDS_SOCKET_PATH:void 0,WDS_SOCKET_PORT:void 0,FAST_REFRESH:!0}.REACT_APP_VERSION,tracesSampleRate:.1,beforeSend(e){var t,r,n,a;const i=null!==(t=null===(r=e.exception)||void 0===r||null===(n=r.values)||void 0===n||null===(a=n[0])||void 0===a?void 0:a.value)&&void 0!==t?t:"";return i.includes("Network request failed")||i.includes("Load failed")?null:e}})}();(0,i.createRoot)(document.getElementById("root")).render((0,$d.jsx)(hw,{}))})();
//# sourceMappingURL=main.cd997296.js.map