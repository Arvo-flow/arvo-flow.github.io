/*! For license information please see main.cbfa0b30.js.LICENSE.txt */
...
`,wj=vd.span`
  font-size: 13px;
  font-weight: 600;
  color: ${e=>{let{$highlight:t}=e;return t?"#2BC4AC":"rgba(255,255,255,0.85)"}};
  text-align: right;
`,Sj=vd.div`
  background: #060D0A;
  border-top: 1px solid rgba(255,255,255,0.06);
...
`,Vj=vd.span`
  font-size: 14px;
  font-weight: 600;
  color: ${e=>{let{$highlight:t}=e;return t?"#1B7A6E":"rgba(14,26,23,0.82)"}};
  text-align: right;
`,Uj=vd.span`
  display: block;
  font-size: 11px;
...
`,ew=vd.div`
  ...
  justify-content: center;
  gap: 16px;
`,tw=vd.div`display: flex; gap: 8px;`,rw=vd.div`
  width: 8px; height: 8px;
  border-radius: 50%;
  background: #1DB09A;
...
`,sw=vd.a`
  ...
  padding-bottom: 2px;
`,cw=e=>null!=e?new Intl.NumberFormat("sv-SE",{maximumFractionDigits:0}).format(e):"\u2013",dw=(e,t)=>500*Math.round((e+t)/2/500),uw={microsoft365:"Microsoft 365",google:"Google Workspace",zoho:"Zoho Mail",other:"Anpassad e-postl\xf6sning"},pw=["januari","februari","mars","april","maj","juni","juli","augusti","september","oktober","november","december"];function hw(e){if(!e)return null;const[t,r]=e.split("-");return`${pw[parseInt(r)-1]} ${t}`}function fw(e){if(!e)return"";return new Date(e).toLocaleDateString("sv-SE",{day:"numeric",month:"long",year:"numeric"})}function mw(){var e,t,r,a;const{token:i}=ho(),[o,l]=(0,n.useState)("loading"),[s,c]=(0,n.useState)(null),[d,u]=(0,n.useState)(!1);(0,n.useEffect)(()=>{i?fetch(`/api/prospect?token=${encodeURIComponent(i)}`).then(e=>e.json()).then(e=>{e.ok?(c(e.prospect),l("ready")):l("error")}).catch(()=>l("error")):l("error")},[i]);const p=e=>{d||(u(!0),fetch(`/api/prospect?token=${encodeURIComponent(i)}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({action:e})}).catch(()=>{}))};if("loading"===o)return(0,$d.jsxs)(ew,{children:[(0,$d.jsx)(tw,{children:[0,1,2].map(e=>(0,$d.jsx)(rw,{$i:e},e))}),(0,$d.jsx)(nw,{children:"H\xe4mtar er analys\u2026"})]});if("error"===o)return(0,$d.jsxs)(aw,{children:[(0,$d.jsx)(iw,{children:"\ud83d\udd12"}),(0,$d.jsx)(ow,{children:"Analysen hittades inte"}),(0,$d.jsx)(lw,{children:"L\xe4nken kan ha g\xe5tt ut eller \xe4r ogiltig. Analysera er faktura direkt \u2014 det tar 2 minuter."}),(0,$d.jsx)(sw,{href:"/testa-faktura",children:"Analysera en faktura \u2192"})]});const{companyName:h,industry:f,employees:m,estimates:g,generatedAt:x}=s,v=null!==(e=null===g||void 0===g?void 0:g.categories)&&void 0!==e?e:[],b=(null===g||void 0===g?void 0:g.hasEstimates)&&((null===g||void 0===g?void 0:g.totalSavingLow)>0||v.length>0),y=null===g||void 0===g?void 0:g.mxPlatform,k=null===g||void 0===g?void 0:g.mxSince,j=null===g||void 0===g?void 0:g.domainRegistered,w=null===g||void 0===g?void 0:g.foundedYear,S=null!==(t=null===g||void 0===g?void 0:g.findings)&&void 0!==t?t:[],$=(z=k)?Math.round((Date.now()-new Date(z).getTime())/2630016e3):0;var z;const E=null!==(r=uw[y])&&void 0!==r?r:y,_=S.length>0,N=[];S.forEach(e=>N.push({text:e,key:e})),!_&&k?N.push({text:`${E}-konfiguration of\xf6r\xe4ndrad sedan ${hw(k)} \u2014 ${$} m\xe5nader`,key:"mxSince"}):!_&&y&&N.push({text:`${E} identifierat f\xf6r er dom\xe4n \xb7 ${m} licenser`,key:"mxPlatform"});const A=N.length>0,C=_?"IDENTIFIERAT FYND":"INFRASTRUKTURANALYS",F=_&&(y||j||k),T=null!==(a=null===g||void 0===g?void 0:g.totalSavingCentral)&&void 0!==a?a:b?dw(g.totalSavingLow,g.totalSavingHigh):null,P=v.map(e=>`${e.estimatedSims} ${"m365"===e.category?"Microsoft 365-licenser":"mobilabonnemang"}`).join(" + ");return(0,$d.jsxs)(oj,{children:[(0,$d.jsx)(lj,{}),(0,$d.jsx)(sj,{children:(0,$d.jsxs)(cj,{children:[(0,$d.jsx)(dj,{children:"Konfidentiell analys"}),(0,$d.jsx)(pj,{children:h}),(0,$d.jsxs)(hj,{children:[f&&(0,$d.jsx)("span",{children:f}),f&&m&&(0,$d.jsx)(fj,{children:"\xb7"}),m&&(0,$d.jsxs)("span",{children:[m," anst\xe4llda"]}),w&&(0,$d.jsxs)($d.Fragment,{children:[(0,$d.jsx)(fj,{children:"\xb7"}),(0,$d.jsxs)("span",{children:["Grundat ",w]})]})]}),(0,$d.jsx)(uj,{children:fw(x)})]})}),A&&(0,$d.jsxs)(mj,{children:[(0,$d.jsx)(gj,{children:C}),N.map((e,t)=>(0,$d.jsxs)(xj,{$i:t,children:[(0,$d.jsx)(vj,{children:"\u2605"}),(0,$d.jsx)(bj,{children:e.text})]},e.key)),F&&(0,$d.jsxs)(yj,{children:[y&&(0,$d.jsxs)(kj,{children:[(0,$d.jsx)(jj,{children:"E-postplattform"}),(0,$d.jsx)(wj,{children:E})]}),k&&(0,$d.jsxs)(kj,{children:[(0,$d.jsx)(jj,{children:"Konfiguration sedan"}),(0,$d.jsxs)(wj,{$highlight:!0,children:[hw(k)," \u2014 ",$," m\xe5n"]})]}),j&&(0,$d.jsxs)(kj,{children:[(0,$d.jsx)(jj,{children:"Dom\xe4n registrerad"}),(0,$d.jsx)(wj,{children:hw(j)})]})]})]}),b&&(0,$d.jsxs)(Sj,{children:[(0,$d.jsx)(gj,{children:"Sannolik kostnadspremie"}),(0,$d.jsxs)($j,{children:[(0,$d.jsx)(zj,{children:"\u2248"}),cw(T)," ",(0,$d.jsx)("span",{style:{fontSize:"0.42em",letterSpacing:"0em",fontWeight:700},children:"kr/\xe5r"})]}),(0,$d.jsxs)(Ej,{children:["Intervall ",cw(g.totalSavingLow),"\u2013",cw(g.totalSavingHigh)," kr/\xe5r"]}),P&&(0,$d.jsxs)(_j,{children:["Baserat p\xe5 ",P," mot verifierade listpriser"]}),(0,$d.jsx)(Nj,{children:"Er faktiska avtalskostnad ser vi inte f\xf6rr\xe4n ni delar er faktura"})]}),v.length>0&&(0,$d.jsxs)(Oj,{children:[(0,$d.jsx)(Ij,{children:"Kostnadsanalys per kategori"}),v.map((e,t)=>{var r;const n="m365"===e.category?"licens":"abonnemang",a=null!==(r=e.savingCentral)&&void 0!==r?r:dw(e.savingLow,e.savingHigh);return(0,$d.jsxs)(Aj,{children:[(0,$d.jsx)(Cj,{children:e.label}),(0,$d.jsxs)(Mj,{children:[(0,$d.jsx)(Bj,{children:"m365"===e.category?"Uppskattade licenser":"Uppskattade abonnemang"}),(0,$d.jsxs)(Vj,{children:[e.estimatedSims," st"]})]}),(0,$d.jsxs)(Mj,{children:[(0,$d.jsx)(Bj,{children:"Typisk marknadskostnad"}),(0,$d.jsxs)(Vj,{children:[cw(e.typicalLow),"\u2013",cw(e.typicalHigh)," kr/\xe5r",(0,$d.jsxs)(Uj,{children:["median ",e.pricePerSim.typical," kr/m\xe5n per ",n," \xb1 15 %"]})]})]}),(0,$d.jsxs)(Mj,{children:[(0,$d.jsx)(Bj,{children:"Arvo-pris, verifierat listpris"}),(0,$d.jsxs)(Vj,{$highlight:!0,children:[cw(e.arvoAnnual)," kr/\xe5r",(0,$d.jsxs)(Uj,{children:[e.pricePerSim.arvo," kr/m\xe5n per ",n]})]})]}),(0,$d.jsxs)(Fj,{children:[(0,$d.jsx)(Tj,{children:"Sannolik premie"}),(0,$d.jsxs)("div",{children:[(0,$d.jsxs)(Pj,{children:["\u2248 ",cw(a)," kr/\xe5r"]}),(0,$d.jsxs)(Dj,{children:["intervall ",cw(e.savingLow),"\u2013",cw(e.savingHigh)]})]})]}),(0,$d.jsx)(Lj,{children:e.sourceNote})]},t)})]}),(0,$d.jsxs)(Kj,{children:[(0,$d.jsxs)(Rj,{children:["Arvo har analyserat den publika DNS-konfigurationen f\xf6r ",h,"s dom\xe4n. Ingen data har inh\xe4mtats fr\xe5n er eller era leverant\xf6rer utan ert tillst\xe5nd."]}),(0,$d.jsxs)(Hj,{children:[(0,$d.jsx)(Wj,{href:"/testa-faktura",onClick:()=>p("upload"),children:"Se er exakta premie \u2014 ladda upp en faktura"}),(0,$d.jsx)(qj,{children:"Kostnadsfritt \xb7 2 minuter \xb7 Ingen registrering kr\xe4vs"})]}),(0,$d.jsx)(Yj,{}),(0,$d.jsx)(Gj,{href:"/intelligence#aktivera",onClick:()=>p("activate"),children:"Eller l\xe5t Arvo bevaka er l\xf6pande \u2014 Arvo Intelligence, 1\xa0995 kr/m\xe5n \u2192"}),(0,$d.jsx)(Qj,{children:"Ingen bindningstid \xb7 Bevakningen b\xf6rjar inom 24 timmar"})]}),(0,$d.jsxs)(Jj,{children:[(0,$d.jsx)(Xj,{children:"arvoflow.se"}),(0,$d.jsx)(Zj,{children:"Arvo Intelligence"})]})]})}"scrollRestoration"in window.history&&(window.history.scrollRestoration="manual");const gw=()=>{const{pathname:e}=so();return(0,n.useEffect)(()=>{window.scrollTo(0,0)},[e]),null},xw=()=>(0,$d.jsxs)(dd,{theme:wd,children:[(0,$d.jsx)(Sd,{}),(0,$d.jsx)(gl,{basename:"/flow",children:(0,$d.jsxs)(Nd,{children:[(0,$d.jsx)(gw,{}),(0,$d.jsxs)(Lo,{children:[(0,$d.jsx)(Po,{path:"/",element:(0,$d.jsx)(Kp,{})}),(0,$d.jsx)(Po,{path:"/connect",element:(0,$d.jsx)(xh,{})}),(0,$d.jsx)(Po,{path:"/scanning",element:(0,$d.jsx)(Dh,{})}),(0,$d.jsx)(Po,{path:"/insights",element:(0,$d.jsx)(bf,{})}),(0,$d.jsx)(Po,{path:"/opportunity/:id",element:(0,$d.jsx)(Yf,{})}),(0,$d.jsx)(Po,{path:"/bias",element:(0,$d.jsx)(dm,{})}),(0,$d.jsx)(Po,{path:"/villkor",element:(0,$d.jsx)(zm,{})}),(0,$d.jsx)(Po,{path:"/integritet",element:(0,$d.jsx)(Em,{})}),(0,$d.jsx)(Po,{path:"/cookies",element:(0,$d.jsx)(_m,{})}),(0,$d.jsx)(Po,{path:"/testa-faktura",element:(0,$d.jsx)(Ig,{})}),(0,$d.jsx)(Po,{path:"/portfolio",element:(0,$d.jsx)(Hx,{})}),(0,$d.jsx)(Po,{path:"/admin",element:(0,$d.jsx)(fv,{})}),(0,$d.jsx)(Po,{path:"/utfall",element:(0,$d.jsx)(zv,{})}),(0,$d.jsx)(Po,{path:"/arvo-score",element:(0,$d.jsx)(eb,{})}),(0,$d.jsx)(Po,{path:"/briefing/:token",element:(0,$d.jsx)(ly,{})}),(0,$d.jsx)(Po,{path:"/intelligence",element:(0,$d.jsx)(uk,{})}),(0,$d.jsx)(Po,{path:"/aktivera",element:(0,$d.jsx)(tj,{})}),(0,$d.jsx)(Po,{path:"/prospect/:token",element:(0,$d.jsx)(mw,{})}),(0,$d.jsx)(Po,{path:"*",element:(0,$d.jsx)(To,{to:"/",replace:!0})})]})]})})]});!function(){var e;const t={NODE_ENV:"production",PUBLIC_URL:"/flow",WDS_SOCKET_HOST:void 0,WDS_SOCKET_PATH:void 0,WDS_SOCKET_PORT:void 0,FAST_REFRESH:!0}.REACT_APP_SENTRY_DSN;t&&ri({dsn:t,environment:null!==(e="production")?e:"production",release:{NODE_ENV:"production",PUBLIC_URL:"/flow",WDS_SOCKET_HOST:void 0,WDS_SOCKET_PATH:void 0,WDS_SOCKET_PORT:void 0,FAST_REFRESH:!0}.REACT_APP_VERSION,tracesSampleRate:.1,beforeSend(e){var t,r,n,a;const i=null!==(t=null===(r=e.exception)||void 0===r||null===(n=r.values)||void 0===n||null===(a=n[0])||void 0===a?void 0:a.value)&&void 0!==t?t:"";return i.includes("Network request failed")||i.includes("Load failed")?null:e}})}();(0,i.createRoot)(document.getElementById("root")).render((0,$d.jsx)(xw,{}))})();
//# sourceMappingURL=main.cbfa0b30.js.map