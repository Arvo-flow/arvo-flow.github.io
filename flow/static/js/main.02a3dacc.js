/*! For license information please see main.02a3dacc.js.LICENSE.txt */
...
`,hm=vd.div`
  ...
  border: 2px solid rgba(250, 250, 247, 0.3);
  border-top-color: #FAFAF7;
  animation: ${Gh} 0.7s linear infinite;
`,mm=vd.ol`
  margin: 24px 0 0;
  display: flex;
  flex-direction: column;
...
`,fm=vd.li`
  ...
  div.bullet {
    ...
    animation: ${e=>{let{$state:t}=e;return"active"===t?Yh:"none"}} 1.6s ease-in-out infinite;
    flex-shrink: 0;
  }
  div.label {
    font-size: 14.5px;
...
`),xm=vd.div`
  ...
  &::after {
    ...
    animation: ${Qh} 3.6s ease-in-out 1.2s infinite;
    pointer-events: none;
  }
...
`,hf=vd.div`
  ...
  font-family: ${af}; font-size: 10px; letter-spacing: .26em; text-transform: uppercase;
...
`,ff=vd.div`
  .brand {
    font-family: ${af}; font-size: 11px; font-weight: 600;
  ...
  h1 {
    font-family: ${of}; font-weight: 700; line-height: 1.02; letter-spacing: -.03em;
...
`,gf=vd.div`
  ...
  .disc .sweep {
    ...
    animation: ${lf} 3.2s linear infinite;
    mask: radial-gradient(circle, #000 62%, transparent 63%);
    -webkit-mask: radial-gradient(circle, #000 62%, transparent 63%);
  }
  .radar-title {
    font-family: ${af}; font-size: 10px; letter-spacing: .22em; text-transform: uppercase;
  ...
  .rstat {
    ...
    span.v { font-family: ${af}; color: ${wd.dossier.inkOnDark}; font-feature-settings:'tnum'; }
  }
  .radar-foot {
    ...
    .live { width: 7px; height: 7px; border-radius: 50%; background: ${wd.dossier.tealBright};
      box-shadow: ${wd.dossier.glow}; animation: ${cf} 2.4s ease-in-out infinite; }
  }
`,xf=vd.section`
  ...
  .eyebrow {
    font-family: ${af}; font-size: 11px; letter-spacing: .26em; text-transform: uppercase;
  ...
  h2 {
    font-family: ${of}; font-weight: 600; letter-spacing: -.02em;
...
`,vf=vd.section`
  ...
  .rf-eyebrow {
    display: inline-flex; align-items: center; gap: 8px;
    font-family: ${af}; font-size: 11px; letter-spacing: .22em; text-transform: uppercase;
  ...
  .rf-title {
    font-family: ${of}; font-weight: 600; font-size: clamp(20px, 3.4vw, 27px); line-height: 1.15;
    color: ${wd.dossier.inkOnDark};
  }
  .rf-impact {
    flex-shrink: 0; font-family: ${af}; font-size: clamp(20px, 3.6vw, 26px); font-weight: 600;
    letter-spacing: -.02em; font-feature-settings: 'tnum'; color: ${wd.color.warning}; white-space: nowrap;
  }
  .rf-line {
    display: inline-block; font-family: ${af}; font-size: 12.5px; color: ${wd.dossier.mutedOnDark};
...
`,bf=vd.span`
  display: inline-flex; align-items: center; gap: 8px;
  font-family: ${af}; font-size: 11px; letter-spacing: .04em;
...
`,jf=vd.div`
  ...
  .card-eyebrow {
    font-family: ${af}; font-size: 10px; letter-spacing: .24em; text-transform: uppercase;
...
`,wf=vd(jf)`
  ...
  h3 {
    font-family: ${of}; font-weight: 600; font-size: clamp(21px, 2.6vw, 27px);
  ...
  .barrow {
    ...
    .amt { font-family: ${af}; font-feature-settings:'tnum'; color: ${wd.dossier.inkOnDark};
      white-space: nowrap; }
...
`,Sf=vd(jf)`
  ...
  .idx-num {
    font-family: ${af}; font-weight: 700; font-size: 72px; line-height: .9;
    letter-spacing: -.04em; font-feature-settings:'tnum';
    background: ${wd.dossier.numberGradient};
    -webkit-background-clip: text; background-clip: text; -webkit-text-fill-color: transparent;
  }
  .idx-denom { font-family: ${af}; font-size: 22px; font-weight: 500; letter-spacing: -.02em;
    color: ${wd.dossier.faintOnDark}; padding-bottom: 8px; }
  .idx-delta {
    font-family: ${af}; font-size: 13px; color: ${wd.dossier.tealBright};
  ...
  .mkt-k { font-family: ${af}; font-size: 10px; letter-spacing: .18em; text-transform: uppercase;
  ...
  .mkt-scale { display: flex; justify-content: space-between;
    font-family: ${af}; font-size: 9.5px; letter-spacing: .08em; text-transform: uppercase;
    color: ${wd.dossier.faintOnDark};
...
`,$f=vd(jf)`
  ...
  .cal-prob {
    font-family: ${af}; font-size: 15px; font-weight: 600; font-feature-settings:'tnum';
  ...
  .cal-when {
    font-family: ${af}; font-size: 11px; letter-spacing: .1em; text-transform: uppercase;
...
`,Nf=vd(jf)`
  ...
  .rcpt .day { font-family: ${af}; font-size: 11px; letter-spacing: .14em; text-transform: uppercase;
...
`,_f=vd(jf)`
  ...
  .tally-k { font-family: ${af}; font-size: 10px; letter-spacing: .24em; text-transform: uppercase;
    color: ${wd.dossier.teal}; margin-bottom: 14px; }
  .tally-num { font-family: ${of}; font-weight: 600; font-size: clamp(36px, 6vw, 52px);
...
`,zf=vd.section`
  ...
  ${df(.24)}
  .h-eyebrow { font-family: ${af}; font-size: 10px; letter-spacing: .24em; text-transform: uppercase;
    color: ${wd.dossier.teal}; margin-bottom: 18px; }
  .h-row {
  ...
  .h-cost { font-family: ${af}; font-size: 13.5px; color: ${wd.dossier.mutedOnDark};
    font-feature-settings:'tnum'; white-space: nowrap;
    @media (max-width:560px){ grid-column:2; grid-row:1; } }
  .h-state { font-family: ${af}; font-size: 10.5px; letter-spacing: .1em; text-transform: uppercase;
...
`,Ef=vd.div`
  ...
  .mark { font-family: ${af}; font-size: 11px; letter-spacing: .36em; text-indent: .36em;
    color: ${wd.dossier.faintOnDark}; }
  .tagline { font-family: ${of}; font-style: italic; font-size: 16px;
...
`,Cf=vd.button`
  ...
  .h-badge { font-family:${af}; font-size:10.5px; letter-spacing:.08em;
...
`,Ff=vd.div`
  ...
  span.v { position:absolute; inset:0; display:flex; align-items:center; justify-content:center;
    font-family:${af}; font-size:12.5px; font-weight:700; font-feature-settings:'tnum'; }
`,Df=vd.div`
  padding:6px 0 24px; animation:${sf} .28s ease both;
  display:flex; flex-direction:column; gap:18px;

  /* Arvo bedömer — bara omdömet (score-ringen bor i radhuvudet, ej dubblerad) */
  .diag { padding:0 2px; }
  .diag .dbody .dtop { font-family:${af}; font-size:10px; letter-spacing:.18em; text-transform:uppercase;
  ...
  .fact { display:flex; justify-content:space-between; align-items:baseline; gap:14px;
    ...
    dd { font-family:${af}; color:${wd.dossier.inkOnDark}; font-feature-settings:'tnum'; margin:0; } }
`,Tf=vd.div`
  ...
  .si-k { font-family:${af}; font-size:10px; letter-spacing:.24em; text-transform:uppercase;
    color:${wd.dossier.teal}; margin-bottom:14px; }
  ...
  .si-n { flex-shrink:0; width:22px; height:22px; border-radius:50%;
    ...
    font-family:${af}; font-size:11px; font-weight:600; display:flex; align-items:center; justify-content:center; }
  ...
  .si-offer { display:flex; align-items:baseline; gap:8px; margin-bottom:6px;
    ...
    .old { font-family:${af}; font-size:13px; color:${wd.dossier.faintOnDark};
      text-decoration:line-through; }
    .arr { color:${wd.dossier.faintOnDark}; }
    .new { font-family:${af}; font-size:20px; font-weight:700; font-feature-settings:'tnum';
      color:${wd.dossier.tealBright}; }
...
`,Of=vd.div`
  ...
  ${df(.1)}
  .iq-k { font-family:${af}; font-size:10px; letter-spacing:.24em; text-transform:uppercase;
    color:${wd.dossier.teal}; margin-bottom:14px; }
  h3 { font-family:${of}; font-weight:600; font-size:clamp(22px,3.2vw,30px); line-height:1.16;
  ...
  .iq-price { font-family:${af}; font-size:19px; font-weight:600; letter-spacing:-.01em;
...
`,Lf=vd.div`
  ...
  animation:${lf} .8s linear infinite; margin:120px auto;
`,Rf=vd.div`
  margin-top:34px; padding-top:28px; border-top:1px solid ${wd.dossier.hairlineOnDark};
  ${df(.06)}
  .cm-eyebrow { font-family:${af}; font-size:10px; letter-spacing:.24em; text-transform:uppercase;
    color:${wd.dossier.teal}; margin-bottom:16px; }
  ...
  .cm-tag { font-family:${af}; font-size:8.5px; letter-spacing:.12em; text-transform:uppercase;
  ...
  .cm-verified { font-family:${af}; font-size:9px; letter-spacing:.07em; text-transform:uppercase;
...
`,If=vd.div`
  ...
  .door-k { font-family:${af}; font-size:10px; letter-spacing:.24em; text-transform:uppercase;
    color:${wd.dossier.teal}; margin-bottom:12px; }
  .door h4 { font-family:${of}; font-weight:600; font-size:18px; letter-spacing:-.01em;
  ...
  .door .spacer { flex:1; }
`,Mf=vd.div`
  font-family:${af}; font-size:14px; letter-spacing:.01em; color:${wd.dossier.tealBright};
...
`,Uf=vd.div`
  ...
  .dp-stat { font-family:${af}; font-size:11px; letter-spacing:.06em; white-space:nowrap; }
...
`,Vf=vd.div`
  ...
  border-radius:${wd.size.radius.md}; ${df(.18)}
