...
`,cm=vd.div`
  ...
  background: linear-gradient(to bottom, ${tm.bg}F0 0%, transparent 100%);
  pointer-events: none;
`,dm=vd.div`
  max-width: ${tm.column};
  margin: 0 auto;
...
`,um=vd.header`
  ...
  &::before {
    ...
    background: ${tm.aurora};
    pointer-events: none;
  }
  &::after {
    content: '';
    position: absolute; top: 0; left: 0; right: 0; height: 2px;
    background: ${tm.keyline};
  }
`,pm=vd.p`
  position: relative;
  font-family: ${nm};
...
`,fm=vd.p`
  ...
  color: ${tm.mutedOnDark};
  max-width: 420px; margin: 0 auto;
  ${lm(.12)}
`,mm=vd.section`
  background: ${tm.bgRaised};
  border: 1px solid ${tm.hairlineOnDark};
  border-radius: 20px;
  padding: 28px 26px;
  margin-bottom: 14px;
  ${lm(.18)}
...
`,xm=vd.div`
  ...
  .track { fill: none; stroke: ${tm.hairlineOnDark}; stroke-width: 9; }
  .fill  { fill: none; stroke-width: 9; stroke-linecap: round;
    stroke: url(#kontorGrad);
    animation: ${om} 1.3s cubic-bezier(0.16, 1, 0.3, 1) both; }
`,vm=vd.div`
  position: absolute; inset: 0;
  display: flex; flex-direction: column; align-items: center; justify-content: center;
  span.score { font-family: ${wd.font.display}; font-size: 30px; font-weight: 700;
    color: ${tm.inkOnDark}; line-height: 1; }
  span.of { font-family: ${nm}; font-size: 9px; letter-spacing: 0.14em;
    color: ${tm.faintOnDark}; margin-top: 4px; }
`,bm=vd.div`
  flex: 1; text-align: left;
  h2 { font-family: ${wd.font.display}; font-size: 19px; font-weight: 700;
    color: ${tm.inkOnDark}; margin: 0 0 6px; letter-spacing: -0.01em;
    sup { font-size: 9px; color: ${tm.teal}; } }
  p { font-size: 13px; line-height: 1.65; color: ${tm.mutedOnDark}; margin: 0; }
`,ym=vd.div`
  display: grid; grid-template-columns: 1fr 1fr 1fr;
  border-top: 1px solid ${tm.hairlineOnDark};
  padding-top: 20px;
...
`,km=vd.div`
  ...
  p.label { font-family: ${nm}; font-size: 9.5px; letter-spacing: 0.18em;
    text-transform: uppercase; color: ${tm.faintOnDark}; margin: 0 0 7px;
    @media (max-width: 520px) { margin: 0; } }
  p.value { font-family: ${wd.font.display}; font-size: 22px; font-weight: 700;
    color: ${tm.inkOnDark}; margin: 0; letter-spacing: -0.01em;
    span.unit { font-size: 12px; font-family: ${wd.font.sans}; font-weight: 500;
      color: ${tm.mutedOnDark}; margin-left: 4px; } }
  &.saving p.value {
    background: ${tm.numberGradient};
    -webkit-background-clip: text; background-clip: text;
    -webkit-text-fill-color: transparent;
    span.unit { -webkit-text-fill-color: ${tm.mutedOnDark}; }
  }
`,jm=vd.h3`
  font-family: ${nm};
  font-size: 10px; font-weight: 500;
  letter-spacing: 0.26em; text-transform: uppercase;
  color: ${tm.faintOnDark};
...
`,Sm=vd.div`
  ...
  &::before {
    ...
    background: ${e=>{let{$saving:t}=e;return t?tm.numberGradient:tm.hairlineOnDark}};
  }
`,$m=vd.div`
  flex: 1; min-width: 0;
  h4 { font-family: ${wd.font.display}; font-size: 16.5px; font-weight: 700;
    color: ${tm.inkOnDark}; margin: 0 0 5px; letter-spacing: -0.005em;
    white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
  p { font-family: ${nm}; font-size: 10px; letter-spacing: 0.1em;
    text-transform: uppercase; color: ${tm.faintOnDark}; margin: 0; }
`,_m=vd.div`
  text-align: right; flex-shrink: 0;
  p.cost { font-size: 13.5px; font-weight: 600; color: ${tm.mutedOnDark}; margin: 0 0 6px; }
`,Em=vd.span`
  display: inline-block;
  font-family: ${nm};
  font-size: 10.5px; font-weight: 500; letter-spacing: 0.06em;
  padding: 4px 11px; border-radius: 100px;
  ${e=>{let{$saving:t}=e;return t?md`color: ${tm.tealBright}; background: rgba(43, 196, 172, 0.12);
        border: 1px solid rgba(43, 196, 172, 0.3);`:md`color: ${tm.faintOnDark}; background: transparent;
        border: 1px solid ${tm.hairlineOnDark};`}}
`,zm=vd.section`
  background: ${tm.bgRaised};
  border: 1px solid ${tm.hairlineOnDark};
  ...
  margin-top: 30px;
  ${lm(.3)}
  h3 { font-family: ${wd.font.display}; font-size: 19px; font-weight: 700;
    color: ${tm.inkOnDark}; margin: 0 0 8px; letter-spacing: -0.01em; }
  p { font-size: 13.5px; line-height: 1.7; color: ${tm.mutedOnDark}; margin: 0 0 16px; }
`,Nm=vd.div`
  font-family: ${nm};
...
`,Am=vd.section`
  ...
  margin-top: 14px;
  ${lm(.34)}
  h3 { font-family: ${wd.font.display}; font-size: 17px; font-weight: 700;
    color: ${tm.inkOnDark}; margin: 0 0 7px; letter-spacing: -0.01em; }
  p { font-size: 13px; line-height: 1.65; color: ${tm.mutedOnDark}; margin: 0 0 16px; }
`,Cm=vd.form`
...
`,Fm=vd.input`
  ...
  border: 1px solid ${tm.hairlineOnDark};
  background: ${tm.bg};
  font-size: 14px; color: ${tm.inkOnDark};
  outline: none; transition: border-color 0.2s;
  &:focus { border-color: ${tm.teal}; }
  &::placeholder { color: ${tm.faintOnDark}; }
`,Tm=vd.button`
  padding: 12px 26px; border-radius: 100px; border: none; cursor: pointer;
  background: ${tm.ctaGradient};
  box-shadow: ${tm.ctaShadow};
  color: ${tm.inkOnDark}; font-size: 14px; font-weight: 700; white-space: nowrap;
...
`,Dm=vd(vl)`
  ...
  background: ${tm.ctaGradient};
  box-shadow: ${tm.ctaShadow};
  color: ${tm.inkOnDark}; font-size: 14px; font-weight: 700;
  text-decoration: none;
  transition: transform 0.2s ease;
  &:hover { transform: translateY(-1px); }
`,Pm=vd.p`
  &&& { margin: 10px 0 0; font-size: 12px; color: ${tm.faintOnDark}; }
`,Om=vd.p`
  &&& { color: ${tm.tealBright}; font-weight: 600; margin: 0; }
`,Rm=vd.div`
  text-align: center;
  background: ${tm.bgRaised};
  border: 1px solid ${tm.hairlineOnDark};
...
`,Lx=vd.div`
  ...
  margin-bottom: 56px;
  text-align: left;
  animation: ${Fx} 0.75s cubic-bezier(0.34, 1.46, 0.64, 1) both;
  box-shadow:
...
`,Mx=vd.span`
  ...
  background: #1DB09A;
  flex-shrink: 0;
  animation: ${Tx} 2.2s ease-in-out infinite;
`,Bx=vd.span`
  font-size: 12px;
  font-weight: 600;
  color: rgba(255,255,255,0.45);
...
`,Oy=vd.a`
  ...
  padding-bottom: 2px;
`,Ry=(e,t)=>500*Math.round((e+t)/2/500);function Ly(e){if(!e)return"";return new Date(e).toLocaleDateString("sv-SE",{day:"numeric",month:"long",year:"numeric"})}function Iy(){var e,t,n,a;const{token:i}=ho(),[o,l]=(0,r.useState)("loading"),[s,c]=(0,r.useState)(null),[d,u]=(0,r.useState)(!1);(0,r.useEffect)(()=>{i?fetch(`/api/prospect?token=${encodeURIComponent(i)}`).then(e=>e.json()).then(e=>{e.ok?(c(e.prospect),l("ready")):l("error")}).catch(()=>l("error")):l("error")},[i]);const p=e=>{d||(u(!0),fetch(`/api/prospect?token=${encodeURIComponent(i)}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({action:e})}).catch(()=>{}))};if("loading"===o)return(0,$d.jsxs)(zy,{children:[(0,$d.jsx)(Ny,{children:[0,1,2].map(e=>(0,$d.jsx)(Ay,{$i:e},e))}),(0,$d.jsx)(Cy,{children:"H\xe4mtar er analys\u2026"})]});if("error"===o)return(0,$d.jsxs)(Fy,{children:[(0,$d.jsx)(Ty,{children:"\ud83d\udd12"}),(0,$d.jsx)(Dy,{children:"Analysen hittades inte"}),(0,$d.jsx)(Py,{children:"L\xe4nken kan ha g\xe5tt ut eller \xe4r ogiltig. Analysera er faktura direkt \u2014 det tar 2 minuter."}),(0,$d.jsx)(Oy,{href:"/testa-faktura",children:"Analysera en faktura \u2192"})]});const{companyName:h,industry:f,employees:m,estimates:g,generatedAt:x}=s,v=null!==(e=null===g||void 0===g?void 0:g.categories)&&void 0!==e?e:[],b=(null===g||void 0===g?void 0:g.hasEstimates)&&((null===g||void 0===g?void 0:g.totalSavingLow)>0||v.length>0),y=null===g||void 0===g?void 0:g.mxPlatform,k=null===g||void 0===g?void 0:g.mxSince,j=null===g||void 0===g?void 0:g.domainRegistered,w=null===g||void 0===g?void 0:g.foundedYear,S=null!==(t=null===g||void 0===g?void 0:g.findings)&&void 0!==t?t:[],$=(_=k)?Math.round((Date.now()-new Date(_).getTime())/2630016e3):0;var _;const E=null!==(n=Uh[y])&&void 0!==n?n:y,z=S.length>0,N=[];S.forEach(e=>N.push({text:e,key:e})),!z&&k?N.push({text:`${E}-konfiguration of\xf6r\xe4ndrad sedan ${Bh(k)} \u2014 ${$} m\xe5nader`,key:"mxSince"}):!z&&y&&N.push({text:`${E} identifierat f\xf6r er dom\xe4n \xb7 ${m} licenser`,key:"mxPlatform"});const A=N.length>0,C=z?"IDENTIFIERAT FYND":"INFRASTRUKTURANALYS",F=z&&(y||j||k),T=null!==(a=null===g||void 0===g?void 0:g.totalSavingCentral)&&void 0!==a?a:b?Ry(g.totalSavingLow,g.totalSavingHigh):null,D=v.map(e=>`${e.estimatedSims} ${"m365"===e.category?"Microsoft 365-licenser":"mobilabonnemang"}`).join(" + ");return(0,$d.jsxs)(Ab,{children:[(0,$d.jsx)(Cb,{}),(0,$d.jsx)(Fb,{children:(0,$d.jsxs)(Tb,{children:[(0,$d.jsx)(Db,{children:"ARVO"}),(0,$d.jsx)(Pb,{children:"Konfidentiell analys"}),(0,$d.jsx)(Ob,{children:h}),(0,$d.jsxs)(Rb,{children:[f&&(0,$d.jsx)("span",{children:f}),f&&m&&(0,$d.jsx)(Lb,{children:"\xb7"}),m&&(0,$d.jsxs)("span",{children:[m," anst\xe4llda"]}),w&&(0,$d.jsxs)($d.Fragment,{children:[(0,$d.jsx)(Lb,{children:"\xb7"}),(0,$d.jsxs)("span",{children:["Grundat ",w]})]})]}),(0,$d.jsx)(Ib,{children:Ly(x)})]})}),A&&(0,$d.jsxs)(Mb,{children:[(0,$d.jsx)(Bb,{children:C}),N.map((e,t)=>(0,$d.jsxs)(Ub,{$i:t,children:[t>0&&(0,$d.jsx)(Vb,{}),(0,$d.jsx)(Hb,{children:e.text})]},e.key)),F&&(0,$d.jsxs)(Kb,{children:[y&&(0,$d.jsxs)(Wb,{children:[(0,$d.jsx)(qb,{children:"E-postplattform"}),(0,$d.jsx)(Yb,{children:E})]}),k&&(0,$d.jsxs)(Wb,{children:[(0,$d.jsx)(qb,{children:"Konfiguration sedan"}),(0,$d.jsxs)(Yb,{$highlight:!0,children:[Bh(k)," \u2014 ",$," m\xe5n"]})]}),j&&(0,$d.jsxs)(Wb,{children:[(0,$d.jsx)(qb,{children:"Dom\xe4n registrerad"}),(0,$d.jsx)(Yb,{children:Bh(j)})]})]})]}),b&&(0,$d.jsxs)(Gb,{children:[(0,$d.jsx)(Bb,{children:"Sannolik kostnadspremie"}),(0,$d.jsxs)(Qb,{children:[(0,$d.jsx)(Jb,{children:"\u2248"}),Ih(T)," ",(0,$d.jsx)("span",{style:{fontSize:"0.42em",letterSpacing:"0em",fontWeight:700},children:"kr/\xe5r"})]}),(0,$d.jsxs)(Xb,{children:[(0,$d.jsx)(Zb,{children:(0,$d.jsx)(ey,{style:{left:`${Math.min(88,Math.max(12,g.totalSavingHigh>g.totalSavingLow?(T-g.totalSavingLow)/(g.totalSavingHigh-g.totalSavingLow)*100:50))}%`}})}),(0,$d.jsxs)(ty,{children:[(0,$d.jsx)("span",{children:Ih(g.totalSavingLow)}),(0,$d.jsxs)("span",{children:[Ih(g.totalSavingHigh)," kr/\xe5r"]})]})]}),D&&(0,$d.jsxs)(ny,{children:["Baserat p\xe5 ",D," mot verifierade listpriser"]}),(0,$d.jsx)(ry,{children:"Er faktiska avtalskostnad ser vi inte f\xf6rr\xe4n ni delar er faktura"})]}),v.length>0&&(0,$d.jsxs)(ay,{children:[(0,$d.jsx)(iy,{children:"Kostnadsanalys per kategori"}),v.map((e,t)=>{var n;const r="m365"===e.category?"licens":"abonnemang",a=null!==(n=e.savingCentral)&&void 0!==n?n:Ry(e.savingLow,e.savingHigh);return(0,$d.jsxs)(oy,{children:[(0,$d.jsx)(ly,{children:e.label}),(0,$d.jsxs)(sy,{children:[(0,$d.jsx)(cy,{children:"m365"===e.category?"Uppskattade licenser":"Uppskattade abonnemang"}),(0,$d.jsxs)(dy,{children:[e.estimatedSims," st"]})]}),(0,$d.jsxs)(sy,{children:[(0,$d.jsx)(cy,{children:"Typisk marknadskostnad"}),(0,$d.jsxs)(dy,{children:[Ih(e.typicalLow),"\u2013",Ih(e.typicalHigh)," kr/\xe5r",(0,$d.jsx)(uy,{children:"live"===e.source?`median av verifierade fakturor: ${e.pricePerSim.typical} kr/m\xe5n per ${r} \xb1 15 %`:`ordinarie listpris ${e.pricePerSim.typical} kr/m\xe5n per ${r} \xb1 15 %`})]})]}),(0,$d.jsxs)(sy,{children:[(0,$d.jsx)(cy,{children:"Arvo-pris, verifierat listpris"}),(0,$d.jsxs)(dy,{$highlight:!0,children:[Ih(e.arvoAnnual)," kr/\xe5r",(0,$d.jsxs)(uy,{children:[e.pricePerSim.arvo," kr/m\xe5n per ",r]})]})]}),(0,$d.jsx)(gy,{children:e.sourceNote}),(0,$d.jsxs)(py,{children:[(0,$d.jsx)(hy,{children:"Sannolik premie"}),(0,$d.jsxs)("div",{children:[(0,$d.jsxs)(fy,{children:["\u2248 ",Ih(a)," kr/\xe5r"]}),(0,$d.jsxs)(my,{children:["intervall ",Ih(e.savingLow),"\u2013",Ih(e.savingHigh)]})]})]})]},t)})]}),(0,$d.jsxs)(xy,{children:[(0,$d.jsxs)(vy,{children:["Arvo har analyserat den publika DNS-konfigurationen f\xf6r ",h,"s dom\xe4n. Ingen data har inh\xe4mtats fr\xe5n er eller era leverant\xf6rer utan ert tillst\xe5nd."]}),(0,$d.jsxs)(by,{children:[(0,$d.jsx)(yy,{href:"/testa-faktura",onClick:()=>p("upload"),children:"Se er exakta premie"}),(0,$d.jsx)(ky,{children:"Ladda upp en faktura \xb7 Kostnadsfritt \xb7 2 minuter \xb7 Ingen registrering"})]}),(0,$d.jsx)(jy,{}),(0,$d.jsx)(wy,{href:"/intelligence#aktivera",onClick:()=>p("activate"),children:"Eller l\xe5t Arvo bevaka er l\xf6pande \u2014 Arvo Intelligence, 1\xa0995 kr/m\xe5n \u2192"}),(0,$d.jsx)(Sy,{children:"Ingen bindningstid \xb7 Bevakningen b\xf6rjar inom 24 timmar"})]}),(0,$d.jsxs)($y,{children:[(0,$d.jsx)(_y,{children:"arvoflow.se"}),(0,$d.jsx)(Ey,{children:"Arvo Intelligence"})]})]})}"scrollRestoration"in window.history&&(window.history.scrollRestoration="manual");const My=()=>{const{pathname:e}=so();return(0,r.useEffect)(()=>{window.scrollTo(0,0)},[e]),null},By=()=>(0,$d.jsxs)(dd,{theme:wd,children:[(0,$d.jsx)(Sd,{}),(0,$d.jsx)(gl,{basename:"/flow",children:(0,$d.jsxs)(Nd,{children:[(0,$d.jsx)(My,{}),(0,$d.jsxs)(Oo,{children:[(0,$d.jsx)(Do,{path:"/",element:(0,$d.jsx)(Ap,{})}),(0,$d.jsx)(Do,{path:"/connect",element:(0,$d.jsx)(rh,{})}),(0,$d.jsx)(Do,{path:"/bias",element:(0,$d.jsx)(bh,{})}),(0,$d.jsx)(Do,{path:"/villkor",element:(0,$d.jsx)(Ph,{})}),(0,$d.jsx)(Do,{path:"/integritet",element:(0,$d.jsx)(Oh,{})}),(0,$d.jsx)(Do,{path:"/cookies",element:(0,$d.jsx)(Rh,{})}),(0,$d.jsx)(Do,{path:"/testa-faktura",element:(0,$d.jsx)(em,{})}),(0,$d.jsx)(Do,{path:"/portfolio",element:(0,$d.jsx)(Um,{})}),(0,$d.jsx)(Do,{path:"/admin",element:(0,$d.jsx)(ug,{})}),(0,$d.jsx)(Do,{path:"/utfall",element:(0,$d.jsx)(wg,{})}),(0,$d.jsx)(Do,{path:"/briefing/:token",element:(0,$d.jsx)(Ax,{})}),(0,$d.jsx)(Do,{path:"/intelligence",element:(0,$d.jsx)(Dv,{})}),(0,$d.jsx)(Do,{path:"/aktivera",element:(0,$d.jsx)(Sb,{})}),(0,$d.jsx)(Do,{path:"/prospect/:token",element:(0,$d.jsx)(Iy,{})}),(0,$d.jsx)(Do,{path:"*",element:(0,$d.jsx)(To,{to:"/",replace:!0})})]})]})})]});!function(){var e;const t={NODE_ENV:"production",PUBLIC_URL:"/flow",WDS_SOCKET_HOST:void 0,WDS_SOCKET_PATH:void 0,WDS_SOCKET_PORT:void 0,FAST_REFRESH:!0}.REACT_APP_SENTRY_DSN;t&&ni({dsn:t,environment:null!==(e="production")?e:"production",release:{NODE_ENV:"production",PUBLIC_URL:"/flow",WDS_SOCKET_HOST:void 0,WDS_SOCKET_PATH:void 0,WDS_SOCKET_PORT:void 0,FAST_REFRESH:!0}.REACT_APP_VERSION,tracesSampleRate:.1,beforeSend(e){var t,n,r,a;const i=null!==(t=null===(n=e.exception)||void 0===n||null===(r=n.values)||void 0===r||null===(a=r[0])||void 0===a?void 0:a.value)&&void 0!==t?t:"";return i.includes("Network request failed")||i.includes("Load failed")?null:e}})}();(0,i.createRoot)(document.getElementById("root")).render((0,$d.jsx)(By,{}))})();
//# sourceMappingURL=main.773a98ad.js.map