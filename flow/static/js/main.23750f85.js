...
`,ij=function(){return md`
  opacity: 0;
  animation: ${rj} 0.75s ${arguments.length>0&&void 0!==arguments[0]?arguments[0]:0}s cubic-bezier(0.16, 1, 0.3, 1) forwards;
`},oj="'JetBrains Mono', 'SF Mono', ui-monospace, Menlo, monospace",lj=vd.div`
  min-height: 100vh;
  background: #050B09;
...
`,bj=vd.div`
  ...
  ${e=>{let{$i:t}=e;return ij(.08+.06*(null!==t&&void 0!==t?t:0))}}
`,yj=vd.div`
  width: 36px;
  height: 1px;
...
`,$j=vd.span`
  ...
  font-size: 12.5px;
  font-weight: 500;
  color: ${e=>{let{$highlight:t}=e;return t?"#5DD6CA":"rgba(255,255,255,0.88)"}};
  text-align: right;
`,zj=vd.div`
  background: #050B09;
  border-top: 1px solid rgba(255,255,255,0.07);
...
`,Mj=vd.span`
  ...
  font-size: 13px;
  font-weight: 600;
  color: ${e=>{let{$highlight:t}=e;return t?"#1B7A6E":"rgba(14,26,23,0.84)"}};
  text-align: right;
`,Vj=vd.span`
  display: block;
...
`,iw=vd.div`
  ...
  justify-content: center;
  gap: 16px;
`,ow=vd.div`display: flex; gap: 8px;`,lw=vd.div`
  width: 8px; height: 8px;
  border-radius: 50%;
  background: #1DB09A;
...
`,hw=vd.a`
  ...
  padding-bottom: 2px;
`,fw=e=>null!=e?new Intl.NumberFormat("sv-SE",{maximumFractionDigits:0}).format(e):"\u2013",mw=(e,t)=>500*Math.round((e+t)/2/500),gw={microsoft365:"Microsoft 365",google:"Google Workspace",zoho:"Zoho Mail",other:"Anpassad e-postl\xf6sning"},xw=["januari","februari","mars","april","maj","juni","juli","augusti","september","oktober","november","december"];function vw(e){if(!e)return null;const[t,r]=e.split("-");return`${xw[parseInt(r)-1]} ${t}`}function bw(e){if(!e)return"";return new Date(e).toLocaleDateString("sv-SE",{day:"numeric",month:"long",year:"numeric"})}function yw(){var e,t,r,a;const{token:i}=ho(),[o,l]=(0,n.useState)("loading"),[s,c]=(0,n.useState)(null),[d,u]=(0,n.useState)(!1);(0,n.useEffect)(()=>{i?fetch(`/api/prospect?token=${encodeURIComponent(i)}`).then(e=>e.json()).then(e=>{e.ok?(c(e.prospect),l("ready")):l("error")}).catch(()=>l("error")):l("error")},[i]);const p=e=>{d||(u(!0),fetch(`/api/prospect?token=${encodeURIComponent(i)}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({action:e})}).catch(()=>{}))};if("loading"===o)return(0,$d.jsxs)(iw,{children:[(0,$d.jsx)(ow,{children:[0,1,2].map(e=>(0,$d.jsx)(lw,{$i:e},e))}),(0,$d.jsx)(sw,{children:"H\xe4mtar er analys\u2026"})]});if("error"===o)return(0,$d.jsxs)(cw,{children:[(0,$d.jsx)(dw,{children:"\ud83d\udd12"}),(0,$d.jsx)(uw,{children:"Analysen hittades inte"}),(0,$d.jsx)(pw,{children:"L\xe4nken kan ha g\xe5tt ut eller \xe4r ogiltig. Analysera er faktura direkt \u2014 det tar 2 minuter."}),(0,$d.jsx)(hw,{href:"/testa-faktura",children:"Analysera en faktura \u2192"})]});const{companyName:h,industry:f,employees:m,estimates:g,generatedAt:x}=s,v=null!==(e=null===g||void 0===g?void 0:g.categories)&&void 0!==e?e:[],b=(null===g||void 0===g?void 0:g.hasEstimates)&&((null===g||void 0===g?void 0:g.totalSavingLow)>0||v.length>0),y=null===g||void 0===g?void 0:g.mxPlatform,k=null===g||void 0===g?void 0:g.mxSince,j=null===g||void 0===g?void 0:g.domainRegistered,w=null===g||void 0===g?void 0:g.foundedYear,S=null!==(t=null===g||void 0===g?void 0:g.findings)&&void 0!==t?t:[],$=(z=k)?Math.round((Date.now()-new Date(z).getTime())/2630016e3):0;var z;const E=null!==(r=gw[y])&&void 0!==r?r:y,_=S.length>0,N=[];S.forEach(e=>N.push({text:e,key:e})),!_&&k?N.push({text:`${E}-konfiguration of\xf6r\xe4ndrad sedan ${vw(k)} \u2014 ${$} m\xe5nader`,key:"mxSince"}):!_&&y&&N.push({text:`${E} identifierat f\xf6r er dom\xe4n \xb7 ${m} licenser`,key:"mxPlatform"});const A=N.length>0,C=_?"IDENTIFIERAT FYND":"INFRASTRUKTURANALYS",F=_&&(y||j||k),T=null!==(a=null===g||void 0===g?void 0:g.totalSavingCentral)&&void 0!==a?a:b?mw(g.totalSavingLow,g.totalSavingHigh):null,D=v.map(e=>`${e.estimatedSims} ${"m365"===e.category?"Microsoft 365-licenser":"mobilabonnemang"}`).join(" + ");return(0,$d.jsxs)(lj,{children:[(0,$d.jsx)(sj,{}),(0,$d.jsx)(cj,{children:(0,$d.jsxs)(dj,{children:[(0,$d.jsx)(uj,{children:"ARVO"}),(0,$d.jsx)(pj,{children:"Konfidentiell analys"}),(0,$d.jsx)(hj,{children:h}),(0,$d.jsxs)(fj,{children:[f&&(0,$d.jsx)("span",{children:f}),f&&m&&(0,$d.jsx)(mj,{children:"\xb7"}),m&&(0,$d.jsxs)("span",{children:[m," anst\xe4llda"]}),w&&(0,$d.jsxs)($d.Fragment,{children:[(0,$d.jsx)(mj,{children:"\xb7"}),(0,$d.jsxs)("span",{children:["Grundat ",w]})]})]}),(0,$d.jsx)(gj,{children:bw(x)})]})}),A&&(0,$d.jsxs)(xj,{children:[(0,$d.jsx)(vj,{children:C}),N.map((e,t)=>(0,$d.jsxs)(bj,{$i:t,children:[t>0&&(0,$d.jsx)(yj,{}),(0,$d.jsx)(kj,{children:e.text})]},e.key)),F&&(0,$d.jsxs)(jj,{children:[y&&(0,$d.jsxs)(wj,{children:[(0,$d.jsx)(Sj,{children:"E-postplattform"}),(0,$d.jsx)($j,{children:E})]}),k&&(0,$d.jsxs)(wj,{children:[(0,$d.jsx)(Sj,{children:"Konfiguration sedan"}),(0,$d.jsxs)($j,{$highlight:!0,children:[vw(k)," \u2014 ",$," m\xe5n"]})]}),j&&(0,$d.jsxs)(wj,{children:[(0,$d.jsx)(Sj,{children:"Dom\xe4n registrerad"}),(0,$d.jsx)($j,{children:vw(j)})]})]})]}),b&&(0,$d.jsxs)(zj,{children:[(0,$d.jsx)(vj,{children:"Sannolik kostnadspremie"}),(0,$d.jsxs)(Ej,{children:[(0,$d.jsx)(_j,{children:"\u2248"}),fw(T)," ",(0,$d.jsx)("span",{style:{fontSize:"0.42em",letterSpacing:"0em",fontWeight:700},children:"kr/\xe5r"})]}),(0,$d.jsxs)(Nj,{children:[(0,$d.jsx)(Aj,{children:(0,$d.jsx)(Cj,{style:{left:`${Math.min(88,Math.max(12,g.totalSavingHigh>g.totalSavingLow?(T-g.totalSavingLow)/(g.totalSavingHigh-g.totalSavingLow)*100:50))}%`}})}),(0,$d.jsxs)(Fj,{children:[(0,$d.jsx)("span",{children:fw(g.totalSavingLow)}),(0,$d.jsxs)("span",{children:[fw(g.totalSavingHigh)," kr/\xe5r"]})]})]}),D&&(0,$d.jsxs)(Tj,{children:["Baserat p\xe5 ",D," mot verifierade listpriser"]}),(0,$d.jsx)(Dj,{children:"Er faktiska avtalskostnad ser vi inte f\xf6rr\xe4n ni delar er faktura"})]}),v.length>0&&(0,$d.jsxs)(Pj,{children:[(0,$d.jsx)(Lj,{children:"Kostnadsanalys per kategori"}),v.map((e,t)=>{var r;const n="m365"===e.category?"licens":"abonnemang",a=null!==(r=e.savingCentral)&&void 0!==r?r:mw(e.savingLow,e.savingHigh);return(0,$d.jsxs)(Rj,{children:[(0,$d.jsx)(Oj,{children:e.label}),(0,$d.jsxs)(Ij,{children:[(0,$d.jsx)(Bj,{children:"m365"===e.category?"Uppskattade licenser":"Uppskattade abonnemang"}),(0,$d.jsxs)(Mj,{children:[e.estimatedSims," st"]})]}),(0,$d.jsxs)(Ij,{children:[(0,$d.jsx)(Bj,{children:"Typisk marknadskostnad"}),(0,$d.jsxs)(Mj,{children:[fw(e.typicalLow),"\u2013",fw(e.typicalHigh)," kr/\xe5r",(0,$d.jsxs)(Vj,{children:["median ",e.pricePerSim.typical," kr/m\xe5n per ",n," \xb1 15 %"]})]})]}),(0,$d.jsxs)(Ij,{children:[(0,$d.jsx)(Bj,{children:"Arvo-pris, verifierat listpris"}),(0,$d.jsxs)(Mj,{$highlight:!0,children:[fw(e.arvoAnnual)," kr/\xe5r",(0,$d.jsxs)(Vj,{children:[e.pricePerSim.arvo," kr/m\xe5n per ",n]})]})]}),(0,$d.jsx)(qj,{children:e.sourceNote}),(0,$d.jsxs)(Uj,{children:[(0,$d.jsx)(Kj,{children:"Sannolik premie"}),(0,$d.jsxs)("div",{children:[(0,$d.jsxs)(Hj,{children:["\u2248 ",fw(a)," kr/\xe5r"]}),(0,$d.jsxs)(Wj,{children:["intervall ",fw(e.savingLow),"\u2013",fw(e.savingHigh)]})]})]})]},t)})]}),(0,$d.jsxs)(Yj,{children:[(0,$d.jsxs)(Gj,{children:["Arvo har analyserat den publika DNS-konfigurationen f\xf6r ",h,"s dom\xe4n. Ingen data har inh\xe4mtats fr\xe5n er eller era leverant\xf6rer utan ert tillst\xe5nd."]}),(0,$d.jsxs)(Qj,{children:[(0,$d.jsx)(Jj,{href:"/testa-faktura",onClick:()=>p("upload"),children:"Se er exakta premie"}),(0,$d.jsx)(Xj,{children:"Ladda upp en faktura \xb7 Kostnadsfritt \xb7 2 minuter \xb7 Ingen registrering"})]}),(0,$d.jsx)(Zj,{}),(0,$d.jsx)(ew,{href:"/intelligence#aktivera",onClick:()=>p("activate"),children:"Eller l\xe5t Arvo bevaka er l\xf6pande \u2014 Arvo Intelligence, 1\xa0995 kr/m\xe5n \u2192"}),(0,$d.jsx)(tw,{children:"Ingen bindningstid \xb7 Bevakningen b\xf6rjar inom 24 timmar"})]}),(0,$d.jsxs)(rw,{children:[(0,$d.jsx)(nw,{children:"arvoflow.se"}),(0,$d.jsx)(aw,{children:"Arvo Intelligence"})]})]})}"scrollRestoration"in window.history&&(window.history.scrollRestoration="manual");const kw=()=>{const{pathname:e}=so();return(0,n.useEffect)(()=>{window.scrollTo(0,0)},[e]),null},jw=()=>(0,$d.jsxs)(dd,{theme:wd,children:[(0,$d.jsx)(Sd,{}),(0,$d.jsx)(gl,{basename:"/flow",children:(0,$d.jsxs)(Nd,{children:[(0,$d.jsx)(kw,{}),(0,$d.jsxs)(Lo,{children:[(0,$d.jsx)(Do,{path:"/",element:(0,$d.jsx)(Kp,{})}),(0,$d.jsx)(Do,{path:"/connect",element:(0,$d.jsx)(xh,{})}),(0,$d.jsx)(Do,{path:"/scanning",element:(0,$d.jsx)(Ph,{})}),(0,$d.jsx)(Do,{path:"/insights",element:(0,$d.jsx)(bf,{})}),(0,$d.jsx)(Do,{path:"/opportunity/:id",element:(0,$d.jsx)(Yf,{})}),(0,$d.jsx)(Do,{path:"/bias",element:(0,$d.jsx)(dm,{})}),(0,$d.jsx)(Do,{path:"/villkor",element:(0,$d.jsx)(zm,{})}),(0,$d.jsx)(Do,{path:"/integritet",element:(0,$d.jsx)(Em,{})}),(0,$d.jsx)(Do,{path:"/cookies",element:(0,$d.jsx)(_m,{})}),(0,$d.jsx)(Do,{path:"/testa-faktura",element:(0,$d.jsx)(Ig,{})}),(0,$d.jsx)(Do,{path:"/portfolio",element:(0,$d.jsx)(Hx,{})}),(0,$d.jsx)(Do,{path:"/admin",element:(0,$d.jsx)(fv,{})}),(0,$d.jsx)(Do,{path:"/utfall",element:(0,$d.jsx)(zv,{})}),(0,$d.jsx)(Do,{path:"/arvo-score",element:(0,$d.jsx)(eb,{})}),(0,$d.jsx)(Do,{path:"/briefing/:token",element:(0,$d.jsx)(ly,{})}),(0,$d.jsx)(Do,{path:"/intelligence",element:(0,$d.jsx)(uk,{})}),(0,$d.jsx)(Do,{path:"/aktivera",element:(0,$d.jsx)(tj,{})}),(0,$d.jsx)(Do,{path:"/prospect/:token",element:(0,$d.jsx)(yw,{})}),(0,$d.jsx)(Do,{path:"*",element:(0,$d.jsx)(To,{to:"/",replace:!0})})]})]})})]});!function(){var e;const t={NODE_ENV:"production",PUBLIC_URL:"/flow",WDS_SOCKET_HOST:void 0,WDS_SOCKET_PATH:void 0,WDS_SOCKET_PORT:void 0,FAST_REFRESH:!0}.REACT_APP_SENTRY_DSN;t&&ri({dsn:t,environment:null!==(e="production")?e:"production",release:{NODE_ENV:"production",PUBLIC_URL:"/flow",WDS_SOCKET_HOST:void 0,WDS_SOCKET_PATH:void 0,WDS_SOCKET_PORT:void 0,FAST_REFRESH:!0}.REACT_APP_VERSION,tracesSampleRate:.1,beforeSend(e){var t,r,n,a;const i=null!==(t=null===(r=e.exception)||void 0===r||null===(n=r.values)||void 0===n||null===(a=n[0])||void 0===a?void 0:a.value)&&void 0!==t?t:"";return i.includes("Network request failed")||i.includes("Load failed")?null:e}})}();(0,i.createRoot)(document.getElementById("root")).render((0,$d.jsx)(jw,{}))})();
//# sourceMappingURL=main.23750f85.js.map