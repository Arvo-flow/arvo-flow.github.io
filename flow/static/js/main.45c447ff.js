/*! For license information please see main.45c447ff.js.LICENSE.txt */
...
`,Qf=vd.div`
  ...
  .door-tag { font-family:${xf}; font-size:8.5px; letter-spacing:.12em; text-transform:uppercase;
...
`,Jf=vd.button`
  ...
  .ac-copy { flex-shrink:0; display:inline-flex; align-items:center; gap:6px;
    font-family:${xf}; font-size:10px; letter-spacing:.12em; text-transform:uppercase;
    color:${wd.dossier.faintOnDark}; }
...
//# sourceMappingURL=main.45c447ff.js.map