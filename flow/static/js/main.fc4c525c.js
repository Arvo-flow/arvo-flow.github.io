/*! For license information please see main.fc4c525c.js.LICENSE.txt */
...
`;function uf(e){let{email:t,setEmail:r,onSubmit:n,loading:a,reveal:i,note:o}=e;return(0,$d.jsxs)($d.Fragment,{children:[(0,$d.jsxs)(df,{onSubmit:n,children:[(0,$d.jsx)("div",{className:"rp-k",children:"Innan f\xf6rsta fakturan"}),(0,$d.jsxs)("p",{className:"rp-lede",children:["Ange er ",(0,$d.jsx)("b",{children:"f\xf6retagsmejl"}),". Innan ni delat en enda siffra l\xe4gger Arvo fram vad vi redan ser om er \u2014 varje rad med sin k\xe4lla."]}),(0,$d.jsxs)("div",{className:"rp-row",children:[(0,$d.jsx)("input",{type:"email",inputMode:"email",autoComplete:"email",placeholder:"namn@ertbolag.se",value:t,onChange:e=>r(e.target.value),disabled:a}),(0,$d.jsx)("button",{type:"submit",disabled:a||!t.trim(),children:a?"L\xe4ser av\u2026":"Visa vad vi ser \u2192"})]}),o&&(0,$d.jsx)("p",{className:"rp-note",children:o})]}),i&&(0,$d.jsx)(pf,{domain:i.domain,findings:i.findings})]})}function pf(e){let{domain:t,findings:r}=e;return t&&null!==r&&void 0!==r&&r.length?(0,$d.jsxs)(cf,{children:[(0,$d.jsxs)("div",{className:"rv-eyebrow",children:["Avl\xe4st \xb7 ",t]}),r.map((e,t)=>(0,$d.jsxs)("div",{className:"rv-find",children:[(0,$d.jsx)("div",{className:"rv-title",children:e.title}),e.detail&&(0,$d.jsx)("div",{className:"rv-detail",children:e.detail}),(0,$d.jsxs)("div",{className:"rv-source",children:[(0,$d.jsx)("b",{children:"K\xe4lla:"})," ",e.source]})]},t)),(0,$d.jsxs)("p",{className:"rv-foot",children:["Allt ovan \xe4r ",(0,$d.jsx)("b",{children:"publik fakta"}),", avl\xe4st p\xe5 sekunder \u2014 innan ni loggat in, utan att ni l\xe4mnat ifr\xe5n er n\xe5got. T\xe4nk er vad vakten ser den dag ni delar en faktura."]})]}):null}const hf=vd.div`
...
//# sourceMappingURL=main.fc4c525c.js.map