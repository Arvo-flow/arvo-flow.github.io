...
`;var $d=r(579);const zd=(0,n.createContext)(null),_d="arvo_user_email",Nd=(()=>{try{var e;return null!==(e=new URLSearchParams(window.location.search).get("magic"))&&void 0!==e?e:null}catch{return null}})();function Ed(e){let{children:t}=e;const[r,a]=(0,n.useState)(()=>{try{return localStorage.getItem(_d)||null}catch{return null}}),[i,o]=(0,n.useState)("idle");(0,n.useEffect)(()=>{const e=Nd;e&&(o("validating"),fetch("/api/validate-magic",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e})}).then(e=>{if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()}).then(e=>{if(e.email){try{localStorage.setItem(_d,e.email)}catch{}a(e.email),o("ok")}else o("error")}).catch(e=>{console.error("[auth] validate-magic misslyckades:",e.message),o("error")}))},[]);const s=(0,n.useCallback)(e=>{try{localStorage.setItem(_d,e)}catch{}a(e)},[]),l=(0,n.useCallback)(()=>{try{localStorage.removeItem(_d)}catch{}a(null)},[]);return(0,$d.jsx)(zd.Provider,{value:{email:r,login:s,logout:l,magicState:i},children:t})}function Ad(){return(0,n.useContext)(zd)}const Cd=vd.span`
  display: inline-flex;
  align-items: center;
  gap: 12px;
  font-family: ${e=>{let{theme:t}=e;return t.font.display}};
...
`;function df(e){let{email:t,setEmail:r,onSubmit:n,loading:a,reveal:i,note:o}=e;return(0,$d.jsxs)($d.Fragment,{children:[(0,$d.jsxs)(cf,{onSubmit:n,children:[(0,$d.jsx)("div",{className:"rp-k",children:"Innan ni laddar upp"}),(0,$d.jsxs)("p",{className:"rp-lede",children:["Skriv er ",(0,$d.jsx)("b",{children:"jobbadress"})," \u2014 s\xe5 visar Arvo vad vi redan kan l\xe4sa av om er, k\xe4llbelagt, innan ni gett oss en enda faktura."]}),(0,$d.jsxs)("div",{className:"rp-row",children:[(0,$d.jsx)("input",{type:"email",inputMode:"email",autoComplete:"email",placeholder:"namn@ertbolag.se",value:t,onChange:e=>r(e.target.value),disabled:a}),(0,$d.jsx)("button",{type:"submit",disabled:a||!t.trim(),children:a?"L\xe4ser av\u2026":"Se vad vi redan vet \u2192"})]}),o&&(0,$d.jsx)("p",{className:"rp-note",children:o})]}),i&&(0,$d.jsx)(uf,{domain:i.domain,findings:i.findings})]})}function uf(e){let{domain:t,findings:r}=e;return t&&null!==r&&void 0!==r&&r.length?(0,$d.jsxs)(lf,{children:[(0,$d.jsxs)("div",{className:"rv-eyebrow",children:["Arvo l\xe4ste av ",t]}),r.map((e,t)=>(0,$d.jsxs)("div",{className:"rv-find",children:[(0,$d.jsx)("div",{className:"rv-title",children:e.title}),e.detail&&(0,$d.jsx)("div",{className:"rv-detail",children:e.detail}),(0,$d.jsxs)("div",{className:"rv-source",children:[(0,$d.jsx)("b",{children:"K\xe4lla:"})," ",e.source]})]},t)),(0,$d.jsxs)("p",{className:"rv-foot",children:["Allt ovan \xe4r ",(0,$d.jsx)("b",{children:"publik fakta"})," vi l\xe4ste av p\xe5 sekunder \u2014 innan ni ens loggat in, utan att ni gett oss n\xe5got. T\xe4nk vad vakten ser n\xe4r ni delar er f\xf6rsta faktura."]})]}):null}const pf=wd.font.mono,hf=wd.font.display,mf=jd`from { opacity:0; transform:translateY(22px); } to { opacity:1; transform:translateY(0); }`,ff=jd`to { transform: rotate(360deg); }`,gf=(jd`0%,100% { opacity:.25; } 50% { opacity:1; }`,jd`0%,100% { opacity:.6; } 50% { opacity:1; }`),xf=(jd`0% { background-position:-200% 0; } 100% { background-position:200% 0; }`,function(){return fd`opacity:0; animation:${mf} .7s ${arguments.length>0&&void 0!==arguments[0]?arguments[0]:0}s cubic-bezier(0.16,1,0.3,1) forwards;`}),vf=vd.main`
  min-height: 100vh;
...
`,yf=(vd.div`
  ...
  font-family: ${pf}; font-size: 10px; letter-spacing: .26em; text-transform: uppercase;
...
`),kf=vd.div`
  .brand {
    font-family: ${pf}; font-size: 11px; font-weight: 600;
  ...
  h1 {
    font-family: ${hf}; font-weight: 700; line-height: 1.02; letter-spacing: -.03em;
...
`,jf=vd.div`
  ...
  .disc .sweep {
    ...
    animation: ${ff} 3.2s linear infinite;
    mask: radial-gradient(circle, #000 62%, transparent 63%);
    -webkit-mask: radial-gradient(circle, #000 62%, transparent 63%);
  }
  .radar-title {
    font-family: ${pf}; font-size: 10px; letter-spacing: .22em; text-transform: uppercase;
  ...
  .rstat {
    ...
    span.v { font-family: ${pf}; color: ${wd.dossier.inkOnDark}; font-feature-settings:'tnum'; }
  }
  .radar-foot {
    ...
    .live { width: 7px; height: 7px; border-radius: 50%; background: ${wd.dossier.tealBright};
      box-shadow: ${wd.dossier.glow}; animation: ${gf} 2.4s ease-in-out infinite; }
  }
`,wf=vd.section`
  ...
  .eyebrow {
    font-family: ${pf}; font-size: 11px; letter-spacing: .26em; text-transform: uppercase;
  ...
  h2 {
    font-family: ${hf}; font-weight: 600; letter-spacing: -.02em;
...
`,Sf=vd.span`
  display: inline-flex; align-items: center; gap: 8px;
  font-family: ${pf}; font-size: 11px; letter-spacing: .04em;
...
`,_f=vd.div`
  ...
  .card-eyebrow {
    font-family: ${pf}; font-size: 10px; letter-spacing: .24em; text-transform: uppercase;
...
`,Nf=vd(_f)`
  ...
  h3 {
    font-family: ${hf}; font-weight: 600; font-size: clamp(21px, 2.6vw, 27px);
  ...
  .barrow {
    ...
    .amt { font-family: ${pf}; font-feature-settings:'tnum'; color: ${wd.dossier.inkOnDark};
      white-space: nowrap; }
...
`,Ef=vd(_f)`
  ...
  .idx-num {
    font-family: ${pf}; font-weight: 700; font-size: 72px; line-height: .9;
    letter-spacing: -.04em; font-feature-settings:'tnum';
    background: ${wd.dossier.numberGradient};
    -webkit-background-clip: text; background-clip: text; -webkit-text-fill-color: transparent;
  }
  .idx-denom { font-family: ${pf}; font-size: 22px; font-weight: 500; letter-spacing: -.02em;
    color: ${wd.dossier.faintOnDark}; padding-bottom: 8px; }
  .idx-delta {
    font-family: ${pf}; font-size: 13px; color: ${wd.dossier.tealBright};
  ...
  .mkt-k { font-family: ${pf}; font-size: 10px; letter-spacing: .18em; text-transform: uppercase;
  ...
  .mkt-scale { display: flex; justify-content: space-between;
    font-family: ${pf}; font-size: 9.5px; letter-spacing: .08em; text-transform: uppercase;
    color: ${wd.dossier.faintOnDark};
...
`,Af=vd(_f)`
  ...
  .cal-prob {
    font-family: ${pf}; font-size: 15px; font-weight: 600; font-feature-settings:'tnum';
  ...
  .cal-when {
    font-family: ${pf}; font-size: 11px; letter-spacing: .1em; text-transform: uppercase;
...
`,Cf=vd(_f)`
  ...
  .rcpt .day { font-family: ${pf}; font-size: 11px; letter-spacing: .14em; text-transform: uppercase;
...
`,Ff=vd(_f)`
  ...
  .tally-k { font-family: ${pf}; font-size: 10px; letter-spacing: .24em; text-transform: uppercase;
    color: ${wd.dossier.teal}; margin-bottom: 14px; }
  .tally-num { font-family: ${hf}; font-weight: 600; font-size: clamp(36px, 6vw, 52px);
...
`,Df=vd.section`
  ...
  ${xf(.24)}
  .h-eyebrow { font-family: ${pf}; font-size: 10px; letter-spacing: .24em; text-transform: uppercase;
    color: ${wd.dossier.teal}; margin-bottom: 18px; }
  .h-row {
  ...
  .h-cost { font-family: ${pf}; font-size: 13.5px; color: ${wd.dossier.mutedOnDark};
    font-feature-settings:'tnum'; white-space: nowrap;
    @media (max-width:560px){ grid-column:2; grid-row:1; } }
  .h-state { font-family: ${pf}; font-size: 10.5px; letter-spacing: .1em; text-transform: uppercase;
...
`,Tf=vd.div`
  ...
  .mark { font-family: ${pf}; font-size: 11px; letter-spacing: .36em; text-indent: .36em;
    color: ${wd.dossier.faintOnDark}; }
  .tagline { font-family: ${hf}; font-style: italic; font-size: 16px;
...
`,Of=vd.button`
  ...
  .h-badge { font-family:${pf}; font-size:13px; letter-spacing:.06em;
...
`,Lf=vd.div`
  ...
  span.v { position:absolute; inset:0; display:flex; align-items:center; justify-content:center;
    font-family:${pf}; font-size:15px; font-weight:700; font-feature-settings:'tnum'; }
`,Rf=vd.div`
  padding:6px 0 24px; animation:${mf} .28s ease both;
  display:flex; flex-direction:column; gap:18px;

  /* Arvo bedömer — bara omdömet (score-ringen bor i radhuvudet, ej dubblerad) */
  .diag { padding:0 2px; }
  .diag .dbody .dtop { font-family:${pf}; font-size:10px; letter-spacing:.18em; text-transform:uppercase;
  ...
  .fact { display:flex; justify-content:space-between; align-items:baseline; gap:14px;
    ...
    dd { font-family:${pf}; color:${wd.dossier.inkOnDark}; font-feature-settings:'tnum'; margin:0; } }
`,If=vd.div`
  ...
  .si-k { font-family:${pf}; font-size:10px; letter-spacing:.24em; text-transform:uppercase;
    color:${wd.dossier.teal}; margin-bottom:14px; }
  ...
  .si-n { flex-shrink:0; width:22px; height:22px; border-radius:50%;
    ...
    font-family:${pf}; font-size:11px; font-weight:600; display:flex; align-items:center; justify-content:center; }
  ...
  .si-offer { display:flex; align-items:baseline; gap:8px; margin-bottom:6px;
    ...
    .old { font-family:${pf}; font-size:13px; color:${wd.dossier.faintOnDark};
      text-decoration:line-through; }
    .arr { color:${wd.dossier.faintOnDark}; }
    .new { font-family:${pf}; font-size:20px; font-weight:700; font-feature-settings:'tnum';
      color:${wd.dossier.tealBright}; }
...
`,Bf=vd.div`
  ...
  ${xf(.1)}
  .iq-k { font-family:${pf}; font-size:10px; letter-spacing:.24em; text-transform:uppercase;
    color:${wd.dossier.teal}; margin-bottom:14px; }
  h3 { font-family:${hf}; font-weight:600; font-size:clamp(22px,3.2vw,30px); line-height:1.16;
  ...
  .iq-price { font-family:${pf}; font-size:19px; font-weight:600; letter-spacing:-.01em;
...
`,Uf=vd.div`
  ...
  animation:${ff} .8s linear infinite; margin:120px auto;
`,Vf=vd.div`
  margin-top:34px; padding-top:28px; border-top:1px solid ${wd.dossier.hairlineOnDark};
  ${xf(.06)}
  .cm-eyebrow { font-family:${pf}; font-size:10px; letter-spacing:.24em; text-transform:uppercase;
    color:${wd.dossier.teal}; margin-bottom:16px; }
  ...
  .cm-tag { font-family:${pf}; font-size:8.5px; letter-spacing:.12em; text-transform:uppercase;
  ...
  .cm-verified { font-family:${pf}; font-size:9px; letter-spacing:.07em; text-transform:uppercase;
...
`,Kf=vd.div`
  ...
  .door-k { font-family:${pf}; font-size:10px; letter-spacing:.24em; text-transform:uppercase;
    color:${wd.dossier.teal}; margin-bottom:12px; }
  .door h4 { font-family:${hf}; font-weight:600; font-size:18px; letter-spacing:-.01em;
  ...
  .door .spacer { flex:1; }
`,Hf=vd.div`
  font-family:${pf}; font-size:14px; letter-spacing:.01em; color:${wd.dossier.tealBright};
...
`,qf=vd.div`
  ...
  .dp-stat { font-family:${pf}; font-size:11px; letter-spacing:.06em; white-space:nowrap; }
...
`,Yf=vd.div`
  ...
  border-radius:${wd.size.radius.md}; ${xf(.18)}
  ...
  .ft-txt { flex:1; font-size:13px; line-height:1.5; color:${wd.dossier.mutedOnDark};
    b { color:${wd.dossier.inkOnDark}; } }
  .ft-soon { font-family:${pf}; font-size:9.5px; letter-spacing:.14em; text-transform:uppercase;
    color:${wd.dossier.tealBright}; border:1px solid rgba(43,196,172,.4);
    border-radius:${wd.size.radius.pill}; padding:5px 11px; white-space:nowrap; }
`,Gf=Hh,Qf=e=>new Promise((t,r)=>{const n=new FileReader;n.onload=()=>{const e=String(n.result||"");t(e.includes(",")?e.split(",")[1]:e)},n.onerror=()=>r(new Error("Kunde inte l\xe4sa filen")),n.readAsDataURL(e)});function Jf(e,t,r){switch(e){case 429:return["Dagskvot n\xe5dd",t||"Ni har n\xe5tt max antal fria analyser idag \u2014 f\xf6rs\xf6k igen imorgon eller aktivera ert konto."];case 504:return["Tog f\xf6r l\xe5ng tid","Analysen hann inte klart i tid. V\xe4nta en stund och f\xf6rs\xf6k igen."];case 401:return["Sessionen l\xf6pte ut","Ladda om sidan och f\xf6rs\xf6k igen."+(r?` (orsak: ${r})`:"")];case 413:return["Filen f\xf6r stor",t||"PDF:en \xf6verstiger maxstorleken \u2014 komprimera eller dela upp den."];case 400:return["Kunde inte l\xe4sas",t||"Filen gick inte att tolka som en faktura. Kontrollera att det \xe4r en PDF-faktura."];case 404:return["Tj\xe4nsten n\xe5s inte h\xe4r","\xd6ppna ert kontor via arvoflow.se s\xe5 fungerar analysen."];case 500:case 502:case 503:return["Tillf\xe4lligt serverfel","N\xe5got gick fel p\xe5 v\xe5r sida \u2014 f\xf6rs\xf6k igen om en stund."];default:return["Misslyckades",t||`Servern svarade ${e||"ov\xe4ntat"}.`]}}const Xf=new Set(["gmail.com","hotmail.com","outlook.com","yahoo.com","yahoo.se","icloud.com","live.com","msn.com","me.com","proton.me","protonmail.com"]);async function Zf(){var e;const t=[navigator.userAgent,navigator.language,`${window.screen.width}x${window.screen.height}`,Intl.DateTimeFormat().resolvedOptions().timeZone,String(null!==(e=navigator.hardwareConcurrency)&&void 0!==e?e:"")].join("|");try{const e=await crypto.subtle.digest("SHA-256",(new TextEncoder).encode(t));return Array.from(new Uint8Array(e)).map(e=>e.toString(16).padStart(2,"0")).join("").slice(0,24)}catch{return Math.random().toString(36).slice(2,14)}}const eg="arvo_fp_override";const tg=e=>null==e?"\u2013":Math.round(e).toLocaleString("sv-SE"),rg=e=>e?new Date(e).toLocaleDateString("sv-SE",{day:"numeric",month:"short"}):"",ng=e=>e.toLocaleDateString("sv-SE",{month:"long",year:"numeric"}),ag={per_user_month:"kr/anv./m\xe5n",per_subscription_month:"kr/abonn./m\xe5n",ore_per_kwh:"\xf6re/kWh"},ig={"ramavtal-stat":"statliga ramavtal","ramavtal-kommun":"kommunala ramavtal","reskontra-kommun":"kommunal leverant\xf6rsreskontra",upphandling:"offentliga upphandlingar",eurostat:"officiell statistik (Eurostat/SCB)"},og=e=>null==e?"\u2013":Number(e).toLocaleString("sv-SE",{maximumFractionDigits:2});function sg(e){var t;if("monitoring"===e.route)return 72;if(!e.should_switch||!e.annual_cost||!e.suggested_annual_cost)return e.annual_cost>0?82:50;const r=Math.round((e.annual_cost-e.suggested_annual_cost)/e.annual_cost*100),n=Math.max(5,Math.round(100-1.5*r));return(null!==(t=e.net_saving)&&void 0!==t?t:0)>0?Math.min(n,79):n}function lg(e){return e<45?"#E06A4D":e<65?"#E0A23C":e<80?"#5DD6CA":"#2BC4AC"}const cg=17;function dg(e){let{score:t,size:r=42,r:n=cg,sw:a=3.2}=e;const i=2*Math.PI*n,o=lg(t);return(0,$d.jsxs)("svg",{width:r,height:r,viewBox:`0 0 ${r} ${r}`,children:[(0,$d.jsx)("circle",{cx:r/2,cy:r/2,r:n,fill:"none",stroke:"rgba(255,255,255,.12)",strokeWidth:a}),(0,$d.jsx)("circle",{cx:r/2,cy:r/2,r:n,fill:"none",stroke:o,strokeWidth:a,strokeLinecap:"round",strokeDasharray:`${t/100*i} ${i}`,style:{transform:"rotate(-90deg)",transformOrigin:"center",transition:"stroke-dasharray 1s ease"}})]})}function ug(e){var t,r;const n=Kh(e.category),a=(null!==(t=null===n||void 0===n?void 0:n.label)&&void 0!==t?t:e.category).toLowerCase();if("monitoring"===e.route)return"Avtalet \xe4r tidsbegr\xe4nsat. Arvo bevakar och f\xf6rbereder bytet inf\xf6r f\xf6rnyelsen \u2014 ni betalar konkurrenskraftigt till dess.";if("review_queue"===e.route)return"Kategorin kr\xe4ver manuell granskning \u2014 Arvo inh\xe4mtar offert f\xf6r exakt prisj\xe4mf\xf6relse. Ni kontaktas n\xe4r det \xe4r klart.";if(e.should_switch&&(null!==(r=e.net_saving)&&void 0!==r?r:0)>0){const t=e.annual_cost>0&&e.suggested_annual_cost>0?Math.round((e.annual_cost-e.suggested_annual_cost)/e.annual_cost*100):0;return t>=10?`Ni betalar <b>${t}% mer</b> \xe4n verifierat marknadspris f\xf6r ${a}. Arvo rekommenderar byte \u2014 det l\xe4gre priset finns f\xf6rberett nedan.`:`Ni betalar ${t>0?`${t}% mer`:"n\xe5got mer"} \xe4n verifierat marknadspris f\xf6r ${a} \u2014 ett litet gap. Ett l\xe4gre avtalspris finns att s\xe4kra om ni vill, men ingen br\xe5dska; avv\xe4rjt \xe4r \xe4nd\xe5 avv\xe4rjt.`}return`Priset \xe4r konkurrenskraftigt mot verifierat marknadspris f\xf6r ${a}. Inget byte rekommenderas i dag \u2014 dela en ny faktura vid n\xe4sta avtalsperiod s\xe5 kontrollerar Arvo igen.`}function pg(){var e,t,r,a;const[i,o]=(0,n.useState)(null),[s,l]=(0,n.useState)(null),[c,d]=(0,n.useState)({}),[u,p]=(0,n.useState)({}),[h,m]=(0,n.useState)({}),[f,g]=(0,n.useState)(null),[x,v]=(0,n.useState)(new Set),[b,y]=(0,n.useState)(""),[k,j]=(0,n.useState)([]),[w,S]=(0,n.useState)(!1),[$,z]=(0,n.useState)(""),[_,N]=(0,n.useState)(!1),[E,A]=(0,n.useState)(!1),[C,F]=(0,n.useState)(""),[D,T]=(0,n.useState)(null),[P,O]=(0,n.useState)(!1),[L,R]=(0,n.useState)(""),I=(0,n.useMemo)(()=>new URLSearchParams(window.location.search).get("magic"),[]),M=(0,n.useCallback)(async e=>{var t,r,n,a,i;const s=e||b||await Zf(),c=`fingerprint=${encodeURIComponent(s)}`+(I?`&magic=${encodeURIComponent(I)}`:""),u=await fetch(`/api/invoice-history?${c}`);if(!u.ok)throw new Error(`HTTP ${u.status}`);const h=await u.json();o(null!==(t=h.analyses)&&void 0!==t?t:[]),l(null!==(r=h.email)&&void 0!==r?r:null),d(null!==(n=h.cohort)&&void 0!==n?n:{}),p(null!==(a=h.publicBench)&&void 0!==a?a:{}),m(null!==(i=h.forecasts)&&void 0!==i?i:{})},[b,I]);async function B(e){const t=[...e||[]].filter(e=>"application/pdf"===e.type||/\.pdf$/i.test(e.name)).slice(0,20);if(!t.length)return;z(""),S(!0),j(t.map(e=>({name:e.name,status:"work"})));let r=null;if(!I)try{var n;const e=await fetch("/api/token",{method:"POST"});r=null===(n=await e.json())||void 0===n?void 0:n.token}catch{}let a=!1,i="",o=0;for(let s=0;s<t.length;s++)try{const e=await Qf(t[s]);let n="fail",l="Misslyckades",c="";const d=I?"/api/kontor-ingest":"/api/test-invoice",u=I?{pdfBase64:e,magic:I,fingerprint:b}:{pdfBase64:e,industry:"ovrigt",employees:10,token:r,fingerprint:b},p=await fetch(d,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(u)}),h=await p.json().catch(()=>({}));I?h.ok?n="done":([l,c]=Jf(p.status,null===h||void 0===h?void 0:h.error,null===h||void 0===h?void 0:h.code),i=c):h.gate?(n="gate",a=!0):"auto"===h.route||"monitoring"===h.route?n="done":"review_queue"===h.route||"unsupported"===h.route?(n="review",o++):([l,c]=Jf(p.status,null===h||void 0===h?void 0:h.error,null===h||void 0===h?void 0:h.code),i=c),j(e=>e.map((e,t)=>t===s?{...e,status:n,label:l,hint:c}:e))}catch{i="Kunde inte n\xe5 servern \u2014 kontrollera n\xe4tet och f\xf6rs\xf6k igen.",j(e=>e.map((e,t)=>t===s?{...e,status:"fail",label:"N\xe4tverksfel",hint:i}:e))}S(!1),a?z("Ni har n\xe5tt gr\xe4nsen f\xf6r fria analyser. Vidarebefordra resten till faktura@inbox.arvoflow.se \u2014 eller aktivera ert konto \u2014 s\xe5 forts\xe4tter vi."):o>0?z("En eller flera fakturor beh\xf6ver manuell granskning (t.ex. utl\xe4ndsk valuta eller l\xe5g l\xe4sbarhet). Vi tittar p\xe5 dem och \xe5terkommer \u2014 ladda g\xe4rna upp fler under tiden."):i&&z(i);try{await M()}catch{}}(0,n.useEffect)(()=>{let e=!1;return(async()=>{try{const t=function(){try{const e=new URLSearchParams(window.location.search);if(e.has("reset")){const t=(e.get("reset")||"1").toLowerCase();if("off"===t||"0"===t||"real"===t)localStorage.removeItem(eg);else{const e="test"+Array.from(crypto.getRandomValues(new Uint8Array(10))).map(e=>e.toString(16).padStart(2,"0")).join("");localStorage.setItem(eg,e),["arvo_successful_count","arvo_had_saving","arvo_gate_passed"].forEach(e=>localStorage.removeItem(e))}e.delete("reset");const r=e.toString();window.history.replaceState({},"",window.location.pathname+(r?`?${r}`:""))}return localStorage.getItem(eg)||null}catch{return null}}();e||A(!!t);const r=t||await Zf();e||y(r),e||await M(r)}catch(t){e||g(t.message)}})(),()=>{e=!0}},[]);const U=(0,n.useMemo)(()=>(null!==i&&void 0!==i?i:[]).filter(e=>"auto"===e.route||"monitoring"===e.route),[i]),V=(0,n.useMemo)(()=>function(e){const t=new Map;for(const r of null!==e&&void 0!==e?e:[]){const e=`${sf(r).trim().toLowerCase()}|${String(r.category||"").toLowerCase()}`,n=t.get(e);n?(n.count+=1,new Date(r.created_at)>new Date(n.latest.created_at)&&(n.latest=r)):t.set(e,{key:e,latest:r,count:1})}return[...t.values()].sort((e,t)=>{var r,n;return(null!==(r=t.latest.net_saving)&&void 0!==r?r:0)-(null!==(n=e.latest.net_saving)&&void 0!==n?n:0)})}(U),[U]),K=(0,n.useMemo)(()=>{var e;const t={high:0,medium:1,low:2};return null!==(e=(null!==U&&void 0!==U?U:[]).map(e=>e.lead_finding_json).filter(e=>e&&"object"===typeof e&&e.title).sort((e,r)=>t[e.severity]-t[r.severity]||(r.annualImpact||0)-(e.annualImpact||0))[0])&&void 0!==e?e:null},[U]),H=(0,n.useMemo)(()=>{var e;return null!==(e=(null!==i&&void 0!==i?i:[]).map(e=>e.contractClock).filter(e=>e&&"object"===typeof e&&e.title&&e.daysLeft>0).sort((e,t)=>e.daysLeft-t.daysLeft)[0])&&void 0!==e?e:null},[i]),W=(0,n.useMemo)(()=>{var e;const t={high:0,medium:1,low:2};return null!==(e=Object.values(null!==h&&void 0!==h?h:{}).filter(e=>e&&"object"===typeof e&&e.title).sort((e,r)=>{var n,a;return(null!==(n=t[e.confidence])&&void 0!==n?n:3)-(null!==(a=t[r.confidence])&&void 0!==a?a:3)})[0])&&void 0!==e?e:null},[h]),q=V.reduce((e,t)=>{var r;return e+(null!==(r=t.latest.net_saving)&&void 0!==r?r:0)},0),Y=function(e){if(!e.length)return 0;let t=0,r=0;for(const n of e){const e=n.latest.annual_cost>0?n.latest.annual_cost:0;t+=e,r+=sg(n.latest)*e}return 0===t?Math.round(e.reduce((e,t)=>e+sg(t.latest),0)/e.length):Math.round(r/t)}(V),G=(Q=Y,{pointer:Math.max(4,Math.min(96,Q)),label:Q>=67?"Under marknaden":Q>=45?"I niv\xe5":"\xd6ver marknaden"});var Q;const J=function(e){var t;if(!e)return null;const r=(null!==(t=e.split("@")[1])&&void 0!==t?t:"").toLowerCase();if(!r||Xf.has(r))return null;const n=r.split(".")[0];return n.charAt(0).toUpperCase()+n.slice(1)}(s),X=V.filter(e=>{var t;return e.latest.should_switch&&(null!==(t=e.latest.net_saving)&&void 0!==t?t:0)>0}),Z=(0,n.useMemo)(()=>{let e=null;for(const t of V){const r=t.latest,n=c[`${r.normalized_supplier}|${r.category}`],a=(null===n||void 0===n?void 0:n.supplierMedian)||(null===n||void 0===n?void 0:n.supplierAvgCost);if(!n||!a||!r.annual_cost)continue;const i=Math.round((r.annual_cost-a)/a*100),o={supplier:r.supplier||r.normalized_supplier,cost:r.annual_cost,median:a,p25:n.supplierP25,n:n.supplierDataPoints,pct:i};(!e||i>e.pct)&&(e=o)}return e},[V,c]),ee=(0,n.useMemo)(()=>{if(Z)return null;for(const r of V){var e;const n=r.latest,a=u[n.category];if(a&&a.n>=2&&null!==(e=a.observations)&&void 0!==e&&e.length){var t;const e="eurostat"===(null===(t=a.observations[0])||void 0===t?void 0:t.source),r=e&&"supplier"===a.scope&&n.price_per_seat_monthly>0?n.price_per_seat_monthly:null,i=r?Math.round((r-a.median)/a.median*100):null;return{...a,category:n.category,supplier:n.supplier||n.normalized_supplier,customerUnit:r,pct:i,isPeer:e}}}return null},[Z,V,u]),te=(0,n.useMemo)(()=>V.filter(e=>"annual"===e.latest.billing_period&&e.latest.created_at).map(e=>{const t=e.latest,r=new Date(t.created_at);return r.setMonth(r.getMonth()+12),{id:t.id,supplier:t.supplier||t.normalized_supplier,when:r,cost:t.annual_cost}}).sort((e,t)=>e.when-t.when),[V]),re=V.length?rg(V.map(e=>e.latest.created_at).sort().reverse()[0]):"",ne=(new Date).toLocaleDateString("sv-SE",{day:"numeric",month:"short",year:"numeric"}).toUpperCase(),ae=X.length>0,ie=(0,n.useMemo)(()=>{const e=[];return e.push({tag:"Bevakar",what:(0,$d.jsxs)($d.Fragment,{children:["Sveper marknaden mot era ",(0,$d.jsxs)("b",{children:[V.length," leverant\xf6rer"]})," \u2014 nattligt, mot ",(0,$d.jsx)("b",{children:"40 marknadsk\xe4llor"}),"."]})}),U.length>0&&e.push({tag:"Analys",what:(0,$d.jsxs)($d.Fragment,{children:["V\xe4gde ",(0,$d.jsxs)("b",{children:[U.length," ",1===U.length?"faktura":"fakturor"]})," mot verifierat marknadspris",re?(0,$d.jsxs)($d.Fragment,{children:[" \xb7 senast ",re]}):null,"."]})}),Z&&e.push({tag:"Kohort",what:(0,$d.jsxs)($d.Fragment,{children:["J\xe4mf\xf6rde era priser mot ",(0,$d.jsxs)("b",{children:[Z.n," bolag"]})," hos ",Z.supplier," via n\xe4tverket \u2014 sanningen ingen j\xe4mf\xf6relsesajt kan ge."]})}),W&&e.push({tag:"Prognos",what:(0,$d.jsxs)($d.Fragment,{children:["K\xf6ade ett motdrag inf\xf6r en trolig h\xf6jning: ",(0,$d.jsx)("b",{children:W.title}),"."]})}),H&&e.push({tag:"Klocka",what:(0,$d.jsxs)($d.Fragment,{children:["Bevakar avtalsklockan \u2014 ",(0,$d.jsxs)("b",{children:[H.daysLeft," dagar"]})," kvar p\xe5 bindningen, agerar i f\xf6nstret."]})}),e},[V.length,U.length,re,Z,W,H]),oe=ae?(0,$d.jsxs)($d.Fragment,{children:["Ni betalar ",(0,$d.jsx)("em",{children:"\xf6ver marknaden"})," hos ",X.length," av ",V.length,"."]}):(0,$d.jsxs)($d.Fragment,{children:["H\xe5ll kursen. Era priser ",(0,$d.jsx)("em",{children:"st\xe5r sig mot marknaden."})]}),se=ae?(0,$d.jsxs)($d.Fragment,{children:["Vi j\xe4mf\xf6rde era ",(0,$d.jsxs)("b",{children:[V.length," leverant\xf6rer"]})," mot verifierat marknadspris.",(0,$d.jsxs)("b",{children:[" ",tg(q)," kr/\xe5r"]})," i m\xf6jlig nettobesparing ligger p\xe5 bordet \u2014 det st\xf6rsta bytet tar tv\xe5 minuter att signera. Resten h\xe5ller m\xe5ttet; dem r\xf6r vi inte."]}):(0,$d.jsxs)($d.Fragment,{children:["Vi j\xe4mf\xf6rde era ",(0,$d.jsxs)("b",{children:[V.length," leverant\xf6rer"]})," mot verifierat marknadspris. Inget byte rekommenderas i dag. Vi h\xf6r av oss om l\xe4get f\xf6r\xe4ndras \u2014 ni beh\xf6ver inte g\xf6ra n\xe5got."]});return(0,$d.jsx)(vf,{children:(0,$d.jsxs)(bf,{children:[null===i&&!f&&(0,$d.jsx)(Uf,{}),f&&(0,$d.jsx)(wf,{children:(0,$d.jsx)("h2",{style:{fontSize:26},children:"Kunde inte ladda ert kontor \u2014 f\xf6rs\xf6k igen om en stund."})}),null!==i&&V.length>0&&(0,$d.jsxs)($d.Fragment,{children:[(0,$d.jsxs)(yf,{children:[(0,$d.jsxs)(kf,{children:[(0,$d.jsx)("div",{className:"brand",children:"ARVO-KONTORET"}),(0,$d.jsxs)("div",{className:"confidential",children:["Konfidentiellt \xb7 ",null!==J&&void 0!==J?J:"Ert konto"," \xb7 ",ne,E?" \xb7 TESTKONTO (?reset=off f\xf6r skarpt)":""]}),(0,$d.jsx)("h1",{children:ae?(0,$d.jsxs)($d.Fragment,{children:["Ett par drag",(0,$d.jsx)("br",{}),"v\xe4ntar p\xe5 er."]}):(0,$d.jsxs)($d.Fragment,{children:["God morgon.",(0,$d.jsx)("br",{}),"Allt \xe4r under kontroll."]})})]}),(0,$d.jsxs)(jf,{children:[(0,$d.jsxs)("div",{className:"radar-head",children:[(0,$d.jsxs)("div",{className:"disc",children:[(0,$d.jsxs)("svg",{width:"46",height:"46",viewBox:"0 0 46 46",children:[(0,$d.jsx)("circle",{cx:"23",cy:"23",r:"21",fill:"none",stroke:"rgba(93,214,202,.18)",strokeWidth:"1"}),(0,$d.jsx)("circle",{cx:"23",cy:"23",r:"13",fill:"none",stroke:"rgba(93,214,202,.14)",strokeWidth:"1"}),(0,$d.jsx)("circle",{cx:"23",cy:"23",r:"2",fill:"#5DD6CA"})]}),(0,$d.jsx)("div",{className:"sweep"})]}),(0,$d.jsxs)("div",{className:"radar-title",children:[(0,$d.jsx)("strong",{children:"Vakten"}),"bevakar era avtal"]})]}),(0,$d.jsxs)("div",{className:"radar-stats",children:[(0,$d.jsxs)("div",{className:"rstat",children:[(0,$d.jsx)("span",{children:"Leverant\xf6rer"}),(0,$d.jsx)("span",{className:"v",children:V.length})]}),(0,$d.jsxs)("div",{className:"rstat",children:[(0,$d.jsx)("span",{children:"Analyser"}),(0,$d.jsx)("span",{className:"v",children:U.length})]}),(0,$d.jsxs)("div",{className:"rstat",children:[(0,$d.jsx)("span",{children:"Marknadsk\xe4llor"}),(0,$d.jsx)("span",{className:"v",children:"40"})]})]}),(0,$d.jsxs)("div",{className:"radar-foot",children:[(0,$d.jsx)("span",{className:"live"}),re?(0,$d.jsxs)($d.Fragment,{children:["Senaste analys ",re," \xb7 bevakning aktiv"]}):"Bevakning aktiv"]})]})]}),(0,$d.jsx)(Yh,{finding:K,variant:"dossier"}),(0,$d.jsx)(Yh,{finding:H,variant:"dossier",eyebrow:"Maktkalendern \xb7 avtalsbevakning"}),(0,$d.jsx)(Yh,{finding:W,variant:"dossier",eyebrow:"Maktkalendern \xb7 prognos"}),(0,$d.jsxs)(wf,{children:[(0,$d.jsx)("div",{className:"eyebrow",children:"Arvo bed\xf6mer"}),(0,$d.jsx)("h2",{children:oe}),(0,$d.jsx)("p",{className:"work",children:se}),(0,$d.jsxs)(Sf,{children:[(0,$d.jsx)("span",{className:"pct",children:"Verifierat"})," \xb7 grundat p\xe5 ",V.length," analyserade leverant\xf6rer \xb7 publika listpriser"]})]}),(0,$d.jsxs)($f,{children:[(0,$d.jsxs)(Ef,{children:[(0,$d.jsxs)("div",{className:"card-eyebrow",children:[(0,$d.jsx)("span",{children:"Arvo Score"}),(0,$d.jsx)("span",{className:"src",children:"mot verifierat listpris"})]}),(0,$d.jsxs)("div",{className:"idx-main",children:[(0,$d.jsx)("span",{className:"idx-num",children:Y}),(0,$d.jsx)("span",{className:"idx-denom",children:"/100"})]}),(0,$d.jsx)("div",{className:"mkt-k",children:"Marknadsl\xe4ge"}),(0,$d.jsx)("div",{className:"mkt-track",children:(0,$d.jsx)("span",{className:"mkt-ptr",style:{left:`${G.pointer}%`}})}),(0,$d.jsxs)("div",{className:"mkt-scale",children:[(0,$d.jsx)("span",{className:"\xd6ver marknaden"===G.label?"on":"",children:"\xd6ver marknaden"}),(0,$d.jsx)("span",{className:"I niv\xe5"===G.label?"on":"",children:"I niv\xe5"}),(0,$d.jsx)("span",{className:"Under marknaden"===G.label?"on":"",children:"Under marknaden"})]}),(0,$d.jsx)("p",{className:"idx-note",children:X.length>0?(0,$d.jsxs)($d.Fragment,{children:["Sammanv\xe4gt ",Y>=67?"starkt":Y>=45?"godk\xe4nt":"svagt"," \u2014 men ",(0,$d.jsxs)("b",{children:[X.length," avtal drar \xf6ver marknaden"]}),". De ligger f\xf6rberedda i innehavet nedan."]}):(0,$d.jsxs)($d.Fragment,{children:["Era priser ligger ",(0,$d.jsx)("b",{children:"i niv\xe5 med eller under verifierat listpris"}),". Inget enskilt avtal sticker ut i dag."]})})]}),(0,$d.jsxs)(Ff,{children:[(0,$d.jsx)("div",{className:"tally-k",children:ae?"M\xf6jlig nettobesparing":"Avtal under bevakning"}),(0,$d.jsx)("div",{className:"tally-num",children:ae?(0,$d.jsxs)($d.Fragment,{children:[tg(q)," kr",(0,$d.jsx)("small",{children:"per \xe5r"})]}):(0,$d.jsxs)($d.Fragment,{children:[V.length,(0,$d.jsx)("small",{children:(V.length,"avtal")})]})}),(0,$d.jsx)("div",{className:"tally-sub",children:ae?(0,$d.jsxs)($d.Fragment,{children:[(0,$d.jsxs)("b",{children:[X.length," byte",X.length>1?"n":""," f\xf6rberedda"]})," \xb7 netto efter Arvos arvode (20% av f\xf6rsta \xe5rets besparing). Fr\xe5n \xe5r tv\xe5 \xe4r hela besparingen er."]}):(0,$d.jsx)($d.Fragment,{children:"Era priser st\xe5r sig \u2014 inga byten p\xe5 bordet just nu. Lugnet att ni ligger r\xe4tt \xe4r ocks\xe5 en leverans."})})]})]}),(0,$d.jsxs)(Cf,{children:[(0,$d.jsxs)("div",{className:"card-eyebrow",children:[(0,$d.jsx)("span",{children:"Vaktens kvitton"}),(0,$d.jsx)("span",{className:"src",children:"medan ni drev bolaget"})]}),ie.map((e,t)=>(0,$d.jsxs)("div",{className:"rcpt",children:[(0,$d.jsx)("span",{className:"day",children:e.tag}),(0,$d.jsx)("span",{className:"what",children:e.what})]},t))]}),(Z||ee||te.length>0)&&(0,$d.jsxs)($f,{children:[ee&&(0,$d.jsxs)(Nf,{$full:0===te.length,children:[(0,$d.jsxs)("div",{className:"card-eyebrow",children:[(0,$d.jsx)("span",{children:ee.isPeer?"Den kollektiva sanningen":"Golv-referens"}),(0,$d.jsxs)("span",{className:"src",children:[ee.isPeer?"svenska f\xf6retag":"offentlig sektor"," \xb7 ",ee.n," pris",ee.n>1?"punkter":"punkt"]})]}),(0,$d.jsx)("h3",{children:(e=>{const t=((null===(e=Kh(ee.category))||void 0===e?void 0:e.label)||ee.category).toLowerCase(),r=ag[ee.unit]||"";return ee.isPeer?ee.customerUnit&&ee.pct>=8?(0,$d.jsxs)($d.Fragment,{children:["Svenska f\xf6retag betalar ",og(ee.median)," ",r," f\xf6r ",t,". Ni betalar ",(0,$d.jsxs)("em",{children:[ee.pct,"% mer."]})]}):ee.customerUnit&&ee.pct<=-8?(0,$d.jsxs)($d.Fragment,{children:["Ni betalar ",(0,$d.jsxs)("em",{children:[Math.abs(ee.pct),"% mindre"]})," \xe4n svenska f\xf6retag f\xf6r ",t,"."]}):ee.customerUnit?(0,$d.jsxs)($d.Fragment,{children:["Ni betalar ",(0,$d.jsx)("em",{children:"i niv\xe5"})," med svenska f\xf6retag f\xf6r ",t,"."]}):(0,$d.jsxs)($d.Fragment,{children:["Svenska f\xf6retag betalar ",(0,$d.jsxs)("em",{children:[og(ee.min),"\u2013",og(ee.max)," ",r]})," f\xf6r ",t,"."]}):(0,$d.jsxs)($d.Fragment,{children:["Offentlig sektor pressar samma ",t," till ",(0,$d.jsxs)("em",{children:[og(ee.min),"\u2013",og(ee.max)," ",r]}),". Beviset att priset \xe4r ",(0,$d.jsx)("em",{children:"f\xf6rhandlingsbart."})]})})()}),(()=>{const e=[...ee.customerUnit?[{lbl:"Ni betalar",amt:ee.customerUnit,you:!0}]:[],...(ee.observations||[]).map(e=>({lbl:e.product||e.buyer,amt:e.unitPrice,you:!1}))];if(!e.length)return null;const t=Math.max(...e.map(e=>e.amt))||1;return(0,$d.jsx)("div",{className:"bars",children:e.map((e,r)=>(0,$d.jsxs)("div",{className:"barrow"+(e.you?" you":""),children:[(0,$d.jsx)("span",{className:"lbl",children:e.lbl}),(0,$d.jsx)("span",{className:"track",children:(0,$d.jsx)("span",{className:"fill",style:{width:`${Math.max(8,e.amt/t*100)}%`}})}),(0,$d.jsx)("span",{className:"amt",children:og(e.amt)})]},r))})})(),(0,$d.jsxs)("p",{className:"truth-note",children:["Verkliga priser ur ",(0,$d.jsx)("b",{children:"\xf6ppen data"})," \u2014 ",ig[null===(e=ee.observations)||void 0===e||null===(t=e[0])||void 0===t?void 0:t.source]||"offentliga avtal",null!==(r=ee.observations)&&void 0!==r&&null!==(a=r[0])&&void 0!==a&&a.buyer?`, ${ee.observations[0].buyer}`:"",".",ee.isPeer?ee.customerUnit?" J\xe4mf\xf6rt per enhet mot er faktura.":"":" Golvet \u2014 inte ett m\xe5l ni n\xe5r i er storlek, men beviset att listpriset \xe4r f\xf6rhandlingsbart."]})]}),Z&&(0,$d.jsxs)(Nf,{$full:0===te.length,children:[(0,$d.jsxs)("div",{className:"card-eyebrow",children:[(0,$d.jsx)("span",{children:"Den kollektiva sanningen"}),(0,$d.jsxs)("span",{className:"src",children:[Z.n," bolag \xb7 live"]})]}),(0,$d.jsx)("h3",{children:Z.pct>=8?(0,$d.jsxs)($d.Fragment,{children:[Z.n," bolag hos ",Z.supplier," betalar i snitt ",tg(Z.median)," kr. Ni betalar ",(0,$d.jsxs)("em",{children:[Z.pct,"% mer."]})]}):Z.pct<=-8?(0,$d.jsxs)($d.Fragment,{children:["Ni betalar ",(0,$d.jsxs)("em",{children:[Math.abs(Z.pct),"% mindre"]})," \xe4n snittet hos ",Z.supplier," \u2014 ",Z.n," bolag j\xe4mf\xf6rda."]}):(0,$d.jsxs)($d.Fragment,{children:["Ni betalar ",(0,$d.jsx)("em",{children:"i niv\xe5"})," med vad ",Z.n," bolag betalar hos ",Z.supplier,"."]})}),(()=>{const e=Math.max(Z.cost,Z.median,Z.p25||0)||1,t=[{lbl:"Ni betalar",amt:Z.cost,you:!0},{lbl:`Snitt \xb7 ${Z.n} bolag`,amt:Z.median,you:!1},...Z.p25?[{lbl:"L\xe4gst 25 %",amt:Z.p25,you:!1}]:[]];return(0,$d.jsx)("div",{className:"bars",children:t.map(t=>(0,$d.jsxs)("div",{className:"barrow"+(t.you?" you":""),children:[(0,$d.jsx)("span",{className:"lbl",children:t.lbl}),(0,$d.jsx)("span",{className:"track",children:(0,$d.jsx)("span",{className:"fill",style:{width:`${Math.max(8,t.amt/e*100)}%`}})}),(0,$d.jsxs)("span",{className:"amt",children:[tg(t.amt)," kr"]})]},t.lbl))})})(),(0,$d.jsxs)("p",{className:"truth-note",children:["Den h\xe4r raden kr\xe4ver att man ser ",(0,$d.jsx)("b",{children:"m\xe5nga bolags faktiska fakturor samtidigt"}),". Ingen j\xe4mf\xf6relsesajt och ingen konsult kan ge den \u2014 bara Arvo, tack vare n\xe4tverket."]})]}),te.length>0&&(0,$d.jsxs)(Af,{$full:!Z&&!ee,children:[(0,$d.jsxs)("div",{className:"card-eyebrow",children:[(0,$d.jsx)("span",{children:"Maktkalendern \xb7 era \xe5rsavtal"}),(0,$d.jsx)("span",{className:"src",children:"uppskattat"})]}),te.map(e=>(0,$d.jsxs)("div",{className:"cal-row",children:[(0,$d.jsx)("span",{className:"cal-prob",children:(0,$d.jsx)(bu,{name:"calendar-clock",size:18,stroke:1.8})}),(0,$d.jsxs)("div",{className:"cal-body",children:[(0,$d.jsx)("div",{className:"t",children:e.supplier}),(0,$d.jsxs)("div",{className:"s",children:["\xc5rsavtal \u2014 bytesl\xe4get \xe5terkommer \xe5rligen. ",tg(e.cost)," kr/\xe5r."]})]}),(0,$d.jsxs)("span",{className:"cal-when",children:["~ ",ng(e.when)]})]},e.id))]})]}),(0,$d.jsxs)(Df,{children:[(0,$d.jsxs)("div",{className:"h-eyebrow",children:["Innehavet \xb7 ",V.length," analyserade leverant\xf6rer"]}),V.map(e=>{var t;const r=e.latest,n=Kh(r.category),a=sg(r),i=lg(a),o=x.has(r.id),s=r.should_switch&&(null!==(t=r.net_saving)&&void 0!==t?t:0)>0;return(0,$d.jsxs)(Pf,{$saving:s,children:[(0,$d.jsxs)(Of,{$open:o,onClick:()=>{return e=r.id,void v(t=>{const r=new Set(t);return r.has(e)?r.delete(e):r.add(e),r});var e},"aria-expanded":o,children:[(0,$d.jsxs)(Lf,{children:[(0,$d.jsx)(dg,{score:a}),(0,$d.jsx)("span",{className:"v",style:{color:i},children:a})]}),(0,$d.jsxs)("div",{children:[(0,$d.jsx)("div",{className:"h-name",children:sf(r)}),(0,$d.jsxs)("div",{className:"h-cat",children:[n.label," \xb7 ",rg(r.created_at),e.count>1?` \xb7 ${e.count} analyser`:""]})]}),(0,$d.jsx)("div",{className:"h-cost",children:null!=r.annual_cost?`${tg(r.annual_cost)} kr/\xe5r`:""}),(0,$d.jsx)("div",{className:"h-badge "+(s?"save":"watch"),children:s?`+${tg(r.net_saving)} kr/\xe5r`:"monitoring"===r.route?"Avtalsbevakad":"R\xe4tt prissatt"}),(0,$d.jsx)("span",{className:"h-chev",children:(0,$d.jsx)(bu,{name:"chevron-down",size:16,stroke:2})})]}),o&&(0,$d.jsxs)(Rf,{children:[(0,$d.jsx)("div",{className:"diag",children:(0,$d.jsxs)("div",{className:"dbody",children:[(0,$d.jsx)("div",{className:"dtop",children:"Arvo bed\xf6mer"}),(0,$d.jsx)("div",{className:"dtxt",dangerouslySetInnerHTML:{__html:ug(r)}})]})}),(0,$d.jsxs)("dl",{className:"facts",children:[!s&&null!=r.annual_cost&&(0,$d.jsxs)("div",{className:"fact",children:[(0,$d.jsx)("dt",{children:"Ni betalar idag"}),(0,$d.jsxs)("dd",{children:[tg(r.annual_cost)," kr/\xe5r"]})]}),(0,$d.jsxs)("div",{className:"fact",children:[(0,$d.jsx)("dt",{children:"Kategori"}),(0,$d.jsx)("dd",{style:{fontFamily:"inherit"},children:n.label})]}),(0,$d.jsxs)("div",{className:"fact",children:[(0,$d.jsx)("dt",{children:"Analyserad"}),(0,$d.jsx)("dd",{children:rg(r.created_at)})]})]}),s&&(0,$d.jsxs)(If,{children:[(0,$d.jsx)("div",{className:"si-k",children:"Arvo Switch \xb7 s\xe5 g\xe5r bytet till"}),(0,$d.jsxs)("div",{className:"si-steps",children:[(0,$d.jsxs)("div",{className:"si-step",children:[(0,$d.jsx)("span",{className:"si-n",children:"1"}),(0,$d.jsxs)("span",{className:"si-body",children:[(0,$d.jsx)("span",{className:"si-t",children:"Ni aktiverar bytet"}),(0,$d.jsx)("span",{className:"si-d",children:"Ett klick \u2014 Arvo tar det d\xe4rifr\xe5n."})]})]}),(0,$d.jsxs)("div",{className:"si-step",children:[(0,$d.jsx)("span",{className:"si-n",children:"2"}),(0,$d.jsxs)("span",{className:"si-body",children:[(0,$d.jsx)("span",{className:"si-t",children:"Arvo f\xf6rbereder allt"}),(0,$d.jsx)("span",{className:"si-d",children:"Fullmakt och bytesplan i er inkorg inom 24 timmar \u2014 ni granskar och signerar."})]})]}),(0,$d.jsxs)("div",{className:"si-step",children:[(0,$d.jsx)("span",{className:"si-n",children:"3"}),(0,$d.jsxs)("span",{className:"si-body",children:[(0,$d.jsx)("span",{className:"si-t",children:"Nytt avtalspris aktivt"}),(0,$d.jsx)("span",{className:"si-d",children:"Ni betalar 20 % av f\xf6rsta \xe5rets besparing \u2014 fr\xe5n \xe5r tv\xe5 \xe4r hela besparingen er."})]})]})]}),(0,$d.jsxs)("div",{className:"si-offer",children:[(0,$d.jsxs)("span",{className:"old",children:[tg(r.annual_cost)," kr/\xe5r"]}),(0,$d.jsx)("span",{className:"arr",children:"\u2192"}),(0,$d.jsxs)("span",{className:"new",children:[tg(r.suggested_annual_cost),(0,$d.jsx)("small",{children:"kr/\xe5r"})]})]}),(0,$d.jsxs)("div",{className:"si-save",children:["Ni sparar ",(0,$d.jsxs)("b",{children:[tg(r.net_saving)," kr/\xe5r"]})," netto efter Arvos arvode (20 % av f\xf6rsta \xe5rets besparing)."]}),(0,$d.jsxs)(Mf,{as:vs,to:"/aktivera",children:["Aktivera bytet ",(0,$d.jsx)(bu,{name:"arrow",size:16})]})]})]})]},r.id)})]}),(0,$d.jsxs)(Bf,{children:[(0,$d.jsx)("div",{className:"iq-k",children:"Arvo Intelligence"}),(0,$d.jsxs)("h3",{children:["Hela reskontran, ",(0,$d.jsx)("em",{children:"bevakad dygnet runt."})]}),(0,$d.jsx)("p",{children:ae?(0,$d.jsxs)($d.Fragment,{children:["I dag vaktar Arvo de avtal ni delat. Arvo Intelligence vidgar vakten till ",(0,$d.jsx)("b",{children:"resten av boken"})," \u2014 varenda avtal ni har \u2014 och larmar er innan n\xe4sta h\xf6jning n\xe5r er. Varje m\xe5nad: ett brev med exakt vad som r\xf6rt sig, och vad vi gjort \xe5t det."]}):(0,$d.jsxs)($d.Fragment,{children:["Era priser st\xe5r sig i dag, och Arvo vaktar de avtal ni delat. Arvo Intelligence vidgar vakten till ",(0,$d.jsx)("b",{children:"resten av boken"}),", s\xe5 att inget avtal l\xe4mnas obevakat \u2014 och skickar varje m\xe5nad ett brev med vad som r\xf6rt sig."]})}),(0,$d.jsxs)("div",{className:"iq-row",children:[(0,$d.jsxs)("span",{className:"iq-price",children:["1 995 kr ",(0,$d.jsx)("span",{children:"/ m\xe5n \xb7 ingen bindningstid"})]}),(0,$d.jsxs)(Mf,{as:vs,to:"/aktivera",children:["Aktivera Arvo Intelligence ",(0,$d.jsx)(bu,{name:"arrow",size:16})]})]})]}),(0,$d.jsxs)(Tf,{children:[(0,$d.jsx)("div",{className:"keyline"}),(0,$d.jsx)("div",{className:"mark",children:"ARVO"}),(0,$d.jsx)("div",{className:"tagline",children:"Finansiell intelligens som aldrig sover."})]})]}),null!==i&&0===V.length&&!f&&(0,$d.jsxs)($d.Fragment,{children:[(0,$d.jsx)(yf,{children:(0,$d.jsxs)(kf,{children:[(0,$d.jsx)("div",{className:"brand",children:"ARVO-KONTORET"}),(0,$d.jsxs)("div",{className:"confidential",children:["Konfidentiellt \xb7 ",null!==J&&void 0!==J?J:"Ert konto"," \xb7 ",ne,E?" \xb7 TESTKONTO (?reset=off f\xf6r skarpt)":""]}),(0,$d.jsxs)("h1",{children:["Ert kontor v\xe4ntar",(0,$d.jsx)("br",{}),"p\xe5 f\xf6rsta analysen."]})]})}),(0,$d.jsx)(df,{email:C,setEmail:F,onSubmit:async function(e){var t;null===e||void 0===e||null===(t=e.preventDefault)||void 0===t||t.call(e);const r=C.trim();if(r&&!P){O(!0),T(null),R("");try{var n;const e=await fetch("/api/reveal",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:r})}),t=await e.json().catch(()=>({}));null!==(n=t.findings)&&void 0!==n&&n.length?T(t):R(t.note||"Vi kunde inte l\xe4sa av den dom\xe4nen \u2014 ange er f\xf6retagsadress s\xe5 f\xf6rs\xf6ker vi igen.")}catch{R("Kunde inte n\xe5 Arvo just nu \u2014 f\xf6rs\xf6k igen om en stund.")}finally{O(!1)}}},loading:P,reveal:D,note:L}),(0,$d.jsxs)(wf,{children:[(0,$d.jsx)("div",{className:"eyebrow",children:"Var pengarna oftast rinner"}),(0,$d.jsxs)("h2",{children:["\xd6verbetalningen sitter oftast i ",(0,$d.jsx)("em",{children:"IT-licenser, telefoni och mjukvara."})]}),(0,$d.jsx)("p",{className:"work",children:"B\xf6rja d\xe4r \u2014 en enda faktura r\xe4cker f\xf6r ert f\xf6rsta fynd, ofta inom minuter. T\xf6m sedan resten av h\xf6gen: ju fler avtal Arvo ser, desto skarpare blir hela bilden av var ni betalar f\xf6r mycket."})]}),(0,$d.jsxs)(Vf,{children:[(0,$d.jsxs)("div",{className:"cm-eyebrow",children:["Er kostnadskarta \xb7 ",Gf.length," kategorier"]}),(0,$d.jsx)("div",{className:"cm-grid",children:Gf.map(e=>(0,$d.jsxs)("div",{className:"cm-cell"+("verdict"===e.mode?" hot":""),children:[(0,$d.jsxs)("div",{className:"cm-top",children:[(0,$d.jsx)("span",{className:"cm-ico",children:(0,$d.jsx)(bu,{name:e.icon,size:19,stroke:1.7})}),"verdict"===e.mode?(0,$d.jsx)("span",{className:"cm-tag",children:"B\xf6rja h\xe4r"}):(0,$d.jsx)("span",{className:"cm-tag offert",children:"via offert"})]}),(0,$d.jsx)("span",{className:"cm-label",children:e.label}),(0,$d.jsx)("span",{className:"cm-hint",children:e.hint}),e.know&&(0,$d.jsx)("span",{className:"cm-verified",children:e.know})]},e.label))})]}),(0,$d.jsxs)(Kf,{children:[(0,$d.jsxs)("div",{className:"door",children:[(0,$d.jsx)("div",{className:"door-k",children:"Snabbast \xb7 vidarebefordra"}),(0,$d.jsx)("h4",{children:"T\xf6m m\xe5nadens fakturor i ett mejl."}),(0,$d.jsx)("p",{children:"Markera era leverant\xf6rsfakturor (PDF) i inkorgen och vidarebefordra allt p\xe5 en g\xe5ng \u2014 analyserna landar h\xe4r."}),(0,$d.jsx)("div",{className:"spacer"}),(0,$d.jsx)(Hf,{children:"faktura@inbox.arvoflow.se"})]}),(0,$d.jsxs)("div",{className:"door",children:[(0,$d.jsx)("div",{className:"door-k",children:"Eller \xb7 ladda upp direkt"}),(0,$d.jsx)("h4",{children:"Dra in flera fakturor h\xe4r."}),(0,$d.jsx)("p",{children:"PDF \xb7 upp till 20 \xe5t g\xe5ngen \xb7 vi sparar aldrig filen efter analysen."}),(0,$d.jsx)("div",{className:"spacer"}),(0,$d.jsxs)(Wf,{className:`${w?"busy":""}${_?" over":""}`,onDrop:e=>{var t;e.preventDefault(),N(!1),B(null===(t=e.dataTransfer)||void 0===t?void 0:t.files)},onDragOver:e=>{e.preventDefault(),_||N(!0)},onDragLeave:()=>N(!1),children:[(0,$d.jsx)("span",{className:"dz-ico",children:(0,$d.jsx)(bu,{name:"upload",size:22,stroke:1.7})}),(0,$d.jsx)("span",{className:"dz-t",children:w?"Analyserar\u2026":_?"Sl\xe4pp h\xe4r":"Sl\xe4pp eller v\xe4lj PDF-fakturor"}),(0,$d.jsx)("span",{className:"dz-s",children:"Flera samtidigt g\xe5r bra"}),(0,$d.jsx)("input",{type:"file",accept:"application/pdf",multiple:!0,disabled:w,onChange:e=>{const t=e.target.files;e.target.value="",B(t)}})]}),k.length>0&&(0,$d.jsx)(qf,{children:k.map((e,t)=>(0,$d.jsxs)("div",{className:"dp-row",children:[(0,$d.jsx)("span",{className:"dp-name",children:e.name}),(0,$d.jsx)("span",{className:"dp-stat "+("done"===e.status?"done":"work"===e.status||"gate"===e.status||"review"===e.status?"work":"fail"),title:"fail"===e.status&&e.hint||"",children:"done"===e.status?"Klar":"review"===e.status?"Manuell granskning":"fail"===e.status?e.label||"Misslyckades":"gate"===e.status?"Gr\xe4ns n\xe5dd":"Analyserar\u2026"})]},`${e.name}-${t}`))}),$&&(0,$d.jsx)(qf,{children:(0,$d.jsx)("p",{className:"dp-note",children:$})})]})]}),(0,$d.jsxs)(Yf,{children:[(0,$d.jsx)("span",{className:"ft-ico",children:(0,$d.jsx)(bu,{name:"lock",size:18,stroke:1.7})}),(0,$d.jsxs)("span",{className:"ft-txt",children:[(0,$d.jsx)("b",{children:"Snart: koppla Fortnox."})," N\xe4r integrationen \xe4r p\xe5 plats l\xe4ses hela leverant\xf6rsreskontran automatiskt \u2014 d\xe5 slutar ni ladda upp."]}),(0,$d.jsx)("span",{className:"ft-soon",children:"Lanseras inom kort"})]}),(0,$d.jsxs)(Tf,{children:[(0,$d.jsx)("div",{className:"keyline"}),(0,$d.jsx)("div",{className:"mark",children:"ARVO"}),(0,$d.jsx)("div",{className:"tagline",children:"Finansiell intelligens som aldrig sover."})]})]})]})})}const hg=jd`from{opacity:0;transform:translateY(10px)}to{opacity:1;transform:none}`,mg=vd.div`min-height:100vh;background:#0E1A17;color:#fff;font-family:system-ui,sans-serif;padding:32px 24px;`,fg=vd.h1`font-size:24px;font-weight:800;letter-spacing:-.02em;margin:0 0 4px;`,gg=vd.p`font-size:13px;color:rgba(255,255,255,.45);margin:0 0 28px;`,xg=vd.div`display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin-bottom:28px;@media(max-width:700px){grid-template-columns:1fr 1fr;}`,vg=vd.div`background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.1);border-radius:12px;padding:16px 18px;`,bg=vd.p`font-size:10px;font-weight:700;letter-spacing:.07em;text-transform:uppercase;color:rgba(255,255,255,.4);margin:0 0 4px;`,yg=vd.p`font-size:22px;font-weight:800;color:#5DD6CA;margin:0;letter-spacing:-.02em;`,kg=vd.div`margin-bottom:28px;animation:${hg} .4s ease both;`,jg=vd.h2`font-size:13px;font-weight:700;letter-spacing:.07em;text-transform:uppercase;color:rgba(255,255,255,.5);margin:0 0 10px;`,wg=vd.div`background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.08);border-radius:12px;overflow:hidden;`,Sg=vd.div`display:grid;grid-template-columns:${e=>{let{$cols:t}=e;return t}};padding:10px 16px;background:rgba(255,255,255,.06);font-size:10.5px;font-weight:700;letter-spacing:.06em;text-transform:uppercase;color:rgba(255,255,255,.4);gap:12px;`,$g=vd.div`display:grid;grid-template-columns:${e=>{let{$cols:t}=e;return t}};padding:11px 16px;border-top:1px solid rgba(255,255,255,.06);font-size:12.5px;gap:12px;align-items:center;&:hover{background:rgba(255,255,255,.03);}`,zg=vd.span`display:inline-block;padding:2px 8px;border-radius:100px;font-size:11px;font-weight:600;background:${e=>{let{$c:t}=e;return null!==t&&void 0!==t?t:"rgba(255,255,255,.1)"}};color:#fff;`,_g=vd.form`display:flex;gap:8px;margin-top:10px;flex-wrap:wrap;`,Ng=vd.input`padding:10px 14px;border-radius:100px;border:1.5px solid rgba(255,255,255,.15);background:rgba(255,255,255,.06);color:#fff;font-size:13px;flex:1;min-width:200px;outline:none;&::placeholder{color:rgba(255,255,255,.3);}`,Eg=vd.button`padding:10px 20px;border-radius:100px;border:none;cursor:pointer;font-size:13px;font-weight:700;background:linear-gradient(135deg,#5DD6CA,#1B6E66);color:#fff;white-space:nowrap;&:disabled{opacity:.5;cursor:not-allowed;}`,Ag=vd.div`margin-top:8px;background:rgba(93,214,202,.1);border:1px solid rgba(93,214,202,.25);border-radius:8px;padding:10px 14px;font-size:12px;color:#5DD6CA;word-break:break-all;`,Cg=vd.div`max-width:360px;margin:80px auto;text-align:center;`,Fg=vd.p`padding:20px 16px;font-size:13px;color:rgba(255,255,255,.3);margin:0;`;function Dg(e){return e?new Date(e).toLocaleDateString("sv-SE",{day:"numeric",month:"short",hour:"2-digit",minute:"2-digit"}):"\u2013"}function Tg(e){return null==e?"\u2013":Math.round(e).toLocaleString("sv-SE")}function Pg(){var e,t,r,a,i,o,s,l,c,d,u,p,h,m,f,g,x,v,b,y,k,j;const[w,S]=(0,n.useState)(()=>{var e;return null!==(e=sessionStorage.getItem("arvo_admin_token"))&&void 0!==e?e:""}),[$,z]=(0,n.useState)(""),[_,N]=(0,n.useState)(!1),[E,A]=(0,n.useState)(null),[C,F]=(0,n.useState)(""),[D,T]=(0,n.useState)(""),[P,O]=(0,n.useState)(""),[L,R]=(0,n.useState)("72"),[I,M]=(0,n.useState)(""),[B,U]=(0,n.useState)("idle"),[V,K]=(0,n.useState)("queue"),[H,W]=(0,n.useState)("idle"),[q,Y]=(0,n.useState)(null),[G,Q]=(0,n.useState)(null),[J,X]=(0,n.useState)(null),[Z,ee]=(0,n.useState)("list"),[te,re]=(0,n.useState)(""),[ne,ae]=(0,n.useState)(null),[ie,oe]=(0,n.useState)(null),[se,le]=(0,n.useState)(null),[ce,de]=(0,n.useState)(null),[ue,pe]=(0,n.useState)(null),[he,me]=(0,n.useState)("category"),[fe,ge]=(0,n.useState)(""),[xe,ve]=(0,n.useState)(""),[be,ye]=(0,n.useState)(!1),[ke,je]=(0,n.useState)(null),[we,Se]=(0,n.useState)(null),[$e,ze]=(0,n.useState)(null),[_e,Ne]=(0,n.useState)({companyName:"",sniCode:"",employees:"",contactEmail:"",sendEmail:!1}),[Ee,Ae]=(0,n.useState)("idle"),[Ce,Fe]=(0,n.useState)(null),De=(0,n.useCallback)(async e=>{F("");try{const r=await fetch("/api/admin/dashboard",{headers:{"x-admin-token":e}}),n=await r.json();var t;if(!r.ok)return void F(null!==(t=n.error)&&void 0!==t?t:"Ej beh\xf6rig");A(n),N(!0),sessionStorage.setItem("arvo_admin_token",e)}catch{F("N\xe4tverksfel")}},[]);(0,n.useEffect)(()=>{w&&De(w)},[w,De]);const[Te,Pe]=(0,n.useState)(null),Oe=(0,n.useCallback)(()=>{fetch("/api/admin/benchmark-stats",{headers:{"x-admin-token":w}}).then(e=>e.json()).then(Pe).catch(()=>{})},[w]),Le=(0,n.useCallback)(()=>{fetch("/api/admin/prospects",{headers:{"x-admin-token":w}}).then(e=>e.json()).then(e=>{var t,r;Se(null!==(t=e.prospects)&&void 0!==t?t:[]),ze(null!==(r=e.stats)&&void 0!==r?r:{})}).catch(()=>{})},[w]);if(!_)return(0,$d.jsx)(mg,{children:(0,$d.jsxs)(Cg,{children:[(0,$d.jsx)(fg,{children:"Arvo Admin"}),(0,$d.jsx)(gg,{children:"Ange ADMIN_TOKEN f\xf6r att forts\xe4tta"}),C&&(0,$d.jsx)("p",{style:{color:"#EF4444",fontSize:13,marginBottom:12},children:C}),(0,$d.jsxs)("form",{onSubmit:async function(e){e.preventDefault(),S($)},style:{display:"flex",flexDirection:"column",gap:10},children:[(0,$d.jsx)(Ng,{type:"password",placeholder:"Admin-token",value:$,onChange:e=>z(e.target.value),style:{borderRadius:10,textAlign:"center"}}),(0,$d.jsx)(Eg,{type:"submit",disabled:!$,children:"Logga in \u2192"})]})]})});const Re=null!==(e=null===E||void 0===E?void 0:E.stats)&&void 0!==e?e:{},Ie="2fr 1.5fr 1fr 1fr 1fr 1.2fr 84px",Me={padding:"6px 10px",borderRadius:8,border:"1.5px solid rgba(255,255,255,.15)",background:"rgba(255,255,255,.06)",color:"#fff",fontSize:12.5,cursor:"pointer",outline:"none"},Be=["saas-crm","saas-productivity","saas-finance","saas-devtools","saas-other","mobil","bredband","el","skrivarleasing","kortterminal","molnvaxel","loneadmin","utrustningsleasing","managed-workplace","larm-bevakning","foretagshalsovard","bankavgifter","forsakring-foretag","serverhosting","it-support","faktura-tjanst","leasing-bil"],Ue="2fr 1.5fr 1.5fr 1.5fr",Ve="2fr 1.5fr 0.5fr 2fr 1.5fr";return(0,$d.jsxs)(mg,{children:[(0,$d.jsx)(fg,{children:"Arvo Admin"}),(0,$d.jsxs)(gg,{children:["Live-data fr\xe5n Neon Postgres \xb7 senast laddad ",(new Date).toLocaleTimeString("sv-SE")]}),(0,$d.jsxs)(xg,{children:[(0,$d.jsxs)(vg,{children:[(0,$d.jsx)(bg,{children:"Totalt analyserade"}),(0,$d.jsx)(yg,{children:Tg(Re.total_analyses)})]}),(0,$d.jsxs)(vg,{children:[(0,$d.jsx)(bg,{children:"Auto (klara)"}),(0,$d.jsx)(yg,{children:Tg(Re.auto_count)})]}),(0,$d.jsxs)(vg,{children:[(0,$d.jsx)(bg,{children:"Review queue"}),(0,$d.jsx)(yg,{style:{color:"#F59E0B"},children:Tg(Re.review_count)})]}),(0,$d.jsxs)(vg,{children:[(0,$d.jsx)(bg,{children:"Unika anv\xe4ndare"}),(0,$d.jsx)(yg,{children:Tg(Re.unique_users)})]}),(0,$d.jsxs)(vg,{children:[(0,$d.jsx)(bg,{children:"Byten rekommenderade"}),(0,$d.jsx)(yg,{children:Tg(Re.switch_recommended)})]}),(0,$d.jsxs)(vg,{children:[(0,$d.jsx)(bg,{children:"Snitt nettobesparing"}),(0,$d.jsxs)(yg,{children:[Tg(Re.avg_net_saving)," kr"]})]}),(0,$d.jsxs)(vg,{children:[(0,$d.jsx)(bg,{children:"Waitlist"}),(0,$d.jsx)(yg,{children:null!==(t=null===E||void 0===E||null===(r=E.waitlist)||void 0===r?void 0:r.length)&&void 0!==t?t:"\u2013"})]}),(0,$d.jsxs)(vg,{children:[(0,$d.jsx)(bg,{children:"Feedback"}),(0,$d.jsx)(yg,{children:null!==(a=null===E||void 0===E||null===(i=E.feedback)||void 0===i?void 0:i.length)&&void 0!==a?a:"\u2013"})]})]}),(0,$d.jsxs)(kg,{children:[(0,$d.jsx)(jg,{children:"Databasmigration"}),(0,$d.jsxs)(wg,{children:[(0,$d.jsxs)("div",{style:{padding:"16px 18px",display:"flex",alignItems:"center",gap:16,flexWrap:"wrap"},children:[(0,$d.jsxs)("p",{style:{margin:0,fontSize:13,color:"rgba(255,255,255,.6)",flex:1},children:["Skapar tabellerna ",(0,$d.jsx)("code",{style:{background:"rgba(255,255,255,.1)",padding:"1px 6px",borderRadius:4},children:"waitlist"}),","," ",(0,$d.jsx)("code",{style:{background:"rgba(255,255,255,.1)",padding:"1px 6px",borderRadius:4},children:"invoice_feedback"})," och"," ",(0,$d.jsx)("code",{style:{background:"rgba(255,255,255,.1)",padding:"1px 6px",borderRadius:4},children:"magic_tokens"})," i databasen. S\xe4kert att k\xf6ra flera g\xe5nger (IF NOT EXISTS)."]}),(0,$d.jsx)(Eg,{type:"button",onClick:async function(){W("loading"),Y(null);try{const e=await fetch("/api/admin/run-migration",{method:"POST",headers:{"x-admin-token":w}}),t=await e.json();Y(t),W(t.ok?"done":"error")}catch{W("error")}},disabled:"loading"===H,style:{background:"done"===H?"#16a34a":void 0},children:"loading"===H?"K\xf6r migration\u2026":"done"===H?"\u2713 Migration klar!":"K\xf6r migration \u2192"})]}),q&&(0,$d.jsx)("div",{style:{padding:"0 18px 16px",display:"flex",flexDirection:"column",gap:4},children:null===(o=q.results)||void 0===o?void 0:o.map(e=>(0,$d.jsxs)("div",{style:{fontSize:12,color:e.ok?"#5DD6CA":"#EF4444"},children:[e.ok?"\u2713":"\u2717"," ",e.name,e.error?` \u2014 ${e.error}`:""]},e.name))})]})]}),(0,$d.jsxs)(kg,{children:[(0,$d.jsx)(jg,{children:"Generera demo-l\xe4nk (Magic Link)"}),(0,$d.jsx)(wg,{children:(0,$d.jsxs)("div",{style:{padding:"16px 18px"},children:[(0,$d.jsx)("p",{style:{margin:"0 0 12px",fontSize:13,color:"rgba(255,255,255,.6)"},children:"Skickar en tidsbegr\xe4nsad l\xe4nk som ger direkt\xe5tkomst utan gate."}),(0,$d.jsxs)(_g,{onSubmit:async function(e){if(e.preventDefault(),D){U("loading"),M("");try{const e=await fetch("/api/admin/magic-link",{method:"POST",headers:{"Content-Type":"application/json","x-admin-token":w},body:JSON.stringify({email:D,note:P||void 0,expiresInHours:Number(L)})}),t=await e.json();if(!e.ok)return void U("error");M(t.link),U("done")}catch{U("error")}}},children:[(0,$d.jsx)(Ng,{type:"email",placeholder:"mottagare@foretag.se",value:D,onChange:e=>T(e.target.value),required:!0}),(0,$d.jsx)(Ng,{placeholder:"Notering (frivillig)",value:P,onChange:e=>O(e.target.value),style:{maxWidth:200}}),(0,$d.jsx)(Ng,{type:"number",placeholder:"Timmar (default 72)",value:L,onChange:e=>R(e.target.value),style:{maxWidth:140}}),(0,$d.jsx)(Eg,{type:"submit",disabled:!D||"loading"===B,children:"loading"===B?"Genererar\u2026":"Skicka magic link \u2192"})]}),I&&(0,$d.jsxs)(Ag,{children:["\u2713 L\xe4nk skickad till ",D,(0,$d.jsx)("br",{}),(0,$d.jsx)("strong",{children:I})]}),"error"===B&&(0,$d.jsx)("p",{style:{color:"#EF4444",fontSize:12,marginTop:8},children:"Misslyckades \u2014 kontrollera ADMIN_TOKEN och RESEND_API_KEY."})]})})]}),(0,$d.jsx)("div",{style:{display:"flex",gap:4,marginBottom:16},children:[["queue","Review Queue"],["waitlist","Waitlist"],["feedback","Feedback"],["corrections","Korrektioner \ud83e\udde0"],["connections","Anslutningar \ud83d\udd17"],["outbound","Outbound \ud83d\ude80"],["prisbok","Prisboken \ud83d\udcd2"]].map(e=>{let[t,r]=e;return(0,$d.jsx)("button",{onClick:()=>K(t),style:{padding:"7px 16px",borderRadius:100,border:"none",cursor:"pointer",fontSize:12.5,fontWeight:600,background:V===t?"#5DD6CA":"rgba(255,255,255,.08)",color:V===t?"#0E1A17":"rgba(255,255,255,.6)"},children:r},t)})}),"queue"===V&&(0,$d.jsx)(kg,{children:(0,$d.jsxs)(wg,{children:[(0,$d.jsxs)(Sg,{$cols:Ie,children:[(0,$d.jsx)("span",{children:"Leverant\xf6r"}),(0,$d.jsx)("span",{children:"Kategori"}),(0,$d.jsx)("span",{children:"\xc5rskkostnad"}),(0,$d.jsx)("span",{children:"Bransch"}),(0,$d.jsx)("span",{children:"Anst\xe4llda"}),(0,$d.jsx)("span",{children:"Datum"}),(0,$d.jsx)("span",{children:"\xc5tg\xe4rd"})]}),0===(null!==(s=null===E||void 0===E?void 0:E.reviewQueue)&&void 0!==s?s:[]).length&&(0,$d.jsx)(Fg,{children:"Inga review_queue-fakturor \xe4nnu."}),(null!==(l=null===E||void 0===E?void 0:E.reviewQueue)&&void 0!==l?l:[]).map(e=>(0,$d.jsxs)(n.Fragment,{children:[(0,$d.jsxs)($g,{$cols:Ie,children:[(0,$d.jsx)("span",{style:{fontWeight:600},children:e.supplier||e.normalized_supplier||"\u2013"}),(0,$d.jsx)(zg,{$c:"rgba(93,214,202,.15)",children:e.category}),(0,$d.jsxs)("span",{children:[Tg(e.annual_cost)," kr"]}),(0,$d.jsx)("span",{style:{color:"rgba(255,255,255,.5)"},children:e.industry}),(0,$d.jsx)("span",{style:{color:"rgba(255,255,255,.5)"},children:e.employees}),(0,$d.jsx)("span",{style:{color:"rgba(255,255,255,.4)",fontSize:11.5},children:Dg(e.created_at)}),(0,$d.jsx)("button",{onClick:()=>{const t=ue===e.id;pe(t?null:e.id),ge(""),ve(""),me("category"),je(null)},style:{padding:"4px 10px",borderRadius:100,border:"1px solid rgba(93,214,202,.3)",background:ue===e.id?"rgba(93,214,202,.15)":"transparent",color:"#5DD6CA",cursor:"pointer",fontSize:11.5,fontWeight:600},children:ue===e.id?"\u2715":"Korrigera"})]}),ue===e.id&&(0,$d.jsxs)("div",{style:{padding:"14px 16px",borderTop:"1px solid rgba(93,214,202,.12)",background:"rgba(93,214,202,.03)"},children:[(0,$d.jsx)("p",{style:{margin:"0 0 10px",fontSize:12,color:"rgba(255,255,255,.45)"},children:"Manuell korrektion \u2014 sparas som labeled data och tr\xe4nar systemet."}),(0,$d.jsxs)("div",{style:{display:"flex",gap:8,flexWrap:"wrap",alignItems:"center"},children:[(0,$d.jsxs)("select",{value:he,onChange:e=>{me(e.target.value),ge("")},style:Me,children:[(0,$d.jsx)("option",{value:"category",children:"Kategori"}),(0,$d.jsx)("option",{value:"recurring",children:"\xc5terkommande"}),(0,$d.jsx)("option",{value:"route",children:"Route"})]}),"category"===he&&(0,$d.jsxs)("select",{value:fe,onChange:e=>ge(e.target.value),style:Me,children:[(0,$d.jsx)("option",{value:"",children:"V\xe4lj r\xe4tt kategori\u2026"}),Be.map(e=>(0,$d.jsx)("option",{value:e,children:e},e))]}),"recurring"===he&&(0,$d.jsxs)("select",{value:fe,onChange:e=>ge(e.target.value),style:Me,children:[(0,$d.jsx)("option",{value:"",children:"V\xe4lj\u2026"}),(0,$d.jsx)("option",{value:"true",children:"true (\xe5terkommande)"}),(0,$d.jsx)("option",{value:"false",children:"false (eng\xe5ngskostnad)"})]}),"route"===he&&(0,$d.jsxs)("select",{value:fe,onChange:e=>ge(e.target.value),style:Me,children:[(0,$d.jsx)("option",{value:"",children:"V\xe4lj\u2026"}),(0,$d.jsx)("option",{value:"auto",children:"auto"}),(0,$d.jsx)("option",{value:"review_queue",children:"review_queue"}),(0,$d.jsx)("option",{value:"unsupported",children:"unsupported"})]}),(0,$d.jsx)(Ng,{placeholder:"Anledning (valfri)",value:xe,onChange:e=>ve(e.target.value),style:{flex:"1 1 140px",borderRadius:8,padding:"6px 12px",fontSize:12.5}}),(0,$d.jsx)(Eg,{type:"button",onClick:()=>async function(e){if(fe&&!be){ye(!0);try{var t,r;const n="category"===he?null!==(t=e.category)&&void 0!==t?t:"":"recurring"===he?"false":"";(await fetch("/api/admin/corrections",{method:"POST",headers:{"Content-Type":"application/json","x-admin-token":w},body:JSON.stringify({analysisId:e.id,field:he,originalValue:n,correctedValue:fe,reason:xe||"operator_manual_review",category:"category"===he?fe:null!==(r=e.category)&&void 0!==r?r:null,supplier:e.normalized_supplier||e.supplier||null,operatorReasoning:te||null})})).ok&&(je(e.id),setTimeout(()=>{je(null),pe(null),ge(""),ve(""),re(""),me("category")},2500))}catch{}finally{ye(!1)}}}(e),disabled:!fe||be,style:{padding:"7px 18px",fontSize:12.5},children:be?"Sparar\u2026":"Spara \u2192"})]}),(0,$d.jsx)("textarea",{placeholder:"Resonemang / princip (valfri men v\xe4rdefullt \u2014 anv\xe4nds som few-shot-exempel i AI:n n\xe4sta g\xe5ng)",value:te,onChange:e=>re(e.target.value),style:{marginTop:8,width:"100%",boxSizing:"border-box",padding:"8px 12px",borderRadius:8,border:"1.5px solid rgba(255,255,255,.12)",background:"rgba(255,255,255,.05)",color:"#fff",fontSize:12,fontFamily:"inherit",resize:"vertical",minHeight:56,outline:"none"}}),ke===e.id&&(0,$d.jsx)("p",{style:{color:"#5DD6CA",fontSize:12,margin:"8px 0 0"},children:"\u2713 Korrektion sparad \u2014 systemet l\xe4r sig."})]})]},e.id))]})}),"waitlist"===V&&(0,$d.jsx)(kg,{children:(0,$d.jsxs)(wg,{children:[(0,$d.jsxs)(Sg,{$cols:Ue,children:[(0,$d.jsx)("span",{children:"E-post"}),(0,$d.jsx)("span",{children:"K\xe4lla"}),(0,$d.jsx)("span",{children:"Reason"}),(0,$d.jsx)("span",{children:"Datum"})]}),0===(null!==(c=null===E||void 0===E?void 0:E.waitlist)&&void 0!==c?c:[]).length&&(0,$d.jsx)(Fg,{children:"Ingen waitlist \xe4nnu."}),(null!==(d=null===E||void 0===E?void 0:E.waitlist)&&void 0!==d?d:[]).map(e=>{var t;return(0,$d.jsxs)($g,{$cols:Ue,children:[(0,$d.jsx)("span",{style:{fontWeight:600},children:e.email}),(0,$d.jsx)(zg,{$c:"rgba(245,158,11,.15)",children:e.source}),(0,$d.jsx)("span",{style:{color:"rgba(255,255,255,.5)",fontSize:11.5},children:null!==(t=e.reason)&&void 0!==t?t:"\u2013"}),(0,$d.jsx)("span",{style:{color:"rgba(255,255,255,.4)",fontSize:11.5},children:Dg(e.created_at)})]},e.id)})]})}),"feedback"===V&&(0,$d.jsx)(kg,{children:(0,$d.jsxs)(wg,{children:[(0,$d.jsxs)(Sg,{$cols:Ve,children:[(0,$d.jsx)("span",{children:"Leverant\xf6r"}),(0,$d.jsx)("span",{children:"Kategori"}),(0,$d.jsx)("span",{children:"R\xf6st"}),(0,$d.jsx)("span",{children:"Kommentar"}),(0,$d.jsx)("span",{children:"Datum"})]}),0===(null!==(u=null===E||void 0===E?void 0:E.feedback)&&void 0!==u?u:[]).length&&(0,$d.jsx)(Fg,{children:"Ingen feedback \xe4nnu."}),(null!==(p=null===E||void 0===E?void 0:E.feedback)&&void 0!==p?p:[]).map(e=>{var t,r;return(0,$d.jsxs)($g,{$cols:Ve,children:[(0,$d.jsx)("span",{style:{fontWeight:600},children:e.supplier||"\u2013"}),(0,$d.jsx)("span",{style:{color:"rgba(255,255,255,.5)",fontSize:11.5},children:null!==(t=e.category)&&void 0!==t?t:"\u2013"}),(0,$d.jsx)("span",{style:{fontSize:18},children:"up"===e.vote?"\ud83d\udc4d":"\ud83d\udc4e"}),(0,$d.jsx)("span",{style:{color:"rgba(255,255,255,.5)",fontSize:11.5},children:null!==(r=e.comment)&&void 0!==r?r:"\u2013"}),(0,$d.jsx)("span",{style:{color:"rgba(255,255,255,.4)",fontSize:11.5},children:Dg(e.created_at)})]},e.id)})]})}),"corrections"===V&&(0,$d.jsxs)(kg,{children:[(0,$d.jsxs)("div",{style:{display:"flex",gap:8,marginBottom:14,alignItems:"center",flexWrap:"wrap"},children:[(0,$d.jsx)(jg,{style:{margin:0},children:"Flywheel \u2014 Labeled Corrections"}),(0,$d.jsxs)("div",{style:{marginLeft:"auto",display:"flex",gap:4,flexWrap:"wrap"},children:[[["list","Lista"],["patterns","M\xf6nster"],["learning","Aktiv inl\xe4rning \ud83d\udd2c"],["market","Marknadsdata \ud83d\udcca"]].map(e=>{let[t,r]=e;return(0,$d.jsx)("button",{onClick:()=>{ee(t);const e={"x-admin-token":w};"patterns"!==t||J||fetch("/api/admin/corrections?patterns",{headers:e}).then(e=>e.json()).then(e=>{var t;return X(null!==(t=e.patterns)&&void 0!==t?t:[])}).catch(()=>{}),"list"!==t||G||fetch("/api/admin/corrections",{headers:e}).then(e=>e.json()).then(e=>{var t;return Q(null!==(t=e.corrections)&&void 0!==t?t:[])}).catch(()=>{}),"learning"!==t||ne||fetch("/api/admin/corrections?learning",{headers:e}).then(e=>e.json()).then(e=>{var t;return ae(null!==(t=e.queue)&&void 0!==t?t:[])}).catch(()=>{}),"market"!==t||ie||fetch("/api/admin/corrections?market",{headers:e}).then(e=>e.json()).then(e=>oe(e)).catch(()=>{})},style:{padding:"5px 12px",borderRadius:100,border:"none",cursor:"pointer",fontSize:12,fontWeight:600,background:Z===t?"#5DD6CA":"rgba(255,255,255,.08)",color:Z===t?"#0E1A17":"rgba(255,255,255,.6)"},children:r},t)}),(0,$d.jsx)("button",{onClick:()=>{const e={"x-admin-token":w};"patterns"===Z&&fetch("/api/admin/corrections?patterns",{headers:e}).then(e=>e.json()).then(e=>{var t;return X(null!==(t=e.patterns)&&void 0!==t?t:[])}).catch(()=>{}),"list"===Z&&fetch("/api/admin/corrections",{headers:e}).then(e=>e.json()).then(e=>{var t;return Q(null!==(t=e.corrections)&&void 0!==t?t:[])}).catch(()=>{}),"learning"===Z&&fetch("/api/admin/corrections?learning",{headers:e}).then(e=>e.json()).then(e=>{var t;return ae(null!==(t=e.queue)&&void 0!==t?t:[])}).catch(()=>{}),"market"===Z&&fetch("/api/admin/corrections?market",{headers:e}).then(e=>e.json()).then(e=>oe(e)).catch(()=>{})},style:{padding:"5px 12px",borderRadius:100,border:"none",cursor:"pointer",fontSize:12,fontWeight:600,background:"rgba(255,255,255,.08)",color:"rgba(255,255,255,.6)"},children:"\u21bb Ladda"})]})]}),"list"===Z&&(0,$d.jsxs)(wg,{children:[(0,$d.jsxs)(Sg,{$cols:"1fr 1fr 1fr 1fr 80px 110px",children:[(0,$d.jsx)("span",{children:"F\xe4lt"}),(0,$d.jsx)("span",{children:"Fr\xe5n"}),(0,$d.jsx)("span",{children:"Till"}),(0,$d.jsx)("span",{children:"Anledning"}),(0,$d.jsx)("span",{children:"Av"}),(0,$d.jsx)("span",{children:"Datum"})]}),null===G&&(0,$d.jsx)(Fg,{children:"Klicka \u21bb Ladda f\xf6r att h\xe4mta korrektioner."}),0===(null===G||void 0===G?void 0:G.length)&&(0,$d.jsx)(Fg,{children:"Inga korrektioner \xe4nnu \u2014 systemet \xe4r nytt."}),(null!==G&&void 0!==G?G:[]).map(e=>(0,$d.jsxs)(n.Fragment,{children:[(0,$d.jsxs)($g,{$cols:"1fr 1fr 1fr 1fr 80px 110px",children:[(0,$d.jsx)(zg,{$c:"rgba(93,214,202,.15)",children:e.field}),(0,$d.jsx)("span",{style:{color:"rgba(255,100,100,.8)",fontSize:11.5},children:e.original_value||"\u2013"}),(0,$d.jsx)("span",{style:{color:"rgba(100,220,180,.8)",fontSize:11.5},children:e.corrected_value||"\u2013"}),(0,$d.jsx)("span",{style:{color:"rgba(255,255,255,.45)",fontSize:11},children:e.reason}),(0,$d.jsx)(zg,{$c:"operator"===e.corrected_by?"rgba(245,158,11,.2)":"rgba(93,214,202,.1)",children:e.corrected_by}),(0,$d.jsx)("span",{style:{color:"rgba(255,255,255,.4)",fontSize:11},children:Dg(e.created_at)})]}),e.operator_reasoning&&(0,$d.jsxs)("div",{style:{padding:"6px 16px 10px",borderTop:"1px solid rgba(255,255,255,.04)",background:"rgba(93,214,202,.02)"},children:[(0,$d.jsx)("span",{style:{fontSize:10.5,fontWeight:700,letterSpacing:".06em",textTransform:"uppercase",color:"rgba(93,214,202,.5)",marginRight:8},children:"Princip"}),(0,$d.jsx)("span",{style:{fontSize:12,color:"rgba(255,255,255,.55)"},children:e.operator_reasoning})]})]},e.id))]}),"patterns"===Z&&(0,$d.jsxs)(wg,{children:[(0,$d.jsxs)(Sg,{$cols:"1fr 2fr 80px 80px",children:[(0,$d.jsx)("span",{children:"F\xe4lt"}),(0,$d.jsx)("span",{children:"M\xf6nster (reason)"}),(0,$d.jsx)("span",{children:"Antal"}),(0,$d.jsx)("span",{children:"Av"})]}),null===J&&(0,$d.jsx)(Fg,{children:"Klicka \u21bb Ladda f\xf6r att analysera m\xf6nster."}),0===(null===J||void 0===J?void 0:J.length)&&(0,$d.jsx)(Fg,{children:"Inga m\xf6nster \xe4nnu."}),(null!==J&&void 0!==J?J:[]).map((e,t)=>(0,$d.jsxs)($g,{$cols:"1fr 2fr 80px 80px",children:[(0,$d.jsx)(zg,{$c:"rgba(93,214,202,.15)",children:e.field}),(0,$d.jsx)("span",{style:{color:"rgba(255,255,255,.6)",fontSize:11.5},children:e.reason}),(0,$d.jsxs)("span",{style:{fontWeight:700,color:e.count>=5?"#F59E0B":"#5DD6CA"},children:[e.count,"\xd7"]}),(0,$d.jsx)(zg,{$c:"operator"===e.corrected_by?"rgba(245,158,11,.2)":"rgba(93,214,202,.1)",children:e.corrected_by})]},t))]}),"learning"===Z&&(0,$d.jsxs)($d.Fragment,{children:[(0,$d.jsx)("div",{style:{marginBottom:12,padding:"10px 14px",background:"rgba(245,158,11,.08)",border:"1px solid rgba(245,158,11,.2)",borderRadius:10,fontSize:12.5,color:"rgba(255,255,255,.7)"},children:"Leverant\xf6rer som inte matchar n\xe5got k\xe4nt fingerprint \u2014 flaggade automatiskt av pipeline. L\xe4gg till korrektion f\xf6r att l\xe4ra systemet."}),(0,$d.jsxs)(wg,{children:[(0,$d.jsxs)(Sg,{$cols:"2fr 80px 1.5fr",children:[(0,$d.jsx)("span",{children:"Leverant\xf6r (ok\xe4nd)"}),(0,$d.jsx)("span",{children:"Sedd"}),(0,$d.jsx)("span",{children:"Senast"})]}),null===ne&&(0,$d.jsx)(Fg,{children:"Klicka \u21bb Ladda f\xf6r att h\xe4mta k\xf6n."}),0===(null===ne||void 0===ne?void 0:ne.length)&&(0,$d.jsx)(Fg,{children:"Inga ok\xe4nda leverant\xf6rer \u2014 systemet k\xe4nner igen alla det sett."}),(null!==ne&&void 0!==ne?ne:[]).map((e,t)=>(0,$d.jsxs)($g,{$cols:"2fr 80px 1.5fr",children:[(0,$d.jsx)("span",{style:{fontWeight:600,color:"#F59E0B"},children:e.supplier}),(0,$d.jsxs)("span",{style:{fontWeight:700,color:e.seen_count>=3?"#EF4444":"#F59E0B"},children:[e.seen_count,"\xd7"]}),(0,$d.jsx)("span",{style:{color:"rgba(255,255,255,.4)",fontSize:11.5},children:Dg(e.last_seen)})]},t))]})]}),"market"===Z&&(0,$d.jsxs)($d.Fragment,{children:[(0,$d.jsxs)("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:16,marginBottom:20},children:[(0,$d.jsxs)("div",{children:[(0,$d.jsx)(jg,{children:"Kategorif\xf6rdelning (operat\xf6rskorrektioner)"}),(0,$d.jsxs)(wg,{children:[(0,$d.jsxs)(Sg,{$cols:"2fr 80px",children:[(0,$d.jsx)("span",{children:"Kategori"}),(0,$d.jsx)("span",{children:"Antal"})]}),!ie&&(0,$d.jsx)(Fg,{children:"Klicka \u21bb Ladda."}),0===(null===ie||void 0===ie||null===(h=ie.categoryDist)||void 0===h?void 0:h.length)&&(0,$d.jsx)(Fg,{children:"Inga korrektioner \xe4nnu."}),(null!==(m=null===ie||void 0===ie?void 0:ie.categoryDist)&&void 0!==m?m:[]).map((e,t)=>(0,$d.jsxs)($g,{$cols:"2fr 80px",children:[(0,$d.jsx)(zg,{$c:"rgba(93,214,202,.15)",children:e.category}),(0,$d.jsxs)("span",{style:{fontWeight:700,color:"#5DD6CA"},children:[e.count,"\xd7"]})]},t))]})]}),(0,$d.jsxs)("div",{children:[(0,$d.jsx)(jg,{children:"Mest korrigerade leverant\xf6rer"}),(0,$d.jsxs)(wg,{children:[(0,$d.jsxs)(Sg,{$cols:"2fr 80px 1fr",children:[(0,$d.jsx)("span",{children:"Leverant\xf6r"}),(0,$d.jsx)("span",{children:"Korr."}),(0,$d.jsx)("span",{children:"Senast"})]}),!ie&&(0,$d.jsx)(Fg,{children:"Klicka \u21bb Ladda."}),0===(null===ie||void 0===ie||null===(f=ie.topSuppliers)||void 0===f?void 0:f.length)&&(0,$d.jsx)(Fg,{children:"Inga korrektioner \xe4nnu."}),(null!==(g=null===ie||void 0===ie?void 0:ie.topSuppliers)&&void 0!==g?g:[]).map((e,t)=>(0,$d.jsxs)($g,{$cols:"2fr 80px 1fr",children:[(0,$d.jsx)("span",{style:{fontWeight:600,fontSize:12},children:e.supplier}),(0,$d.jsxs)("span",{style:{fontWeight:700,color:e.correction_count>=5?"#F59E0B":"#5DD6CA"},children:[e.correction_count,"\xd7"]}),(0,$d.jsx)("span",{style:{color:"rgba(255,255,255,.4)",fontSize:11},children:Dg(e.last_corrected)})]},t))]})]})]}),(0,$d.jsx)(jg,{children:"Nya leverant\xf6rer per vecka (senaste 90 dagar)"}),(null===ie||void 0===ie||null===(x=ie.discoveryTrend)||void 0===x?void 0:x.length)>0?(0,$d.jsxs)(wg,{children:[(0,$d.jsxs)(Sg,{$cols:"2fr 1fr",children:[(0,$d.jsx)("span",{children:"Vecka"}),(0,$d.jsx)("span",{children:"Ny leverant\xf6rer"})]}),(null!==(v=ie.discoveryTrend)&&void 0!==v?v:[]).map((e,t)=>(0,$d.jsxs)($g,{$cols:"2fr 1fr",children:[(0,$d.jsx)("span",{style:{color:"rgba(255,255,255,.5)",fontSize:12},children:e.week}),(0,$d.jsx)("span",{style:{fontWeight:700,color:"#5DD6CA"},children:e.new_suppliers})]},t))]}):(0,$d.jsx)(Fg,{children:ie?"Inga data \xe4nnu \u2014 skicka in fakturor f\xf6r att bygga marknadsdata.":"Klicka \u21bb Ladda."})]})]}),"connections"===V&&(0,$d.jsxs)(kg,{children:[(0,$d.jsxs)("div",{style:{display:"flex",gap:8,marginBottom:14,alignItems:"center"},children:[(0,$d.jsx)(jg,{style:{margin:0},children:"OAuth-anslutningar \u2014 Gmail & Outlook"}),(0,$d.jsx)("button",{onClick:()=>{fetch("/api/admin/connections",{headers:{"x-admin-token":w}}).then(e=>e.json()).then(e=>{var t,r;le(null!==(t=e.connections)&&void 0!==t?t:[]),de(null!==(r=e.stats)&&void 0!==r?r:[])}).catch(()=>{})},style:{marginLeft:"auto",padding:"5px 12px",borderRadius:100,border:"none",cursor:"pointer",fontSize:12,fontWeight:600,background:"rgba(255,255,255,.08)",color:"rgba(255,255,255,.6)"},children:"\u21bb Ladda"})]}),ce&&ce.length>0&&(0,$d.jsx)("div",{style:{display:"flex",gap:10,marginBottom:14},children:ce.map(e=>(0,$d.jsxs)("div",{style:{background:"rgba(255,255,255,.06)",border:"1px solid rgba(255,255,255,.1)",borderRadius:10,padding:"10px 16px",minWidth:130},children:[(0,$d.jsx)(bg,{children:e.provider}),(0,$d.jsxs)("div",{style:{display:"flex",gap:12,marginTop:4},children:[(0,$d.jsxs)("div",{children:[(0,$d.jsx)("div",{style:{fontSize:18,fontWeight:800,color:"#5DD6CA"},children:e.total}),(0,$d.jsx)("div",{style:{fontSize:10,color:"rgba(255,255,255,.35)"},children:"totalt"})]}),(0,$d.jsxs)("div",{children:[(0,$d.jsx)("div",{style:{fontSize:18,fontWeight:800,color:"#4ADE80"},children:e.active}),(0,$d.jsx)("div",{style:{fontSize:10,color:"rgba(255,255,255,.35)"},children:"aktiva"})]}),(0,$d.jsxs)("div",{children:[(0,$d.jsx)("div",{style:{fontSize:18,fontWeight:800,color:"#F59E0B"},children:e.last_7d}),(0,$d.jsx)("div",{style:{fontSize:10,color:"rgba(255,255,255,.35)"},children:"7 dagar"})]})]})]},e.provider))}),(0,$d.jsxs)(wg,{children:[(0,$d.jsxs)(Sg,{$cols:"2fr 1fr 1fr 1.5fr 1.5fr 80px",children:[(0,$d.jsx)("span",{children:"E-post"}),(0,$d.jsx)("span",{children:"Leverant\xf6r"}),(0,$d.jsx)("span",{children:"Token"}),(0,$d.jsx)("span",{children:"Kopplad"}),(0,$d.jsx)("span",{children:"Uppdaterad"}),(0,$d.jsx)("span",{children:"Status"})]}),null===se&&(0,$d.jsx)(Fg,{children:"Klicka \u21bb Ladda f\xf6r att h\xe4mta anslutningar."}),0===(null===se||void 0===se?void 0:se.length)&&(0,$d.jsx)(Fg,{children:"Inga anslutningar \xe4nnu \u2014 ingen har kopplat Gmail/Outlook."}),(null!==se&&void 0!==se?se:[]).map(e=>(0,$d.jsxs)($g,{$cols:"2fr 1fr 1fr 1.5fr 1.5fr 80px",children:[(0,$d.jsx)("span",{style:{fontWeight:600,fontSize:12.5},children:e.email}),(0,$d.jsx)(zg,{$c:"gmail"===e.provider?"rgba(234,67,53,.2)":"rgba(0,120,212,.2)",children:e.provider}),(0,$d.jsx)("span",{style:{fontSize:11,color:"rgba(255,255,255,.4)"},children:e.token_expiry?new Date(e.token_expiry).toLocaleDateString("sv-SE"):"\u2013"}),(0,$d.jsx)("span",{style:{color:"rgba(255,255,255,.4)",fontSize:11.5},children:Dg(e.created_at)}),(0,$d.jsx)("span",{style:{color:"rgba(255,255,255,.4)",fontSize:11.5},children:Dg(e.updated_at)}),(0,$d.jsx)(zg,{$c:e.token_valid?"rgba(74,222,128,.2)":"rgba(239,68,68,.2)",children:e.token_valid?"OK":"Utg\xe5ngen"})]},e.id))]})]}),"prisbok"===V&&(0,$d.jsxs)(kg,{children:[(0,$d.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:10,marginBottom:12},children:[(0,$d.jsx)(jg,{style:{margin:0},children:"Prisbokens cellteckning"}),(0,$d.jsx)("button",{onClick:Oe,style:{marginLeft:"auto",padding:"6px 14px",borderRadius:100,border:"none",cursor:"pointer",fontSize:12,fontWeight:600,background:"rgba(255,255,255,.08)",color:"rgba(255,255,255,.7)"},children:"Uppdatera"})]}),Te?(0,$d.jsxs)($d.Fragment,{children:[(0,$d.jsxs)("p",{style:{fontSize:12.5,color:"rgba(255,255,255,.55)",margin:"0 0 14px"},children:[null!==(b=Te.total_datapoints)&&void 0!==b?b:0," datapunkter totalt \xb7 ",null!==(y=Te.segments_with_real_data)&&void 0!==y?y:0," celler b\xe4r (\u2265",Te.min_points_threshold,") \xb7 celler n\xe4ra tr\xf6skeln fylls medvetet \u2014 v\xe4lj n\xe4sta outbound-lista p\xe5 SNI-koder som tippar dem \xf6ver."]}),(0,$d.jsxs)(wg,{children:[(0,$d.jsxs)(Sg,{$cols:"1.2fr 1fr .8fr .5fr .8fr",children:[(0,$d.jsx)("span",{children:"Kategori"}),(0,$d.jsx)("span",{children:"Bransch"}),(0,$d.jsx)("span",{children:"Storlek"}),(0,$d.jsx)("span",{children:"n"}),(0,$d.jsx)("span",{children:"Status"})]}),0===(null!==(k=Te.segments)&&void 0!==k?k:[]).length&&(0,$d.jsx)(Fg,{children:"Prisboken \xe4r tom \u2014 varje analyserad faktura l\xe4gger en datapunkt."}),(null!==(j=Te.segments)&&void 0!==j?j:[]).map((e,t)=>(0,$d.jsxs)($g,{$cols:"1.2fr 1fr .8fr .5fr .8fr",children:[(0,$d.jsx)("span",{style:{fontWeight:600},children:e.category}),(0,$d.jsx)("span",{style:{color:"rgba(255,255,255,.6)"},children:e.industry}),(0,$d.jsx)("span",{style:{color:"rgba(255,255,255,.5)"},children:e.size_bucket}),(0,$d.jsx)("span",{style:{fontWeight:700},children:e.n}),(0,$d.jsx)(zg,{$c:"B\xc4R"===e.status?"rgba(93,214,202,.2)":"LIVE-LIGHT"===e.status?"rgba(93,214,202,.12)":"N\xc4RA"===e.status?"rgba(245,158,11,.15)":"rgba(255,255,255,.08)",children:e.status})]},t))]})]}):(0,$d.jsx)(Fg,{children:"Klicka Uppdatera f\xf6r att l\xe4sa cellteckningen."})]}),"outbound"===V&&(0,$d.jsxs)(kg,{children:[(0,$d.jsx)("div",{style:{display:"flex",gap:10,marginBottom:20,flexWrap:"wrap"},children:[["Skapade",null===$e||void 0===$e?void 0:$e.total,"#5DD6CA"],["Mail skickade",null===$e||void 0===$e?void 0:$e.email_sent,"#5DD6CA"],["\xd6ppnade l\xe4nken",null===$e||void 0===$e?void 0:$e.opened,"#F59E0B"],["Konverterade",null===$e||void 0===$e?void 0:$e.converted,"#4ADE80"]].map(e=>{let[t,r,n]=e;return(0,$d.jsxs)(vg,{style:{minWidth:120},children:[(0,$d.jsx)(bg,{children:t}),(0,$d.jsx)(yg,{style:{color:n},children:null!==r&&void 0!==r?r:"\u2013"})]},t)})}),(0,$d.jsx)(jg,{children:"Skapa prospect"}),(0,$d.jsx)(wg,{children:(0,$d.jsxs)("div",{style:{padding:"16px 18px"},children:[(0,$d.jsxs)("form",{onSubmit:async function(e){if(e.preventDefault(),"loading"!==Ee&&_e.companyName&&_e.employees){Ae("loading"),Fe(null);try{const e=await fetch("/api/generate-prospect",{method:"POST",headers:{"Content-Type":"application/json","x-arvo-admin":w},body:JSON.stringify({companyName:_e.companyName,sniCode:_e.sniCode||void 0,employees:Number(_e.employees),contactEmail:_e.contactEmail||void 0,sendEmail:_e.sendEmail,createdBy:"admin-ui"})}),t=await e.json();Fe(t),t.ok&&(Ne({companyName:"",sniCode:"",employees:"",contactEmail:"",sendEmail:!1}),Le())}catch{Fe({ok:!1,error:"N\xe4tverksfel"})}finally{Ae("idle")}}},style:{display:"flex",gap:8,flexWrap:"wrap",alignItems:"flex-end"},children:[(0,$d.jsx)(Ng,{placeholder:"Bolagsnamn *",value:_e.companyName,onChange:e=>Ne(t=>({...t,companyName:e.target.value})),style:{minWidth:180,borderRadius:8}}),(0,$d.jsx)(Ng,{placeholder:"SNI-kod (t.ex. 41)",value:_e.sniCode,onChange:e=>Ne(t=>({...t,sniCode:e.target.value})),style:{width:130,borderRadius:8}}),(0,$d.jsx)(Ng,{placeholder:"Antal anst. *",type:"number",value:_e.employees,onChange:e=>Ne(t=>({...t,employees:e.target.value})),style:{width:110,borderRadius:8}}),(0,$d.jsx)(Ng,{placeholder:"Kontakt-mail",value:_e.contactEmail,onChange:e=>Ne(t=>({...t,contactEmail:e.target.value})),style:{minWidth:200,borderRadius:8}}),(0,$d.jsxs)("label",{style:{display:"flex",alignItems:"center",gap:6,fontSize:13,color:"rgba(255,255,255,.6)",whiteSpace:"nowrap",cursor:"pointer"},children:[(0,$d.jsx)("input",{type:"checkbox",checked:_e.sendEmail,onChange:e=>Ne(t=>({...t,sendEmail:e.target.checked}))}),"Skicka mail"]}),(0,$d.jsx)(Eg,{type:"submit",disabled:"loading"===Ee||!_e.companyName||!_e.employees,children:"loading"===Ee?"\u2026":"Skapa \u2192"})]}),Ce&&(0,$d.jsx)("div",{style:{marginTop:10,padding:"10px 14px",borderRadius:8,background:Ce.ok?"rgba(74,222,128,.1)":"rgba(239,68,68,.1)",border:"1px solid "+(Ce.ok?"rgba(74,222,128,.25)":"rgba(239,68,68,.25)")},children:Ce.ok?(0,$d.jsxs)("span",{style:{fontSize:12.5,color:"#4ADE80"},children:["\u2713 Skapad:\xa0",(0,$d.jsx)("a",{href:Ce.url,target:"_blank",rel:"noopener noreferrer",style:{color:"#5DD6CA",wordBreak:"break-all"},children:Ce.url}),Ce.emailSent&&" \xb7 mail skickat"]}):(0,$d.jsxs)("span",{style:{fontSize:12.5,color:"#F87171"},children:["Fel: ",Ce.error]})})]})}),(0,$d.jsxs)("div",{style:{display:"flex",gap:8,marginBottom:12,marginTop:20,alignItems:"center"},children:[(0,$d.jsx)(jg,{style:{margin:0},children:"Prospects"}),(0,$d.jsx)("button",{onClick:Le,style:{marginLeft:"auto",padding:"5px 12px",borderRadius:100,border:"none",cursor:"pointer",fontSize:12,fontWeight:600,background:"rgba(255,255,255,.08)",color:"rgba(255,255,255,.6)"},children:"\u21bb Ladda"})]}),(0,$d.jsxs)(wg,{children:[(0,$d.jsxs)(Sg,{$cols:"2fr 1.5fr 0.6fr 1.3fr 1.3fr 1fr 1fr",children:[(0,$d.jsx)("span",{children:"Bolag"}),(0,$d.jsx)("span",{children:"Bransch"}),(0,$d.jsx)("span",{children:"Anst."}),(0,$d.jsx)("span",{children:"Mail skickat"}),(0,$d.jsx)("span",{children:"\xd6ppnat"}),(0,$d.jsx)("span",{children:"\xc5tg\xe4rd"}),(0,$d.jsx)("span",{children:"Skapad"})]}),null===we&&(0,$d.jsx)(Fg,{children:"Klicka \u21bb Ladda f\xf6r att h\xe4mta prospects."}),0===(null===we||void 0===we?void 0:we.length)&&(0,$d.jsx)(Fg,{children:"Inga prospects \xe4n \u2014 skapa ett ovan."}),(null!==we&&void 0!==we?we:[]).map(e=>{var t;return(0,$d.jsxs)($g,{$cols:"2fr 1.5fr 0.6fr 1.3fr 1.3fr 1fr 1fr",children:[(0,$d.jsx)("span",{style:{fontWeight:600,fontSize:12.5},children:e.company_name}),(0,$d.jsx)("span",{style:{fontSize:11.5,color:"rgba(255,255,255,.50)"},children:e.industry}),(0,$d.jsx)("span",{style:{fontSize:12},children:e.employees}),(0,$d.jsx)("span",{style:{fontSize:11,color:e.email_sent_at?"rgba(255,255,255,.5)":"rgba(255,255,255,.2)"},children:Dg(e.email_sent_at)}),(0,$d.jsx)("span",{style:{fontSize:11,color:e.opened_at?"#F59E0B":"rgba(255,255,255,.2)"},children:Dg(e.opened_at)}),(0,$d.jsx)(zg,{$c:"upload"===e.action?"rgba(74,222,128,.25)":"activate"===e.action?"rgba(93,214,202,.25)":"rgba(255,255,255,.07)",children:null!==(t=e.action)&&void 0!==t?t:"\u2013"}),(0,$d.jsx)("span",{style:{fontSize:11,color:"rgba(255,255,255,.30)"},children:Dg(e.created_at)})]},e.id)})]})]})]})}const Og=vd.div`
  min-height: 100vh;
  background: ${e=>{let{theme:t}=e;return t.color.bg}};
  display: flex;
  flex-direction: column;
...
`,Wg=vd(vs)`
  ...
  text-decoration: none;
  &:hover { color: ${e=>{let{theme:t}=e;return t.color.ink}}; }
`;function qg(){const e=new URLSearchParams(window.location.search),t=e.get("id"),r=e.get("svar"),[a,i]=(0,n.useState)("ja"===r?"cost":"nej"===r?"submitting-no":"question"),[o,s]=(0,n.useState)(""),[l,c]=(0,n.useState)("idle"),[d,u]=(0,n.useState)("");async function p(e,r){if(t){c("submitting");try{const n=await fetch("/api/outcome-survey",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({analysisId:t,switched:e,actualAnnualCost:r?Number(String(r).replace(/\s/g,"")):null})}),a=await n.json();a.supplier&&u(a.supplier),c("done")}catch{c("error")}}else c("done")}return(0,n.useEffect)(()=>{"nej"===r&&t&&p(!1,null)},[]),"done"===l?(0,$d.jsx)(Og,{children:(0,$d.jsxs)(Lg,{children:[(0,$d.jsx)(Rg,{children:(0,$d.jsx)(vs,{to:"/",children:(0,$d.jsx)(Pd,{})})}),(0,$d.jsx)(Hg,{children:"\u2713"}),(0,$d.jsx)(Mg,{children:"Tack \u2014 det hj\xe4lper oss mycket."}),(0,$d.jsxs)(Bg,{children:["Varje svar g\xf6r Arvo lite mer precis. N\xe4sta kund som analyserar en",d?` ${d}`:"","-faktura drar nytta av det ni just ber\xe4ttade."]}),(0,$d.jsx)(Id,{as:vs,to:"/testa-faktura",$variant:"gradient",$size:"md",children:"Analysera en ny faktura \u2192"})]})}):"submitting-no"===a||"nej"===r&&"done"!==l?(0,$d.jsx)(Og,{children:(0,$d.jsxs)(Lg,{style:{textAlign:"center"},children:[(0,$d.jsx)(Rg,{style:{textAlign:"left"},children:(0,$d.jsx)(vs,{to:"/",children:(0,$d.jsx)(Pd,{})})}),(0,$d.jsx)(Bg,{style:{margin:"32px 0 0"},children:"Registrerar ert svar\u2026"})]})}):(0,$d.jsx)(Og,{children:(0,$d.jsxs)(Lg,{children:[(0,$d.jsx)(Rg,{children:(0,$d.jsx)(vs,{to:"/",children:(0,$d.jsx)(Pd,{})})}),(0,$d.jsx)(Ig,{children:"60-dagars uppf\xf6ljning"}),"question"===a&&(0,$d.jsxs)($d.Fragment,{children:[(0,$d.jsx)(Mg,{children:"Bytte ni leverant\xf6r efter analysen?"}),(0,$d.jsx)(Bg,{children:"Det tar 30 sekunder och hj\xe4lper oss att bli mer precisa f\xf6r er och alla kommande kunder."}),(0,$d.jsxs)(Ug,{children:[(0,$d.jsx)(Id,{$variant:"gradient",$size:"md",onClick:()=>i("cost"),children:"Ja, vi bytte \u2192"}),(0,$d.jsx)(Id,{$variant:"ghost",$size:"md",onClick:()=>p(!1,null),children:"Inte \xe4n"})]})]}),"cost"===a&&(0,$d.jsxs)($d.Fragment,{children:[(0,$d.jsx)(Mg,{children:"Vad betalar ni nu per \xe5r?"}),(0,$d.jsx)(Bg,{children:"Ange er nya \xe5rskostnad (kr/\xe5r) \u2014 vi j\xe4mf\xf6r med vad vi f\xf6rutsp\xe5dde."}),(0,$d.jsx)(Kg,{htmlFor:"actual-cost",children:"Ny \xe5rskostnad (kr)"}),(0,$d.jsx)(Vg,{id:"actual-cost",type:"text",inputMode:"numeric",placeholder:"t.ex. 48 000",value:o,onChange:e=>s(e.target.value),autoFocus:!0}),(0,$d.jsxs)(Ug,{children:[(0,$d.jsx)(Id,{$variant:"gradient",$size:"md",disabled:"submitting"===l,onClick:()=>p(!0,o),children:"submitting"===l?"Sparar\u2026":"Skicka \u2192"}),(0,$d.jsx)(Id,{$variant:"ghost",$size:"sm",onClick:()=>p(!0,null),children:"Hoppa \xf6ver kostnaden"})]}),"error"===l&&(0,$d.jsx)("p",{style:{color:"#D94F3C",fontSize:13,margin:"8px 0 0"},children:"N\xe5got gick fel \u2014 f\xf6rs\xf6k igen."})]}),(0,$d.jsx)(Wg,{to:"/",children:"\u2190 Tillbaka till startsidan"})]})})}const Yg=jd`
...
`,Nx=vd.span`
  ...
  border-radius: 50%;
  animation: ${Xg} 0.7s linear infinite;
`,Ex=(vd.button`
  width: 100%;
  background: none;
  border: none;
...
`),Ax=vd.div`
  ...
  svg path {
    ...
    animation: ${Jg} 0.5s 0.3s ease forwards;
  }
`,Cx=vd.h2`
  margin: 0 0 12px;
...
`,qx=vd.a`
  ...
  &:hover { opacity: 0.88; }
`,Yx=e=>Math.round(null!==e&&void 0!==e?e:0).toLocaleString("sv-SE");const Gx={recommendation:"Bytesrekommendation",cost_trend:"Prish\xf6jning",overpaying:"\xd6verpris",price_alert:"Prish\xf6jningsvarning"};function Qx(e){if(!e)return"";const[t,r]=e.split("-").map(Number),n=new Date(t,r-1,1).toLocaleString("sv-SE",{month:"long",year:"numeric"});return n.charAt(0).toUpperCase()+n.slice(1)}const Jx=e=>{let{size:t=36}=e;return(0,$d.jsxs)("svg",{width:t,height:t,viewBox:"0 0 100 100",fill:"none","aria-hidden":"true",children:[(0,$d.jsx)("defs",{children:(0,$d.jsxs)("linearGradient",{id:"briefingGrad",x1:"50",y1:"5",x2:"50",y2:"95",gradientUnits:"userSpaceOnUse",children:[(0,$d.jsx)("stop",{offset:"0%",stopColor:"#4ECDC4"}),(0,$d.jsx)("stop",{offset:"100%",stopColor:"#1DB09A"})]})}),(0,$d.jsx)("path",{d:"M50 5 L12 85 L35 85 L50 55 L65 85 L88 85 Z",fill:"url(#briefingGrad)"})]})},Xx=()=>(0,$d.jsx)("svg",{width:"20",height:"20",viewBox:"0 0 20 20",fill:"none",children:(0,$d.jsx)("path",{d:"M10 4v12M4 10l6 6 6-6",stroke:"#1DB09A",strokeWidth:"1.8",strokeLinecap:"round",strokeLinejoin:"round"})}),Zx=()=>(0,$d.jsx)("svg",{width:"28",height:"28",viewBox:"0 0 28 28",fill:"none",children:(0,$d.jsx)("path",{d:"M6 14l6 6 10-12",stroke:"#1DB09A",strokeWidth:"2.2",strokeLinecap:"round",strokeLinejoin:"round"})});function ev(){var e;const{token:t}=ho(),[r,a]=(0,n.useState)("loading"),[i,o]=(0,n.useState)(null),[s,l]=(0,n.useState)(""),[c,d]=(0,n.useState)(0),[u,p]=(0,n.useState)({}),[h,m]=(0,n.useState)({}),[f,g]=(0,n.useState)({}),x=(0,n.useRef)(null),v=(0,n.useRef)([]),b=function(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:1300;const[r,a]=(0,n.useState)(0);return(0,n.useEffect)(()=>{if(!e)return;const r=performance.now();let n;const i=o=>{const s=Math.min(1,(o-r)/t),l=1-Math.pow(1-s,3);a(Math.round(l*e)),s<1&&(n=requestAnimationFrame(i))};return n=requestAnimationFrame(i),()=>cancelAnimationFrame(n)},[e,t]),r}("ready"===r?null===i||void 0===i?void 0:i.totalSavingPotential:0);(0,n.useEffect)(()=>{if(!t)return a("error"),void l("Ogiltig l\xe4nk");fetch(`/api/briefing?token=${encodeURIComponent(t)}`).then(e=>e.json()).then(e=>{var t,r;if(!e.ok)return a("error"),void l(null!==(r=e.error)&&void 0!==r?r:"Ok\xe4nt fel");o(e.briefing),g(null!==(t=e.briefing.actionsTaken)&&void 0!==t?t:{}),a("ready")}).catch(()=>{a("error"),l("Kunde inte h\xe4mta briefingen")})},[t]),(0,n.useEffect)(()=>{if("ready"!==r)return;const e=new IntersectionObserver(e=>{e.forEach(e=>{const t=Number(e.target.dataset.cardIndex);e.isIntersecting&&(p(e=>({...e,[t]:!0})),d(t))})},{threshold:.4,root:x.current});return v.current.forEach(t=>{t&&e.observe(t)}),()=>e.disconnect()},[r,i]);const y=(0,n.useCallback)(async(e,r)=>{if("loading"!==h[e]&&"done"!==h[e]){m(t=>({...t,[e]:"loading"}));try{const a=await fetch(`/api/briefing?token=${encodeURIComponent(t)}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({insightId:e,action:r})}),i=await a.json();var n;if(a.ok&&i.ok)m(t=>({...t,[e]:"done"})),g(null!==(n=i.actionsTaken)&&void 0!==n?n:{});else m(t=>({...t,[e]:"idle"}))}catch{m(t=>({...t,[e]:"idle"}))}}},[t,h]),k=(0,n.useCallback)(e=>{const t=v.current[e];t&&t.scrollIntoView({behavior:"smooth",block:"start"})},[]);if("loading"===r)return(0,$d.jsxs)(Ix,{children:[(0,$d.jsx)(Mx,{children:[0,1,2].map(e=>(0,$d.jsx)(Bx,{$i:e},e))}),(0,$d.jsx)(Ux,{children:"H\xe4mtar din Arvo-briefing\u2026"})]});if("error"===r)return(0,$d.jsxs)(Vx,{children:[(0,$d.jsx)(Kx,{children:"\ud83d\udd12"}),(0,$d.jsx)(Hx,{children:"Briefingen hittades inte"}),(0,$d.jsxs)(Wx,{children:[s||"L\xe4nken kan ha g\xe5tt ut eller \xe4r ogiltig."," ","Ladda upp en ny faktura s\xe5 genererar Arvo en uppdaterad briefing \xe5t er."]}),(0,$d.jsx)(qx,{href:"/testa-faktura",children:"Analysera en faktura \u2192"})]});const j=null!==(e=null===i||void 0===i?void 0:i.insights)&&void 0!==e?e:[],w=1+j.length+1,S=Object.keys(f).length>0;return(0,$d.jsxs)($d.Fragment,{children:[(0,$d.jsx)(ux,{children:Array.from({length:w},(e,t)=>(0,$d.jsx)(px,{$active:c===t,onClick:()=>k(t),"aria-label":`G\xe5 till kort ${t+1}`},t))}),(0,$d.jsxs)(Zg,{ref:x,children:[(0,$d.jsxs)(tx,{"data-card-index":"0",ref:e=>{v.current[0]=e},children:[(0,$d.jsx)(Jx,{size:44}),(0,$d.jsx)(rx,{children:"Arvo Intelligence"}),(0,$d.jsx)(nx,{children:Qx(null===i||void 0===i?void 0:i.period)}),(0,$d.jsx)(ax,{children:"Potentiell besparing"}),(0,$d.jsxs)(ix,{children:[Yx(b),(0,$d.jsx)(ox,{children:"kr/\xe5r"})]}),(0,$d.jsxs)(sx,{children:["Arvo har identifierat"," ",(0,$d.jsxs)("strong",{children:[j.length," ",1===j.length?"besparingsinsikt":"besparingsinsikter"]})," ","f\xf6r ert bolag"]}),(0,$d.jsxs)(lx,{children:[(0,$d.jsx)(cx,{children:"Scrolla f\xf6r att se insikterna"}),(0,$d.jsx)(dx,{children:(0,$d.jsx)(Xx,{})})]})]}),j.map((e,t)=>{var r,n,a,i,o,s,l,c,d,p,m,g;const x=t+1,b=!!u[x],k=null!==(r=h[e.id])&&void 0!==r?r:"idle",w="done"===k||!!f[e.id],S="loading"===k;return(0,$d.jsx)(hx,{"data-card-index":String(x),ref:e=>{v.current[x]=e},children:(0,$d.jsxs)(mx,{children:[(0,$d.jsxs)(fx,{$visible:b,children:["INSIKT ",t+1," AV ",j.length]}),(0,$d.jsxs)("div",{children:[(0,$d.jsx)(xx,{$type:e.type,children:null!==(n=Gx[e.type])&&void 0!==n?n:e.type}),(0,$d.jsx)(gx,{$visible:b,children:e.supplier})]}),(0,$d.jsx)(vx,{$visible:b,children:e.headline}),(0,$d.jsx)(bx,{$visible:b,children:e.subheadline}),(0,$d.jsxs)(yx,{$visible:b,children:[(0,$d.jsxs)(kx,{children:[(0,$d.jsxs)(jx,{$primary:!0,children:[Yx(null===(a=e.metric)||void 0===a||null===(i=a.primary)||void 0===i?void 0:i.value),(0,$d.jsx)(wx,{children:"kr"})]}),(0,$d.jsx)(Sx,{children:null===(o=e.metric)||void 0===o||null===(s=o.primary)||void 0===s?void 0:s.label})]}),null!=(null===(l=e.metric)||void 0===l||null===(c=l.secondary)||void 0===c?void 0:c.value)&&(0,$d.jsxs)(kx,{children:[(0,$d.jsxs)(jx,{children:["number"===typeof e.metric.secondary.value&&null!==(d=e.metric.secondary.label)&&void 0!==d&&d.includes("%")?`${e.metric.secondary.value}%`:Yx(e.metric.secondary.value),!(null!==(p=e.metric.secondary.label)&&void 0!==p&&p.includes("%"))&&(0,$d.jsx)(wx,{children:"kr"})]}),(0,$d.jsx)(Sx,{children:null===(m=e.metric)||void 0===m||null===(g=m.secondary)||void 0===g?void 0:g.label})]})]}),(0,$d.jsx)($x,{$visible:b,children:e.context}),e.action&&(0,$d.jsx)(zx,{$visible:b,children:(0,$d.jsxs)(_x,{$done:w,$loading:S,disabled:w||S,onClick:()=>y(e.id,e.action.label),children:[S&&(0,$d.jsx)(Nx,{}),w?"\u2713 Arvo \xe4r p\xe5 det \u2014 vi \xe5terkommer inom 24 timmar":e.action.label]})})]})},e.id)}),(0,$d.jsxs)(Ex,{"data-card-index":String(w-1),ref:e=>{v.current[w-1]=e},children:[(0,$d.jsx)(Ax,{children:(0,$d.jsx)(Zx,{})}),(0,$d.jsx)(Cx,{children:"Er Arvo-briefing \xe4r klar"}),(0,$d.jsx)(Fx,{children:S?"Bra jobbat \u2014 ni har aktiverat Arvo. Vi granskar era avtal och \xe5terkommer med en konkret handlingsplan.":"Era insikter v\xe4ntar p\xe5 er. Ni kan alltid komma tillbaka till denna sida via l\xe4nken i mailet."}),S&&(0,$d.jsx)(Dx,{children:Object.entries(f).map(e=>{let[t,r]=e;return(0,$d.jsxs)(Tx,{children:[(0,$d.jsx)(Px,{children:"\u2713"}),(0,$d.jsxs)(Ox,{children:[(0,$d.jsx)("strong",{children:"approve_switch"===r.type?"Bytesuppdrag":"Bevakningsuppdrag"})," ","aktiverat f\xf6r ",(0,$d.jsx)("strong",{children:r.supplier}),r.estimatedNetSaving>0&&` \xb7 Potentiell besparing: ${Yx(r.estimatedNetSaving)} kr/\xe5r`]})]},t)})}),S&&(0,$d.jsx)(Lx,{children:"Arvo \xe5terkommer inom 24 timmar med n\xe4sta steg."}),(0,$d.jsx)(Rx,{href:"/testa-faktura",children:"Analysera fler fakturor \u2192"})]})]})]})}const tv=jd`
...
`,lv=vd.div`
  ...
  margin-bottom: 56px;
  text-align: left;
  animation: ${rv} 0.75s cubic-bezier(0.34, 1.46, 0.64, 1) both;
  box-shadow:
...
`,gv=vd.h1`
  ...
  line-height: 1.10;
  letter-spacing: -.02em;
  animation: ${tv} 0.8s 0.28s both ease-out;
...
`,xv=vd.p`
  ...
  color: rgba(255,255,255,0.45);
  line-height: 1.55;
  animation: ${tv} 0.8s 0.42s both ease-out;
`,vv=vd.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: 14px;
  animation: ${tv} 0.8s 0.56s both ease-out;
`,bv=vd.a`
  display: inline-flex;
  align-items: center;
...
`,Zv=vd.p`
  ...
  opacity: 0.55;
  font-style: italic;
`,eb=[{context:"Telia h\xf6jer 11% i januari. Ni m\xe4rker det i september \u2014 \xe5tta m\xe5nader senare.",title:"Marknadsintelligens f\xf6re fakturan",body:"Arvo ser vad som h\xe4nder hos j\xe4mf\xf6rbara bolag i n\xe4tverket \u2014 och varnar er innan h\xf6jningen syns p\xe5 er faktura.",quote:'"6 av 14 bolag i er bransch fick Telias prish\xf6jning f\xf6rra m\xe5naden."'},{context:"Tele2-avtalet f\xf6rnyas automatiskt. Ni m\xe4rkte det inte. Nu \xe4r ni l\xe5sta ett \xe5r till.",title:"Kontraktskalender med handlingsplan",body:"Inte bara p\xe5minnelser \u2014 utan exakt vad som ska g\xf6ras, n\xe4r och varf\xf6r. Arvo r\xe4knar bakl\xe4nges fr\xe5n varje f\xf6rnyelsedatum.",quote:'"87 dagar kvar. Aktivera byte senast 15 september."'},{context:"Telia fakturerar 349 kr/SIM. Ert avtal s\xe4ger 299 kr. Ni betalar differensen utan att veta om det.",title:"Faktura mot avtal",body:"Leverant\xf6rer fakturerar fel \u2014 ofta. Arvo kontrollerar automatiskt varje faktura mot k\xe4nt avtalspris och flaggar avvikelser direkt.",quote:'"Telia fakturerar 349 kr/SIM. Ert avtal s\xe4ger 299 kr."'},{context:"Kostnaderna rullar p\xe5. Ingen sammanfattar. Styrelsen fr\xe5gar \u2014 ingen har svaret.",title:"M\xe5natlig CFO-brief",body:"En professionell rapport \u2014 klar f\xf6r styrelserummet \u2014 med vad Arvo hittat, vad som sparats och vad som \xe4r p\xe5 v\xe4g.",quote:'"Tre avtal bevakas. Ett flaggat f\xf6r \xe5tg\xe4rd n\xe4sta vecka."'}];function tb(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:.12;const t=(0,n.useRef)(null),[r,a]=(0,n.useState)(!1);return(0,n.useEffect)(()=>{const r=t.current;if(!r)return;const n=new IntersectionObserver(e=>{let[t]=e;t.isIntersecting&&(a(!0),n.disconnect())},{threshold:e});return n.observe(r),()=>n.disconnect()},[e]),[t,r]}const rb=()=>(0,$d.jsxs)("svg",{width:"14",height:"14",viewBox:"0 0 100 100",fill:"none","aria-hidden":"true",style:{flexShrink:0},children:[(0,$d.jsx)("defs",{children:(0,$d.jsxs)("linearGradient",{id:"intelig",x1:"50",y1:"5",x2:"50",y2:"95",gradientUnits:"userSpaceOnUse",children:[(0,$d.jsx)("stop",{offset:"0%",stopColor:"#4ECDC4"}),(0,$d.jsx)("stop",{offset:"100%",stopColor:"#1DB09A"})]})}),(0,$d.jsx)("path",{d:"M50 5 L12 85 L35 85 L50 55 L65 85 L88 85 Z",fill:"url(#intelig)"})]}),nb=e=>new Intl.NumberFormat("sv-SE",{maximumFractionDigits:0}).format(e);function ab(){var e;const[t,r]=tb(.08),[a,i]=tb(.12),[o]=js(),s=o.get("savings")?Number(o.get("savings")):null,l=null!==(e=o.get("supplier"))&&void 0!==e?e:null,[c,d]=(0,n.useState)(""),[u,p]=(0,n.useState)(""),[h,m]=(0,n.useState)("idle"),[f,g]=(0,n.useState)("");return(0,$d.jsxs)(iv,{children:[(0,$d.jsx)(du,{variant:"public"}),(0,$d.jsx)(ov,{children:(0,$d.jsxs)(sv,{children:[(0,$d.jsxs)(lv,{children:[(0,$d.jsxs)(cv,{children:[(0,$d.jsx)(rb,{}),(0,$d.jsx)(dv,{}),(0,$d.jsx)(uv,{children:"Arvo Intelligence"}),(0,$d.jsx)(pv,{children:"Just nu"})]}),(0,$d.jsx)(hv,{children:"Arvo har detekterat n\xe5got"}),(0,$d.jsxs)(mv,{children:["Telia h\xf6jde priset f\xf6r ",(0,$d.jsx)("strong",{children:"8 av 14 bolag"})," i er bransch f\xf6rra m\xe5naden. Er n\xe4sta faktura tr\xe4ffar om"," ",(0,$d.jsx)("strong",{children:"12 dagar."})]}),(0,$d.jsx)(fv,{as:vs,to:"/testa-faktura",children:"Se vad det inneb\xe4r f\xf6r er \u2192"})]}),(0,$d.jsxs)(gv,{children:["Arvo m\xe4rkte det.",(0,$d.jsx)("br",{}),(0,$d.jsx)("em",{children:"Ni visste inte om det \xe4nnu."})]}),(0,$d.jsx)(xv,{children:"Ni ska inte beh\xf6va h\xe5lla koll. Det \xe4r Arvos jobb."}),(0,$d.jsxs)(vv,{children:[(0,$d.jsx)(bv,{as:"a",href:"#aktivera",children:"Aktivera Arvo Intelligence"}),(0,$d.jsx)(yv,{children:"1 995 kr/m\xe5n \xb7 Ingen bindningstid"})]})]})}),(0,$d.jsxs)(kv,{ref:t,children:[(0,$d.jsxs)(jv,{children:[(0,$d.jsx)(wv,{children:"Arvo Intelligence"}),(0,$d.jsx)(Sv,{style:{marginBottom:0},children:"Det Arvo ser \u2014 som annars f\xf6rsvinner"})]}),(0,$d.jsx)($v,{children:eb.map((e,t)=>(0,$d.jsxs)(zv,{$i:t,$visible:r,children:[(0,$d.jsx)(_v,{children:e.context}),(0,$d.jsx)(Nv,{}),(0,$d.jsx)(Ev,{children:e.title}),(0,$d.jsx)(Av,{children:e.body}),(0,$d.jsx)(Cv,{children:e.quote})]},t))})]}),(0,$d.jsx)(Fv,{ref:a,children:(0,$d.jsxs)(Dv,{children:[(0,$d.jsx)(Tv,{children:"Den enda finansiella partnern som..."}),(0,$d.jsxs)(Pv,{$i:0,$visible:i,children:[(0,$d.jsx)(Ov,{children:"Regel 1"}),(0,$d.jsx)(Lv,{children:"Arvo vaktar er f\xf6r 1 995 kr/m\xe5n."})]}),(0,$d.jsx)(Rv,{}),(0,$d.jsxs)(Pv,{$i:1,$visible:i,children:[(0,$d.jsx)(Ov,{children:"Regel 2"}),(0,$d.jsx)(Lv,{children:"Ni beh\xe5ller 80% av allt vi sparar er."})]})]})}),(0,$d.jsx)(Iv,{id:"aktivera",children:(0,$d.jsxs)(Mv,{children:["sent"!==h&&(0,$d.jsxs)(Bv,{children:["Arvo b\xf6rjar bevaka",(0,$d.jsx)("br",{}),"imorgon bitti."]}),"sent"===h?(0,$d.jsxs)(Gv,{children:[(0,$d.jsx)(Qv,{children:"\u2713"}),(0,$d.jsx)(Jv,{children:"Aktiverat."}),(0,$d.jsxs)(Xv,{children:["Arvo b\xf6rjar bevaka er inom 24\xa0timmar.",(0,$d.jsx)("br",{}),"Vi h\xf6r av oss n\xe4r det finns n\xe5got att agera p\xe5."]}),c&&(0,$d.jsx)(Zv,{children:c})]}):(0,$d.jsxs)($d.Fragment,{children:[null!=s?(0,$d.jsx)(Kv,{children:l?(0,$d.jsxs)($d.Fragment,{children:["Vi identifierade redan ",(0,$d.jsxs)("strong",{children:[nb(s),"\xa0kr/\xe5r"]})," hos ",l,". Den besparingen v\xe4ntar."]}):(0,$d.jsxs)($d.Fragment,{children:["Vi identifierade redan ",(0,$d.jsxs)("strong",{children:[nb(s),"\xa0kr/\xe5r"]})," i besparing \xe5t er. Den v\xe4ntar p\xe5 att aktiveras."]})}):(0,$d.jsx)(Uv,{children:"E-post och bolagsnamn \u2014 klart p\xe5 30 sekunder."}),(0,$d.jsxs)(Hv,{onSubmit:async e=>{e.preventDefault();const t=c.trim();if(t&&"submitting"!==h){m("submitting"),g("");try{var r;const e=await fetch("/api/activate-intelligence",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t,supplier:null!==l&&void 0!==l?l:u.trim()||void 0,netSaving:null!==s&&void 0!==s?s:void 0,source:"intelligence-page"})});if(!e.ok)throw new Error(null!==(r=(await e.json().catch(()=>({}))).error)&&void 0!==r?r:"err");m("sent")}catch{g("N\xe5got gick fel \u2014 f\xf6rs\xf6k igen."),m("error")}}},children:[(0,$d.jsx)(Wv,{type:"email",placeholder:"er@foretag.se",value:c,onChange:e=>d(e.target.value),required:!0,autoComplete:"email"}),(0,$d.jsx)(Wv,{type:"text",placeholder:"Bolagsnamn",value:u,onChange:e=>p(e.target.value),autoComplete:"organization"}),(0,$d.jsx)(qv,{type:"submit",disabled:"submitting"===h,children:"submitting"===h?"\u2026":"Aktivera bevakningen \u2192"}),f&&(0,$d.jsx)(Yv,{children:f})]})]}),(0,$d.jsx)(Vv,{children:"1\xa0995\xa0kr/m\xe5n \xb7 Ingen bindningstid \xb7 Arvo startar bevakningen inom 24h"})]})}),(0,$d.jsx)(xu,{})]})}const ib=jd`
...
`,gb=vd.h1`
  ...
  text-align: center;
  margin: 0 0 16px;
  animation: ${ib} 0.6s 0.08s ease both;
`,xb=vd.p`
  font-size: 15px;
  ...
  margin: 0 0 40px;
  line-height: 1.5;
  animation: ${ib} 0.6s 0.14s ease both;
`,vb=vd.div`
  width: 100%;
  background: rgba(29,176,154,0.10);
  ...
  align-items: center;
  gap: 12px;
  animation: ${ib} 0.6s 0.18s ease both;
`,bb=vd.span`
  font-size: 18px;
  flex-shrink: 0;
  line-height: 1;
...
`,Pb=vd.div`
  ...
  justify-content: center;
  margin-bottom: 20px;
  animation: ${lb} 0.55s cubic-bezier(0.34,1.46,0.64,1) both;
  ...
  svg {
    ...
    stroke-dasharray: 60;
    stroke-dashoffset: 0;
    animation: ${sb} 0.5s 0.2s ease both;
  }
`,Ob=vd.h3`
  font-size: 22px;
  font-weight: 800;
...
`,Mb=vd.div`
  ...
  margin-top: 40px;
  width: 100%;
  animation: ${ib} 0.6s 0.4s ease both;
...
`,Kb=vd.div`
  ...
  flex-direction: column;
  gap: 0;
  animation: ${ib} 0.6s 0.5s ease both;
`,Hb=vd.p`
...
`,Wb=e=>new Intl.NumberFormat("sv-SE",{maximumFractionDigits:0}).format(e);function qb(){return(0,$d.jsx)("svg",{width:"28",height:"28",viewBox:"0 0 28 28",children:(0,$d.jsx)("polyline",{points:"5,14 11,20 23,8"})})}function Yb(){var e;const[t]=js(),r=t.get("savings")?Number(t.get("savings")):null,a=null!==(e=t.get("supplier"))&&void 0!==e?e:null,i=t.get("score")?Number(t.get("score")):null,[o,s]=(0,n.useState)(""),[l,c]=(0,n.useState)("idle"),[d,u]=(0,n.useState)(""),p="/api/auth/gmail-init"+(o?`?email=${encodeURIComponent(o)}`:""),h="/api/auth/outlook-init"+(o?`?email=${encodeURIComponent(o)}`:"");return(0,$d.jsxs)(db,{children:[(0,$d.jsx)(du,{variant:"public"}),(0,$d.jsx)(ub,{children:(0,$d.jsxs)(pb,{children:[(0,$d.jsxs)(hb,{children:[(0,$d.jsx)(mb,{}),(0,$d.jsx)(fb,{children:"Arvo Intelligence"})]}),"sent"!==l&&(0,$d.jsxs)($d.Fragment,{children:[(0,$d.jsxs)(gb,{children:["Arvo b\xf6rjar bevaka er",(0,$d.jsx)("br",{}),"imorgon bitti."]}),(0,$d.jsx)(xb,{children:"1\xa0995\xa0kr/m\xe5n \xb7 Ingen bindningstid"})]}),null!=r&&"sent"!==l&&(0,$d.jsxs)(vb,{children:[(0,$d.jsx)(bb,{children:"\u2192"}),(0,$d.jsx)(yb,{children:a?(0,$d.jsxs)($d.Fragment,{children:["Vi identifierade redan ",(0,$d.jsxs)("strong",{children:[Wb(r),"\xa0kr/\xe5r"]})," hos ",a,". Den besparingen v\xe4ntar."]}):(0,$d.jsxs)($d.Fragment,{children:["Vi identifierade redan ",(0,$d.jsxs)("strong",{children:[Wb(r),"\xa0kr/\xe5r"]})," i besparing \xe5t er. Den v\xe4ntar p\xe5 att aktiveras."]})})]}),(0,$d.jsx)(kb,{children:"sent"===l?(0,$d.jsxs)(Tb,{children:[(0,$d.jsx)(Pb,{children:(0,$d.jsx)(qb,{})}),(0,$d.jsx)(Ob,{children:"Aktiverat."}),(0,$d.jsxs)(Lb,{children:["Arvo b\xf6rjar bevaka er inom 24\xa0timmar.",(0,$d.jsx)("br",{}),"Ni h\xf6r av oss n\xe4r det finns n\xe5got att agera p\xe5."]}),(0,$d.jsx)(Rb,{children:o}),(0,$d.jsx)(Ib,{children:"Koppla er inkorg \u2014 Arvo hittar allt"}),(0,$d.jsxs)(Sb,{href:p,style:{marginBottom:9},children:[(0,$d.jsx)($b,{$provider:"google",children:"G"}),(0,$d.jsx)(zb,{children:"Koppla Gmail"}),(0,$d.jsx)(_b,{children:"\u2192"})]}),(0,$d.jsxs)(Sb,{href:h,children:[(0,$d.jsx)($b,{$provider:"outlook",children:"\u25a0"}),(0,$d.jsx)(zb,{children:"Koppla Outlook"}),(0,$d.jsx)(_b,{children:"\u2192"})]}),(0,$d.jsx)(Db,{children:"Arvo l\xe4ser bara faktura-mail \u2014 aldrig personlig korrespondens."})]}):(0,$d.jsxs)($d.Fragment,{children:[(0,$d.jsx)(jb,{children:"Koppla er inkorg \u2014 en g\xe5ng."}),(0,$d.jsx)(wb,{children:"Arvo s\xf6ker igenom era leverant\xf6rsfakturor och kontaktar er n\xe4r n\xe5got h\xe4nt."}),(0,$d.jsxs)(Sb,{href:p,children:[(0,$d.jsx)($b,{$provider:"google",children:"G"}),(0,$d.jsx)(zb,{children:"Koppla Gmail"}),(0,$d.jsx)(_b,{children:"\u2192"})]}),(0,$d.jsxs)(Sb,{href:h,children:[(0,$d.jsx)($b,{$provider:"outlook",children:"\u25a0"}),(0,$d.jsx)(zb,{children:"Koppla Outlook"}),(0,$d.jsx)(_b,{children:"\u2192"})]}),(0,$d.jsx)(Nb,{children:(0,$d.jsx)("span",{children:"eller b\xf6rja med e-post"})}),(0,$d.jsxs)(Eb,{onSubmit:async e=>{e.preventDefault();const t=o.trim();if(t&&"submitting"!==l){c("submitting"),u("");try{const e=await fetch("/api/activate-intelligence",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t,supplier:null!==a&&void 0!==a?a:void 0,netSaving:null!==r&&void 0!==r?r:void 0,diagScore:null!==i&&void 0!==i?i:void 0,source:"intelligence-page"})});if(!e.ok){var n;const t=await e.json().catch(()=>({}));throw new Error(null!==(n=t.error)&&void 0!==n?n:"server_error")}c("sent")}catch(s){u("N\xe5got gick fel \u2014 f\xf6rs\xf6k igen."),c("error")}}},children:[(0,$d.jsx)(Ab,{type:"email",placeholder:"er@foretag.se",value:o,onChange:e=>s(e.target.value),required:!0,autoComplete:"email"}),(0,$d.jsx)(Cb,{type:"submit",disabled:"submitting"===l,children:"submitting"===l?"\u2026":"Aktivera \u2192"})]}),d&&(0,$d.jsx)(Fb,{children:d}),(0,$d.jsx)(Db,{children:"1\xa0995\xa0kr/m\xe5n \xb7 Ingen bindningstid \xb7 Arvo l\xe4ser bara faktura-mail, aldrig personlig korrespondens."})]})}),(0,$d.jsxs)(Mb,{children:[(0,$d.jsxs)(Bb,{children:[(0,$d.jsx)(Ub,{children:"24h"}),(0,$d.jsx)(Vb,{children:"Arvo aktiverar er bevakning"})]}),(0,$d.jsxs)(Bb,{children:[(0,$d.jsx)(Ub,{children:"Dag 7"}),(0,$d.jsx)(Vb,{children:"Ni f\xe5r er f\xf6rsta analys"})]}),(0,$d.jsxs)(Bb,{children:[(0,$d.jsx)(Ub,{children:"L\xf6pande"}),(0,$d.jsx)(Vb,{children:"Arvo kontaktar er om n\xe5got h\xe4nt"})]})]})]})}),(0,$d.jsxs)(Kb,{children:[(0,$d.jsxs)(Hb,{children:[(0,$d.jsx)("strong",{children:"Regel 1:"})," Arvo vaktar er f\xf6r 1\xa0995\xa0kr/m\xe5n."]}),(0,$d.jsxs)(Hb,{children:[(0,$d.jsx)("strong",{children:"Regel 2:"})," Ni beh\xe5ller 80% av allt vi sparar er."]})]}),(0,$d.jsx)(xu,{})]})}const Gb=jd`
  from { opacity: 0; transform: translateY(28px); }
  to   { opacity: 1; transform: translateY(0); }
`,Qb=jd`
  from { opacity: 0; }
...
`,Xb=function(){return fd`
  opacity: 0;
  animation: ${Gb} 0.75s ${arguments.length>0&&void 0!==arguments[0]?arguments[0]:0}s cubic-bezier(0.16, 1, 0.3, 1) forwards;
`},Zb=wd.font.mono,ey=vd.div`
  min-height: 100vh;
  background: ${wd.dossier.bg};
...
`,py=vd.div`
  ...
  ${e=>{let{$i:t}=e;return Xb(.08+.06*(null!==t&&void 0!==t?t:0))}}
`,hy=vd.div`
  width: 36px;
  height: 1px;
...
`,Xy=vd.div`
  ...
  justify-content: center;
  gap: 16px;
`,Zy=vd.div`display: flex; gap: 8px;`,ek=vd.div`
  width: 8px; height: 8px;
  border-radius: 50%;
  background: ${wd.dossier.teal};
  animation: ${Jb} 1.2s ${e=>{let{$i:t}=e;return.2*(null!==t&&void 0!==t?t:0)}}s ease-in-out infinite;
`,tk=vd.div`
  font-size: 13px;
  color: rgba(255,255,255,0.32);
`,rk=vd.div`
...
`,ok=vd.a`
  ...
  padding-bottom: 2px;
`,sk=(e,t)=>500*Math.round((e+t)/2/500);function lk(e){if(!e)return"";return new Date(e).toLocaleDateString("sv-SE",{day:"numeric",month:"long",year:"numeric"})}function ck(){var e,t,r,a;const{token:i}=ho(),[o,s]=(0,n.useState)("loading"),[l,c]=(0,n.useState)(null),[d,u]=(0,n.useState)(!1);(0,n.useEffect)(()=>{i?fetch(`/api/prospect?token=${encodeURIComponent(i)}`).then(e=>e.json()).then(e=>{e.ok?(c(e.prospect),s("ready")):s("error")}).catch(()=>s("error")):s("error")},[i]);const p=e=>{d||(u(!0),fetch(`/api/prospect?token=${encodeURIComponent(i)}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({action:e})}).catch(()=>{}))};if("loading"===o)return(0,$d.jsxs)(Xy,{children:[(0,$d.jsx)(Zy,{children:[0,1,2].map(e=>(0,$d.jsx)(ek,{$i:e},e))}),(0,$d.jsx)(tk,{children:"H\xe4mtar er analys\u2026"})]});if("error"===o)return(0,$d.jsxs)(rk,{children:[(0,$d.jsx)(nk,{children:"\ud83d\udd12"}),(0,$d.jsx)(ak,{children:"Analysen hittades inte"}),(0,$d.jsx)(ik,{children:"L\xe4nken kan ha g\xe5tt ut eller \xe4r ogiltig. Analysera er faktura direkt \u2014 det tar 2 minuter."}),(0,$d.jsx)(ok,{href:"/testa-faktura",children:"Analysera en faktura \u2192"})]});const{companyName:h,industry:m,employees:f,estimates:g,generatedAt:x}=l,v=null!==(e=null===g||void 0===g?void 0:g.categories)&&void 0!==e?e:[],b=(null===g||void 0===g?void 0:g.hasEstimates)&&((null===g||void 0===g?void 0:g.totalSavingLow)>0||v.length>0),y=null===g||void 0===g?void 0:g.mxPlatform,k=null===g||void 0===g?void 0:g.mxSince,j=null===g||void 0===g?void 0:g.domainRegistered,w=null===g||void 0===g?void 0:g.foundedYear,S=null!==(t=null===g||void 0===g?void 0:g.findings)&&void 0!==t?t:[],$=(z=k)?Math.round((Date.now()-new Date(z).getTime())/2630016e3):0;var z;const _=null!==(r=Uh[y])&&void 0!==r?r:y,N=S.length>0,E=[];S.forEach(e=>E.push({text:e,key:e})),!N&&k?E.push({text:`${_}-konfiguration of\xf6r\xe4ndrad sedan ${Bh(k)} \u2014 ${$} m\xe5nader`,key:"mxSince"}):!N&&y&&E.push({text:`${_} identifierat f\xf6r er dom\xe4n \xb7 ${f} licenser`,key:"mxPlatform"});const A=E.length>0,C=N?"IDENTIFIERAT FYND":"INFRASTRUKTURANALYS",F=N&&(y||j||k),D=null!==(a=null===g||void 0===g?void 0:g.totalSavingCentral)&&void 0!==a?a:b?sk(g.totalSavingLow,g.totalSavingHigh):null,T=v.map(e=>`${e.estimatedSims} ${"m365"===e.category?"Microsoft 365-licenser":"mobilabonnemang"}`).join(" + ");return(0,$d.jsxs)(ey,{children:[(0,$d.jsx)(ty,{}),(0,$d.jsx)(ry,{children:(0,$d.jsxs)(ny,{children:[(0,$d.jsx)(ay,{children:"ARVO"}),(0,$d.jsx)(iy,{children:"Konfidentiell analys"}),(0,$d.jsx)(oy,{children:h}),(0,$d.jsxs)(sy,{children:[m&&(0,$d.jsx)("span",{children:m}),m&&f&&(0,$d.jsx)(ly,{children:"\xb7"}),f&&(0,$d.jsxs)("span",{children:[f," anst\xe4llda"]}),w&&(0,$d.jsxs)($d.Fragment,{children:[(0,$d.jsx)(ly,{children:"\xb7"}),(0,$d.jsxs)("span",{children:["Grundat ",w]})]})]}),(0,$d.jsx)(cy,{children:lk(x)})]})}),A&&(0,$d.jsxs)(dy,{children:[(0,$d.jsx)(uy,{children:C}),E.map((e,t)=>(0,$d.jsxs)(py,{$i:t,children:[t>0&&(0,$d.jsx)(hy,{}),(0,$d.jsx)(my,{children:e.text})]},e.key)),F&&(0,$d.jsxs)(fy,{children:[y&&(0,$d.jsxs)(gy,{children:[(0,$d.jsx)(xy,{children:"E-postplattform"}),(0,$d.jsx)(vy,{children:_})]}),k&&(0,$d.jsxs)(gy,{children:[(0,$d.jsx)(xy,{children:"Konfiguration sedan"}),(0,$d.jsxs)(vy,{$highlight:!0,children:[Bh(k)," \u2014 ",$," m\xe5n"]})]}),j&&(0,$d.jsxs)(gy,{children:[(0,$d.jsx)(xy,{children:"Dom\xe4n registrerad"}),(0,$d.jsx)(vy,{children:Bh(j)})]})]})]}),b&&(0,$d.jsxs)(by,{children:[(0,$d.jsx)(uy,{children:"Sannolik kostnadspremie"}),(0,$d.jsxs)(yy,{children:[(0,$d.jsx)(ky,{children:"\u2248"}),Ih(D)," ",(0,$d.jsx)("span",{style:{fontSize:"0.42em",letterSpacing:"0em",fontWeight:700},children:"kr/\xe5r"})]}),(0,$d.jsxs)(jy,{children:[(0,$d.jsx)(wy,{children:(0,$d.jsx)(Sy,{style:{left:`${Math.min(88,Math.max(12,g.totalSavingHigh>g.totalSavingLow?(D-g.totalSavingLow)/(g.totalSavingHigh-g.totalSavingLow)*100:50))}%`}})}),(0,$d.jsxs)($y,{children:[(0,$d.jsx)("span",{children:Ih(g.totalSavingLow)}),(0,$d.jsxs)("span",{children:[Ih(g.totalSavingHigh)," kr/\xe5r"]})]})]}),T&&(0,$d.jsxs)(zy,{children:["Baserat p\xe5 ",T," mot verifierade listpriser"]}),(0,$d.jsx)(_y,{children:"Er faktiska avtalskostnad ser vi inte f\xf6rr\xe4n ni delar er faktura"})]}),v.length>0&&(0,$d.jsxs)(Ny,{children:[(0,$d.jsx)(Ey,{children:"Kostnadsanalys per kategori"}),v.map((e,t)=>{var r;const n="m365"===e.category?"licens":"abonnemang",a=null!==(r=e.savingCentral)&&void 0!==r?r:sk(e.savingLow,e.savingHigh);return(0,$d.jsxs)(Ay,{children:[(0,$d.jsx)(Cy,{children:e.label}),(0,$d.jsxs)(Fy,{children:[(0,$d.jsx)(Dy,{children:"m365"===e.category?"Uppskattade licenser":"Uppskattade abonnemang"}),(0,$d.jsxs)(Ty,{children:[e.estimatedSims," st"]})]}),(0,$d.jsxs)(Fy,{children:[(0,$d.jsx)(Dy,{children:"Typisk marknadskostnad"}),(0,$d.jsxs)(Ty,{children:[Ih(e.typicalLow),"\u2013",Ih(e.typicalHigh)," kr/\xe5r",(0,$d.jsx)(Py,{children:"live"===e.source?`median av verifierade fakturor: ${e.pricePerSim.typical} kr/m\xe5n per ${n} \xb1 15 %`:`ordinarie listpris ${e.pricePerSim.typical} kr/m\xe5n per ${n} \xb1 15 %`})]})]}),(0,$d.jsxs)(Fy,{children:[(0,$d.jsx)(Dy,{children:"Arvo-pris, verifierat listpris"}),(0,$d.jsxs)(Ty,{$highlight:!0,children:[Ih(e.arvoAnnual)," kr/\xe5r",(0,$d.jsxs)(Py,{children:[e.pricePerSim.arvo," kr/m\xe5n per ",n]})]})]}),(0,$d.jsx)(My,{children:e.sourceNote}),(0,$d.jsxs)(Oy,{children:[(0,$d.jsx)(Ly,{children:"Sannolik premie"}),(0,$d.jsxs)("div",{children:[(0,$d.jsxs)(Ry,{children:["\u2248 ",Ih(a)," kr/\xe5r"]}),(0,$d.jsxs)(Iy,{children:["intervall ",Ih(e.savingLow),"\u2013",Ih(e.savingHigh)]})]})]})]},t)})]}),(0,$d.jsxs)(By,{children:[(0,$d.jsxs)(Uy,{children:["Arvo har analyserat den publika DNS-konfigurationen f\xf6r ",h,"s dom\xe4n. Ingen data har inh\xe4mtats fr\xe5n er eller era leverant\xf6rer utan ert tillst\xe5nd."]}),(0,$d.jsxs)(Vy,{children:[(0,$d.jsx)(Ky,{href:"/testa-faktura",onClick:()=>p("upload"),children:"Se er exakta premie"}),(0,$d.jsx)(Hy,{children:"Ladda upp en faktura \xb7 Kostnadsfritt \xb7 2 minuter \xb7 Ingen registrering"})]}),(0,$d.jsx)(Wy,{}),(0,$d.jsx)(qy,{href:"/intelligence#aktivera",onClick:()=>p("activate"),children:"Eller l\xe5t Arvo bevaka er l\xf6pande \u2014 Arvo Intelligence, 1\xa0995 kr/m\xe5n \u2192"}),(0,$d.jsx)(Yy,{children:"Ingen bindningstid \xb7 Bevakningen b\xf6rjar inom 24 timmar"})]}),(0,$d.jsxs)(Gy,{children:[(0,$d.jsx)(Qy,{children:"arvoflow.se"}),(0,$d.jsx)(Jy,{children:"Arvo Intelligence"})]})]})}"scrollRestoration"in window.history&&(window.history.scrollRestoration="manual");const dk=()=>{const{pathname:e}=lo();return(0,n.useEffect)(()=>{window.scrollTo(0,0)},[e]),null},uk=()=>(0,$d.jsxs)(dd,{theme:wd,children:[(0,$d.jsx)(Sd,{}),(0,$d.jsx)(gs,{basename:"/flow",children:(0,$d.jsxs)(Ed,{children:[(0,$d.jsx)(dk,{}),(0,$d.jsxs)(Oo,{children:[(0,$d.jsx)(To,{path:"/",element:(0,$d.jsx)(Ap,{})}),(0,$d.jsx)(To,{path:"/connect",element:(0,$d.jsx)(nh,{})}),(0,$d.jsx)(To,{path:"/bias",element:(0,$d.jsx)(bh,{})}),(0,$d.jsx)(To,{path:"/villkor",element:(0,$d.jsx)(Ph,{})}),(0,$d.jsx)(To,{path:"/integritet",element:(0,$d.jsx)(Oh,{})}),(0,$d.jsx)(To,{path:"/cookies",element:(0,$d.jsx)(Lh,{})}),(0,$d.jsx)(To,{path:"/testa-faktura",element:(0,$d.jsx)(of,{})}),(0,$d.jsx)(To,{path:"/portfolio",element:(0,$d.jsx)(pg,{})}),(0,$d.jsx)(To,{path:"/admin",element:(0,$d.jsx)(Pg,{})}),(0,$d.jsx)(To,{path:"/utfall",element:(0,$d.jsx)(qg,{})}),(0,$d.jsx)(To,{path:"/briefing/:token",element:(0,$d.jsx)(ev,{})}),(0,$d.jsx)(To,{path:"/intelligence",element:(0,$d.jsx)(ab,{})}),(0,$d.jsx)(To,{path:"/aktivera",element:(0,$d.jsx)(Yb,{})}),(0,$d.jsx)(To,{path:"/prospect/:token",element:(0,$d.jsx)(ck,{})}),(0,$d.jsx)(To,{path:"/kontoret",element:(0,$d.jsx)(Do,{to:"/portfolio",replace:!0})}),(0,$d.jsx)(To,{path:"*",element:(0,$d.jsx)(Do,{to:"/",replace:!0})})]})]})})]});!function(){var e;const t={NODE_ENV:"production",PUBLIC_URL:"/flow",WDS_SOCKET_HOST:void 0,WDS_SOCKET_PATH:void 0,WDS_SOCKET_PORT:void 0,FAST_REFRESH:!0}.REACT_APP_SENTRY_DSN;t&&ri({dsn:t,environment:null!==(e="production")?e:"production",release:{NODE_ENV:"production",PUBLIC_URL:"/flow",WDS_SOCKET_HOST:void 0,WDS_SOCKET_PATH:void 0,WDS_SOCKET_PORT:void 0,FAST_REFRESH:!0}.REACT_APP_VERSION,tracesSampleRate:.1,beforeSend(e){var t,r,n,a;const i=null!==(t=null===(r=e.exception)||void 0===r||null===(n=r.values)||void 0===n||null===(a=n[0])||void 0===a?void 0:a.value)&&void 0!==t?t:"";return i.includes("Network request failed")||i.includes("Load failed")?null:e}})}();(0,i.createRoot)(document.getElementById("root")).render((0,$d.jsx)(uk,{}))})();
//# sourceMappingURL=main.3ffdfffb.js.map