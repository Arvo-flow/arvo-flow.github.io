...
`,fj=vd.p`
  ...
  line-height: 1.75;
  margin: 0 0 32px;
  animation: ${rj} 0.45s 0.08s ease both;
`,mj=vd.div`
  position: relative;
  ...
  margin-bottom: 24px;
  animation: ${rj} 0.45s 0.10s ease both;
  overflow: hidden;
...
`,jj=vd.div`
  ...
  padding: 24px;
  margin-bottom: 16px;
  animation: ${rj} 0.45s 0.18s ease both;
...
`,zj=vd.span`
  font-size: 14px;
  font-weight: 600;
  color: ${e=>{let{$highlight:t}=e;return t?"#4ECDC4":"rgba(255,255,255,0.88)"}};
  white-space: nowrap;
`,Ej=vd.div`
  margin-top: 18px;
...
`,Fj=vd.div`
  ...
  border-radius: 4px;
  margin-bottom: 32px;
  animation: ${rj} 0.45s 0.28s ease both;
`,Tj=vd.div`
  display: flex;
  flex-direction: column;
  gap: 12px;
  animation: ${rj} 0.45s 0.32s ease both;
`,Pj=vd.a`
  display: block;
...
`,Rj=vd.footer`
  ...
  text-align: center;
  animation: ${rj} 0.45s 0.38s ease both;
`,Oj=vd.div`
  font-size: 12px;
...
`,qj=vd.a`
  ...
  font-size: 14px;
  font-weight: 600;
`,Yj=()=>(0,$d.jsxs)("svg",{width:"20",height:"20",viewBox:"0 0 100 100",fill:"none","aria-hidden":"true",style:{flexShrink:0},children:[(0,$d.jsx)("defs",{children:(0,$d.jsxs)("linearGradient",{id:"prospGrad",x1:"50",y1:"5",x2:"50",y2:"95",gradientUnits:"userSpaceOnUse",children:[(0,$d.jsx)("stop",{offset:"0%",stopColor:"#4ECDC4"}),(0,$d.jsx)("stop",{offset:"100%",stopColor:"#1DB09A"})]})}),(0,$d.jsx)("path",{d:"M50 5 L12 85 L35 85 L50 55 L65 85 L88 85 Z",fill:"url(#prospGrad)"})]}),Gj=e=>null!=e?new Intl.NumberFormat("sv-SE",{maximumFractionDigits:0}).format(e):"\u2013",Qj={microsoft365:"Microsoft 365",google:"Google Workspace",zoho:"Zoho Mail",other:"Anpassad e-postl\xf6sning"},Jj=["januari","februari","mars","april","maj","juni","juli","augusti","september","oktober","november","december"];function Xj(e){if(!e)return null;const[t,r]=e.split("-");return`${Jj[parseInt(r)-1]} ${t}`}function Zj(e){if(!e)return"";return new Date(e).toLocaleDateString("sv-SE",{day:"numeric",month:"long",year:"numeric"})}function ew(){var e,t,r,a;const{token:i}=ho(),[o,l]=(0,n.useState)("loading"),[s,c]=(0,n.useState)(null),[d,u]=(0,n.useState)(!1);(0,n.useEffect)(()=>{i?fetch(`/api/prospect?token=${encodeURIComponent(i)}`).then(e=>e.json()).then(e=>{e.ok?(c(e.prospect),l("ready")):l("error")}).catch(()=>l("error")):l("error")},[i]);const p=e=>{d||(u(!0),fetch(`/api/prospect?token=${encodeURIComponent(i)}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({action:e})}).catch(()=>{}))};if("loading"===o)return(0,$d.jsxs)(Ij,{children:[(0,$d.jsx)(Mj,{children:[0,1,2].map(e=>(0,$d.jsx)(Bj,{$i:e},e))}),(0,$d.jsx)(Vj,{children:"H\xe4mtar er kostnadsbed\xf6mning\u2026"})]});if("error"===o)return(0,$d.jsxs)(Uj,{children:[(0,$d.jsx)(Kj,{children:"\ud83d\udd12"}),(0,$d.jsx)(Hj,{children:"Bed\xf6mningen hittades inte"}),(0,$d.jsx)(Wj,{children:"L\xe4nken kan ha g\xe5tt ut eller \xe4r ogiltig. Analysera er faktura direkt \u2014 det tar 2 minuter."}),(0,$d.jsx)(qj,{href:"/testa-faktura",children:"Analysera en faktura \u2192"})]});const{companyName:h,industry:f,sizeBucket:m,employees:g,estimates:x,generatedAt:v}=s,b=null!==(e=null===x||void 0===x?void 0:x.categories)&&void 0!==e?e:[],y=(null===x||void 0===x?void 0:x.hasEstimates)&&b.length>0,k=null===x||void 0===x?void 0:x.mxPlatform,j=null===x||void 0===x?void 0:x.mxSince,w=null===x||void 0===x?void 0:x.domainRegistered,S=null===x||void 0===x?void 0:x.foundedYear,$=null!==(t=null===x||void 0===x?void 0:x.findings)&&void 0!==t?t:[],z=$.length>0,E=k&&(j||S||w),_=z||E,N=(A=j)?Math.round((Date.now()-new Date(A).getTime())/2630016e3):0;var A;return(0,$d.jsxs)(aj,{children:[(0,$d.jsxs)(ij,{children:[(0,$d.jsx)(Yj,{}),(0,$d.jsx)(oj,{children:"Arvo Intelligence"}),(0,$d.jsx)(lj,{children:Zj(v)})]}),(0,$d.jsxs)(sj,{children:[(0,$d.jsxs)(cj,{children:[(0,$d.jsx)(dj,{children:"Konfidentiell kostnadsbed\xf6mning"}),(0,$d.jsx)(uj,{children:h}),(0,$d.jsxs)(pj,{children:[(0,$d.jsx)("span",{children:f}),(0,$d.jsx)(hj,{children:"\xb7"}),(0,$d.jsxs)("span",{children:[g," anst\xe4llda"]}),S&&(0,$d.jsxs)($d.Fragment,{children:[(0,$d.jsx)(hj,{children:"\xb7"}),(0,$d.jsxs)("span",{children:["Grundat ",S]})]})]})]}),(0,$d.jsx)(fj,{children:z?(0,$d.jsxs)($d.Fragment,{children:["Arvo har analyserat er infrastruktur och identifierat konkreta signaler p\xe5",y?(0,$d.jsxs)($d.Fragment,{children:[" en potentiell besparing p\xe5"," ",(0,$d.jsxs)("strong",{style:{color:"#ffffff"},children:[Gj(x.totalSavingLow),"\u2013",Gj(x.totalSavingHigh),"\xa0kr/\xe5r"]}),"."]}):(0,$d.jsx)($d.Fragment,{children:" icke-omf\xf6rhandlade leverant\xf6rsavtal."})," ","Ladda upp er faktura f\xf6r att f\xe5 den exakta siffran \u2014 det \xe4r kostnadsfritt."]}):j?(0,$d.jsxs)($d.Fragment,{children:["Er ",null!==(r=Qj[k])&&void 0!==r?r:k,"-konfiguration \xe4r of\xf6r\xe4ndrad sedan"," ",(0,$d.jsx)("strong",{style:{color:"#ffffff"},children:Xj(j)})," ","\u2014 ",N," m\xe5nader. Ladda upp er faktura f\xf6r att se den exakta besparingen det inneb\xe4r."]}):(0,$d.jsxs)($d.Fragment,{children:["Arvo har analyserat kostnadsprofilen f\xf6r bolag i er bransch med ",g,"\xa0anst\xe4llda.",y?(0,$d.jsxs)($d.Fragment,{children:[" ","Analysen identifierar en potentiell besparing p\xe5"," ",(0,$d.jsxs)("strong",{style:{color:"#ffffff"},children:[Gj(x.totalSavingLow),"\u2013",Gj(x.totalSavingHigh),"\xa0kr/\xe5r"]})," ","\u2014 baserat p\xe5 verifierade marknadspriser."]}):null," ","Ladda upp er faktura f\xf6r att se vad ni faktiskt betalar."]})}),_&&(0,$d.jsxs)(mj,{children:[(0,$d.jsx)(gj,{children:"Arvo:s underlag"}),z&&(0,$d.jsx)(xj,{children:$.map((e,t)=>(0,$d.jsxs)(vj,{children:[(0,$d.jsx)(bj,{children:"\u2605"}),(0,$d.jsx)(yj,{children:e})]},t))}),E&&(0,$d.jsxs)($d.Fragment,{children:[z&&(0,$d.jsx)(kj,{}),k&&(0,$d.jsxs)(Sj,{children:[(0,$d.jsx)($j,{children:"E-postplattform"}),(0,$d.jsx)(zj,{children:null!==(a=Qj[k])&&void 0!==a?a:k})]}),j&&(0,$d.jsxs)(Sj,{children:[(0,$d.jsx)($j,{children:"Konfiguration of\xf6r\xe4ndrad sedan"}),(0,$d.jsxs)(zj,{$highlight:!0,children:[Xj(j)," \u2014 ",N," m\xe5nader"]})]}),w&&(0,$d.jsxs)(Sj,{children:[(0,$d.jsx)($j,{children:"Dom\xe4n registrerad"}),(0,$d.jsx)(zj,{children:Xj(w)})]}),S&&!j&&(0,$d.jsxs)(Sj,{style:{marginBottom:0},children:[(0,$d.jsx)($j,{children:"Grundat"}),(0,$d.jsx)(zj,{children:S})]})]})]}),b.map((e,t)=>(0,$d.jsxs)(jj,{children:[(0,$d.jsx)(wj,{children:e.label}),(0,$d.jsxs)(Sj,{children:[(0,$d.jsx)($j,{children:"Uppskattade abonnemang"}),(0,$d.jsxs)(zj,{children:[e.estimatedSims," st"]})]}),(0,$d.jsxs)(Sj,{children:[(0,$d.jsx)($j,{children:"Typisk marknadskostnad"}),(0,$d.jsxs)(zj,{children:[Gj(e.typicalLow),"\u2013",Gj(e.typicalHigh)," kr/\xe5r"]})]}),(0,$d.jsxs)(Sj,{children:[(0,$d.jsx)($j,{children:"Arvo-priset (verifierat listpris)"}),(0,$d.jsxs)(zj,{$highlight:!0,children:[Gj(e.arvoAnnual)," kr/\xe5r"]})]}),(0,$d.jsxs)(Sj,{style:{marginBottom:0},children:[(0,$d.jsx)($j,{children:"Pris per abonnemang"}),(0,$d.jsxs)(zj,{children:[e.pricePerSim.arvo," kr/m\xe5n"," ",(0,$d.jsxs)("span",{style:{color:"rgba(255,255,255,0.26)",fontWeight:400,fontSize:12},children:["(typiskt ",e.pricePerSim.typical," kr/m\xe5n)"]})]})]}),(0,$d.jsxs)(Ej,{children:[(0,$d.jsx)(_j,{children:"Potentiell besparing"}),(0,$d.jsxs)(Nj,{children:["upp till ",Gj(e.savingHigh)," kr/\xe5r"]})]}),(0,$d.jsx)(Aj,{children:e.sourceNote})]},t)),(0,$d.jsx)(Cj,{}),(0,$d.jsx)(Fj,{children:"Dessa siffror \xe4r uppskattningar baserade p\xe5 er infrastruktur, branschdata och verifierade listpriser. Arvo k\xe4nner inte till ert faktiska avtalspris \u2014 det ser vi n\xe4r ni laddar upp er faktura. Exakt analys tar 2 minuter och \xe4r helt kostnadsfri."}),(0,$d.jsxs)(Tj,{children:[(0,$d.jsx)(Pj,{href:"/testa-faktura",onClick:()=>p("upload"),children:"Ladda upp er faktura \u2014 se exakt vad ni betalar \u2192"}),(0,$d.jsx)(Dj,{children:"Kostnadsfritt \xb7 Tar 2 minuter \xb7 Ingen registrering kr\xe4vs"}),(0,$d.jsx)(Lj,{href:"/intelligence#aktivera",onClick:()=>p("activate"),children:"Aktivera Arvo Intelligence direkt \u2014 1 995 kr/m\xe5n"})]})]}),(0,$d.jsx)(Rj,{children:(0,$d.jsxs)(Oj,{children:["Arvo Intelligence \xb7 1\xa0995 kr/m\xe5n \xb7 Ingen bindningstid",(0,$d.jsx)("br",{}),"Arvo b\xf6rjar bevaka er inom 24 timmar fr\xe5n aktivering"]})})]})}"scrollRestoration"in window.history&&(window.history.scrollRestoration="manual");const tw=()=>{const{pathname:e}=so();return(0,n.useEffect)(()=>{window.scrollTo(0,0)},[e]),null},rw=()=>(0,$d.jsxs)(dd,{theme:wd,children:[(0,$d.jsx)(Sd,{}),(0,$d.jsx)(gl,{basename:"/flow",children:(0,$d.jsxs)(Nd,{children:[(0,$d.jsx)(tw,{}),(0,$d.jsxs)(Lo,{children:[(0,$d.jsx)(Po,{path:"/",element:(0,$d.jsx)(Kp,{})}),(0,$d.jsx)(Po,{path:"/connect",element:(0,$d.jsx)(xh,{})}),(0,$d.jsx)(Po,{path:"/scanning",element:(0,$d.jsx)(Dh,{})}),(0,$d.jsx)(Po,{path:"/insights",element:(0,$d.jsx)(bf,{})}),(0,$d.jsx)(Po,{path:"/opportunity/:id",element:(0,$d.jsx)(Yf,{})}),(0,$d.jsx)(Po,{path:"/bias",element:(0,$d.jsx)(dm,{})}),(0,$d.jsx)(Po,{path:"/villkor",element:(0,$d.jsx)(zm,{})}),(0,$d.jsx)(Po,{path:"/integritet",element:(0,$d.jsx)(Em,{})}),(0,$d.jsx)(Po,{path:"/cookies",element:(0,$d.jsx)(_m,{})}),(0,$d.jsx)(Po,{path:"/testa-faktura",element:(0,$d.jsx)(Ig,{})}),(0,$d.jsx)(Po,{path:"/portfolio",element:(0,$d.jsx)(Hx,{})}),(0,$d.jsx)(Po,{path:"/admin",element:(0,$d.jsx)(fv,{})}),(0,$d.jsx)(Po,{path:"/utfall",element:(0,$d.jsx)(zv,{})}),(0,$d.jsx)(Po,{path:"/arvo-score",element:(0,$d.jsx)(eb,{})}),(0,$d.jsx)(Po,{path:"/briefing/:token",element:(0,$d.jsx)(ly,{})}),(0,$d.jsx)(Po,{path:"/intelligence",element:(0,$d.jsx)(uk,{})}),(0,$d.jsx)(Po,{path:"/aktivera",element:(0,$d.jsx)(tj,{})}),(0,$d.jsx)(Po,{path:"/prospect/:token",element:(0,$d.jsx)(ew,{})}),(0,$d.jsx)(Po,{path:"*",element:(0,$d.jsx)(To,{to:"/",replace:!0})})]})]})})]});!function(){var e;const t={NODE_ENV:"production",PUBLIC_URL:"/flow",WDS_SOCKET_HOST:void 0,WDS_SOCKET_PATH:void 0,WDS_SOCKET_PORT:void 0,FAST_REFRESH:!0}.REACT_APP_SENTRY_DSN;t&&ri({dsn:t,environment:null!==(e="production")?e:"production",release:{NODE_ENV:"production",PUBLIC_URL:"/flow",WDS_SOCKET_HOST:void 0,WDS_SOCKET_PATH:void 0,WDS_SOCKET_PORT:void 0,FAST_REFRESH:!0}.REACT_APP_VERSION,tracesSampleRate:.1,beforeSend(e){var t,r,n,a;const i=null!==(t=null===(r=e.exception)||void 0===r||null===(n=r.values)||void 0===n||null===(a=n[0])||void 0===a?void 0:a.value)&&void 0!==t?t:"";return i.includes("Network request failed")||i.includes("Load failed")?null:e}})}();(0,i.createRoot)(document.getElementById("root")).render((0,$d.jsx)(rw,{}))})();
//# sourceMappingURL=main.1c62af85.js.map