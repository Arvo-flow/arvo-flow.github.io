/*! For license information please see main.e2b5ba43.js.LICENSE.txt */
...
`;function ff(e){let{email:t,onLogout:r}=e;const[a,i]=(0,n.useState)(""),[o,s]=(0,n.useState)(!1),[l,c]=(0,n.useState)(!1);if(t)return(0,$d.jsxs)(mf,{children:[(0,$d.jsxs)("span",{className:"ab-who",children:[(0,$d.jsx)("span",{className:"ab-dot"}),"Inloggad som ",(0,$d.jsx)("b",{children:t})]}),(0,$d.jsx)("button",{className:"ab-out",onClick:r,children:"Logga ut"})]});return(0,$d.jsx)(mf,{children:(0,$d.jsxs)("form",{onSubmit:async function(e){e.preventDefault();const t=a.trim();if(t&&!l){c(!0);try{await fetch("/api/auth/request-magic-link",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t,dest:"portfolio"})}),s(!0)}catch{s(!0)}finally{c(!1)}}},children:[(0,$d.jsx)("div",{className:"ab-k",children:"Redan kund?"}),o?(0,$d.jsxs)("p",{className:"ab-msg",children:["Kolla er inkorg \u2014 en inloggningsl\xe4nk \xe4r p\xe5 v\xe4g till ",(0,$d.jsx)("b",{children:a.trim()}),". Den \xf6ppnar ert kontor p\xe5 vilken enhet som helst."]}):(0,$d.jsxs)($d.Fragment,{children:[(0,$d.jsx)("input",{type:"email",inputMode:"email",autoComplete:"email",placeholder:"Logga in med er f\xf6retagsmejl",value:a,onChange:e=>i(e.target.value),disabled:l}),(0,$d.jsx)("button",{className:"ab-in",type:"submit",disabled:l||!a.trim(),children:l?"Skickar\u2026":"Skicka l\xe4nk"})]})]})})}const gf=wd.font.mono,xf=wd.font.display,vf=jd`from { opacity:0; transform:translateY(22px); } to { opacity:1; transform:translateY(0); }`,bf=jd`to { transform: rotate(360deg); }`,yf=(jd`0%,100% { opacity:.25; } 50% { opacity:1; }`,jd`0%,100% { opacity:.6; } 50% { opacity:1; }`),kf=(jd`0% { background-position:-200% 0; } 100% { background-position:200% 0; }`,function(){return fd`opacity:0; animation:${vf} .7s ${arguments.length>0&&void 0!==arguments[0]?arguments[0]:0}s cubic-bezier(0.16,1,0.3,1) forwards;`}),jf=vd.main`
  min-height: 100vh;
...
`,Sf=(vd.div`
  ...
  font-family: ${gf}; font-size: 10px; letter-spacing: .26em; text-transform: uppercase;
...
`),$f=vd.div`
  .brand {
    font-family: ${gf}; font-size: 11px; font-weight: 600;
...
`,zf=vd.div`
  ...
  .disc .sweep {
    ...
    animation: ${bf} 3.2s linear infinite;
    mask: radial-gradient(circle, #000 62%, transparent 63%);
    -webkit-mask: radial-gradient(circle, #000 62%, transparent 63%);
  }
  .radar-title {
    font-family: ${gf}; font-size: 10px; letter-spacing: .22em; text-transform: uppercase;
  ...
  .rstat {
    ...
    span.v { font-family: ${gf}; color: ${wd.dossier.inkOnDark}; font-feature-settings:'tnum'; }
  }
  .radar-foot {
    ...
    .live { width: 7px; height: 7px; border-radius: 50%; background: ${wd.dossier.tealBright};
      box-shadow: ${wd.dossier.glow}; animation: ${yf} 2.4s ease-in-out infinite; }
  }
`,_f=vd.section`
  ...
  .eyebrow {
    font-family: ${gf}; font-size: 11px; letter-spacing: .26em; text-transform: uppercase;
...
`,Nf=vd.span`
  display: inline-flex; align-items: center; gap: 8px;
  font-family: ${gf}; font-size: 11px; letter-spacing: .04em;
...
`,Cf=vd.div`
  ...
  .card-eyebrow {
    font-family: ${gf}; font-size: 10px; letter-spacing: .24em; text-transform: uppercase;
...
`,Ff=vd(Cf)`
  ...
  .barrow {
    ...
    .amt { font-family: ${gf}; font-feature-settings:'tnum'; color: ${wd.dossier.inkOnDark};
      white-space: nowrap; }
...
`,Df=vd(Cf)`
  ...
  .idx-num {
    font-family: ${gf}; font-weight: 700; font-size: 72px; line-height: .9;
    letter-spacing: -.04em; font-feature-settings:'tnum';
    background: ${wd.dossier.numberGradient};
    -webkit-background-clip: text; background-clip: text; -webkit-text-fill-color: transparent;
  }
  .idx-denom { font-family: ${gf}; font-size: 22px; font-weight: 500; letter-spacing: -.02em;
    color: ${wd.dossier.faintOnDark}; padding-bottom: 8px; }
  .idx-delta {
    font-family: ${gf}; font-size: 13px; color: ${wd.dossier.tealBright};
  ...
  .mkt-k { font-family: ${gf}; font-size: 10px; letter-spacing: .18em; text-transform: uppercase;
  ...
  .mkt-scale { display: flex; justify-content: space-between;
    font-family: ${gf}; font-size: 9.5px; letter-spacing: .08em; text-transform: uppercase;
    color: ${wd.dossier.faintOnDark};
...
`,Tf=vd(Cf)`
  ...
  .cal-prob {
    font-family: ${gf}; font-size: 15px; font-weight: 600; font-feature-settings:'tnum';
  ...
  .cal-when {
    font-family: ${gf}; font-size: 11px; letter-spacing: .1em; text-transform: uppercase;
...
`,Pf=vd(Cf)`
  ...
  .rcpt .day { font-family: ${gf}; font-size: 11px; letter-spacing: .14em; text-transform: uppercase;
...
`,Of=vd(Cf)`
  ...
  .tally-k { font-family: ${gf}; font-size: 10px; letter-spacing: .24em; text-transform: uppercase;
...
`,Lf=vd.section`
  ...
  ${kf(.24)}
  .h-eyebrow { font-family: ${gf}; font-size: 10px; letter-spacing: .24em; text-transform: uppercase;
    color: ${wd.dossier.teal}; margin-bottom: 18px; }
  .h-row {
  ...
  .h-cost { font-family: ${gf}; font-size: 13.5px; color: ${wd.dossier.mutedOnDark};
    font-feature-settings:'tnum'; white-space: nowrap;
    @media (max-width:560px){ grid-column:2; grid-row:1; } }
  .h-state { font-family: ${gf}; font-size: 10.5px; letter-spacing: .1em; text-transform: uppercase;
...
`,Rf=vd.div`
  ...
  .mark { font-family: ${gf}; font-size: 11px; letter-spacing: .36em; text-indent: .36em;
    color: ${wd.dossier.faintOnDark}; }
...
`,Mf=vd.button`
  ...
  .h-badge { font-family:${gf}; font-size:13px; letter-spacing:.06em;
...
`,Bf=vd.div`
  ...
  span.v { position:absolute; inset:0; display:flex; align-items:center; justify-content:center;
    font-family:${gf}; font-size:15px; font-weight:700; font-feature-settings:'tnum'; }
`,Uf=vd.div`
  padding:6px 0 24px; animation:${vf} .28s ease both;
  display:flex; flex-direction:column; gap:18px;

  /* Arvo bedömer — bara omdömet (score-ringen bor i radhuvudet, ej dubblerad) */
  .diag { padding:0 2px; }
  .diag .dbody .dtop { font-family:${gf}; font-size:10px; letter-spacing:.18em; text-transform:uppercase;
  ...
  .fact { display:flex; justify-content:space-between; align-items:baseline; gap:14px;
    ...
    dd { font-family:${gf}; color:${wd.dossier.inkOnDark}; font-feature-settings:'tnum'; margin:0; } }
`,Vf=vd.div`
  ...
  .si-k { font-family:${gf}; font-size:10px; letter-spacing:.24em; text-transform:uppercase;
    color:${wd.dossier.teal}; margin-bottom:14px; }
  ...
  .si-n { flex-shrink:0; width:22px; height:22px; border-radius:50%;
    ...
    font-family:${gf}; font-size:11px; font-weight:600; display:flex; align-items:center; justify-content:center; }
  ...
  .si-offer { display:flex; align-items:baseline; gap:8px; margin-bottom:6px;
    ...
    .old { font-family:${gf}; font-size:13px; color:${wd.dossier.faintOnDark};
      text-decoration:line-through; }
    .arr { color:${wd.dossier.faintOnDark}; }
    .new { font-family:${gf}; font-size:20px; font-weight:700; font-feature-settings:'tnum';
      color:${wd.dossier.tealBright}; }
...
`,Hf=vd.div`
  ...
  ${kf(.1)}
  .iq-k { font-family:${gf}; font-size:10px; letter-spacing:.24em; text-transform:uppercase;
    color:${wd.dossier.teal}; margin-bottom:14px; }
  ...
  .iq-price { font-family:${gf}; font-size:19px; font-weight:600; letter-spacing:-.01em;
...
`,Wf=vd.div`
  ...
  animation:${bf} .8s linear infinite; margin:120px auto;
`,qf=vd.div`
  margin-top:34px; padding-top:28px; border-top:1px solid ${wd.dossier.hairlineOnDark};
  ${kf(.06)}
  .cm-eyebrow { font-family:${gf}; font-size:10px; letter-spacing:.24em; text-transform:uppercase;
    color:${wd.dossier.teal}; margin-bottom:16px; }
  ...
  .cm-tag { font-family:${gf}; font-size:8.5px; letter-spacing:.12em; text-transform:uppercase;
  ...
  .cm-verified { font-family:${gf}; font-size:9px; letter-spacing:.07em; text-transform:uppercase;
...
`,Yf=vd.div`
  ...
  .door-k { font-family:${gf}; font-size:10px; letter-spacing:.24em; text-transform:uppercase;
  ...
  .door .spacer { flex:1; }
`,Gf=vd.div`
  font-family:${gf}; font-size:14px; letter-spacing:.01em; color:${wd.dossier.tealBright};
...
`,Jf=vd.div`
  ...
  .dp-stat { font-family:${gf}; font-size:11px; letter-spacing:.06em; white-space:nowrap; }
...
`,Xf=vd.div`
  ...
  border-radius:${wd.size.radius.md}; ${kf(.18)}
