...
`,ij=vd.div`
  ...
  position: relative;
  animation: ${rj} 0.4s ease-out both;
...
`,gj=vd.div`
  ...
  align-items: flex-start;
  animation: ${rj} 0.4s ease-out both;
  animation-delay: ${e=>{let{$i:t}=e;return.15+.1*(null!==t&&void 0!==t?t:0)}}s;
`,xj=vd.span`
  color: #4ECDC4;
  font-size: 12px;
  flex-shrink: 0;
...
`,jj=vd.span`
  font-size: 14px;
  font-weight: 600;
  color: ${e=>{let{$highlight:t}=e;return t?"#4ECDC4":"rgba(255,255,255,0.82)"}};
  white-space: nowrap;
`,wj=vd.div`
  margin-bottom: 32px;
  animation: ${rj} 0.4s ease-out both;
...
`,Dj=vd.div`
  ...
  align-items: stretch;
  gap: 12px;
  animation: ${rj} 0.6s ease-out both;
...
`,Yj=vd.span`
  ...
  border-radius: 50%;
  background: #1DB09A;
  animation: ${nj} 1.2s ${e=>{let{$i:t}=e;return.18*t}}s ease-in-out infinite;
`,Gj=vd.p`
  font-size: 14px;
  color: rgba(255,255,255,0.28);
  margin: 0;
...
`,ew=vd.a`
  ...
  font-size: 14px;
  font-weight: 600;
`,tw=e=>null!=e?new Intl.NumberFormat("sv-SE",{maximumFractionDigits:0}).format(e):"\u2013",rw={microsoft365:"Microsoft 365",google:"Google Workspace",zoho:"Zoho Mail",other:"Anpassad e-postl\xf6sning"},nw=["januari","februari","mars","april","maj","juni","juli","augusti","september","oktober","november","december"];function aw(e){if(!e)return null;const[t,r]=e.split("-");return`${nw[parseInt(r)-1]} ${t}`}function iw(e){if(!e)return"";return new Date(e).toLocaleDateString("sv-SE",{day:"numeric",month:"long",year:"numeric"})}function ow(){var e,t,r;const{token:a}=ho(),[i,o]=(0,n.useState)("loading"),[l,s]=(0,n.useState)(null),[c,d]=(0,n.useState)(!1);(0,n.useEffect)(()=>{a?fetch(`/api/prospect?token=${encodeURIComponent(a)}`).then(e=>e.json()).then(e=>{e.ok?(s(e.prospect),o("ready")):o("error")}).catch(()=>o("error")):o("error")},[a]);const u=e=>{c||(d(!0),fetch(`/api/prospect?token=${encodeURIComponent(a)}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({action:e})}).catch(()=>{}))};if("loading"===i)return(0,$d.jsxs)(Wj,{children:[(0,$d.jsx)(qj,{children:[0,1,2].map(e=>(0,$d.jsx)(Yj,{$i:e},e))}),(0,$d.jsx)(Gj,{children:"H\xe4mtar er analys\u2026"})]});if("error"===i)return(0,$d.jsxs)(Qj,{children:[(0,$d.jsx)(Jj,{children:"\ud83d\udd12"}),(0,$d.jsx)(Xj,{children:"Analysen hittades inte"}),(0,$d.jsx)(Zj,{children:"L\xe4nken kan ha g\xe5tt ut eller \xe4r ogiltig. Analysera er faktura direkt \u2014 det tar 2 minuter."}),(0,$d.jsx)(ew,{href:"/testa-faktura",children:"Analysera en faktura \u2192"})]});const{companyName:p,industry:h,employees:f,estimates:m,generatedAt:g}=l,x=null!==(e=null===m||void 0===m?void 0:m.categories)&&void 0!==e?e:[],v=(null===m||void 0===m?void 0:m.hasEstimates)&&((null===m||void 0===m?void 0:m.totalSavingLow)>0||x.length>0),b=null===m||void 0===m?void 0:m.mxPlatform,y=null===m||void 0===m?void 0:m.mxSince,k=null===m||void 0===m?void 0:m.domainRegistered,j=null===m||void 0===m?void 0:m.foundedYear,w=null!==(t=null===m||void 0===m?void 0:m.findings)&&void 0!==t?t:[],S=($=y)?Math.round((Date.now()-new Date($).getTime())/2630016e3):0;var $;const z=null!==(r=rw[b])&&void 0!==r?r:b,E=w.length>0,_=[];w.forEach(e=>_.push({text:e,key:e})),!E&&y?_.push({text:`${z}-konfiguration of\xf6r\xe4ndrad sedan ${aw(y)} \u2014 ${S} m\xe5nader`,key:"mxSince"}):!E&&b&&_.push({text:`${z} identifierat f\xf6r er dom\xe4n \xb7 ${f} licenser i konsultbransch`,key:"mxPlatform"});const N=_.length>0,A=E?"IDENTIFIERADE SIGNALER":"INFRASTRUKTURANALYS";return(0,$d.jsxs)(aj,{children:[(0,$d.jsx)(ij,{children:(0,$d.jsxs)(oj,{children:[(0,$d.jsxs)(lj,{children:[(0,$d.jsx)(sj,{children:"KONFIDENTIELL ANALYS"}),(0,$d.jsx)(cj,{children:iw(g)})]}),(0,$d.jsx)(dj,{children:p}),(0,$d.jsxs)(uj,{children:[h&&(0,$d.jsx)("span",{children:h}),h&&f&&(0,$d.jsx)(pj,{children:"\xb7"}),f&&(0,$d.jsxs)("span",{children:[f," anst\xe4llda"]}),j&&(0,$d.jsxs)($d.Fragment,{children:[(0,$d.jsx)(pj,{children:"\xb7"}),(0,$d.jsxs)("span",{children:["Grundat ",j]})]})]})]})}),(0,$d.jsxs)(hj,{children:[N&&(0,$d.jsxs)(mj,{children:[(0,$d.jsx)(fj,{children:A}),_.map((e,t)=>(0,$d.jsxs)(gj,{$i:t,children:[(0,$d.jsx)(xj,{children:"\u2605"}),(0,$d.jsx)(vj,{children:e.text})]},e.key)),E&&(b||k)&&(0,$d.jsxs)(bj,{children:[b&&(0,$d.jsxs)(yj,{children:[(0,$d.jsx)(kj,{children:"E-postplattform"}),(0,$d.jsx)(jj,{children:z})]}),y&&(0,$d.jsxs)(yj,{children:[(0,$d.jsx)(kj,{children:"Konfiguration sedan"}),(0,$d.jsxs)(jj,{$highlight:!0,children:[aw(y)," \u2014 ",S," m\xe5n"]})]}),k&&(0,$d.jsxs)(yj,{children:[(0,$d.jsx)(kj,{children:"Dom\xe4n registrerad"}),(0,$d.jsx)(jj,{children:aw(k)})]})]})]}),v&&(0,$d.jsxs)(wj,{children:[(0,$d.jsx)(fj,{children:"BER\xc4KNAD KOSTNADSPREMIE"}),(0,$d.jsxs)(Sj,{children:[tw(m.totalSavingLow),"\u2013",tw(m.totalSavingHigh)," kr/\xe5r"]}),b&&f&&(0,$d.jsxs)($j,{children:["Baserat p\xe5 ",f," licenser \xd7 marknadspris ",z]}),(0,$d.jsx)(zj,{children:"Ert faktiska avtalspris ser vi inte f\xf6rr\xe4n ni delar er faktura"})]}),x.map((e,t)=>(0,$d.jsxs)(Ej,{children:[(0,$d.jsx)(_j,{children:e.label}),(0,$d.jsxs)(yj,{children:[(0,$d.jsx)(kj,{children:"m365"===e.category?"Uppskattade licenser":"Uppskattade abonnemang"}),(0,$d.jsxs)(jj,{children:[e.estimatedSims," st"]})]}),(0,$d.jsxs)(yj,{children:[(0,$d.jsx)(kj,{children:"Typisk marknadskostnad"}),(0,$d.jsxs)(jj,{children:[tw(e.typicalLow),"\u2013",tw(e.typicalHigh)," kr/\xe5r"]})]}),(0,$d.jsxs)(yj,{children:[(0,$d.jsx)(kj,{children:"Arvo-priset (verifierat listpris)"}),(0,$d.jsxs)(jj,{$highlight:!0,children:[tw(e.arvoAnnual)," kr/\xe5r"]})]}),(0,$d.jsxs)(yj,{children:[(0,$d.jsx)(kj,{children:"m365"===e.category?"Pris per licens":"Pris per abonnemang"}),(0,$d.jsxs)(jj,{children:[e.pricePerSim.arvo," kr/m\xe5n"," ",(0,$d.jsxs)("span",{style:{color:"rgba(255,255,255,0.20)",fontWeight:400,fontSize:12},children:["(typiskt ",e.pricePerSim.typical," kr/m\xe5n)"]})]})]}),(0,$d.jsxs)(Nj,{children:[(0,$d.jsx)(Aj,{children:"Potentiell besparing"}),(0,$d.jsxs)(Cj,{children:["upp till ",tw(e.savingHigh)," kr/\xe5r"]})]}),(0,$d.jsx)(Fj,{children:e.sourceNote})]},t)),(0,$d.jsxs)(Tj,{children:["Arvo har analyserat den publika DNS-konfigurationen f\xf6r ",p,"s dom\xe4n. Ingen data har inh\xe4mtats fr\xe5n er eller era leverant\xf6rer utan ert tillst\xe5nd. Er faktiska avtalskostnad k\xe4nner vi inte till f\xf6rr\xe4n ni visar oss er faktura."]}),(0,$d.jsx)(Vj,{}),(0,$d.jsxs)(Dj,{children:[(0,$d.jsxs)(Pj,{children:[(0,$d.jsx)(Lj,{href:"/testa-faktura",onClick:()=>u("upload"),children:"Verifiera er kostnad \u2014 ladda upp faktura"}),(0,$d.jsx)(Rj,{children:"Kostnadsfritt \xb7 2 minuter \xb7 Ingen registrering kr\xe4vs"})]}),(0,$d.jsx)(Oj,{}),(0,$d.jsxs)(Ij,{children:[(0,$d.jsx)(Bj,{href:"/intelligence#aktivera",onClick:()=>u("activate"),children:"Aktivera Arvo Intelligence \u2014 1 995 kr/m\xe5n"}),(0,$d.jsx)(Mj,{children:"L\xf6pande bevakning \xb7 Ingen bindningstid \xb7 Arvo b\xf6rjar bevaka er inom 24 timmar"})]})]})]}),(0,$d.jsxs)(Uj,{children:[(0,$d.jsx)(Kj,{children:"arvoflow.se"}),(0,$d.jsx)(Hj,{children:"ARVO INTELLIGENCE"})]})]})}"scrollRestoration"in window.history&&(window.history.scrollRestoration="manual");const lw=()=>{const{pathname:e}=so();return(0,n.useEffect)(()=>{window.scrollTo(0,0)},[e]),null},sw=()=>(0,$d.jsxs)(dd,{theme:wd,children:[(0,$d.jsx)(Sd,{}),(0,$d.jsx)(gl,{basename:"/flow",children:(0,$d.jsxs)(Nd,{children:[(0,$d.jsx)(lw,{}),(0,$d.jsxs)(Lo,{children:[(0,$d.jsx)(Do,{path:"/",element:(0,$d.jsx)(Kp,{})}),(0,$d.jsx)(Do,{path:"/connect",element:(0,$d.jsx)(xh,{})}),(0,$d.jsx)(Do,{path:"/scanning",element:(0,$d.jsx)(Ph,{})}),(0,$d.jsx)(Do,{path:"/insights",element:(0,$d.jsx)(bf,{})}),(0,$d.jsx)(Do,{path:"/opportunity/:id",element:(0,$d.jsx)(Yf,{})}),(0,$d.jsx)(Do,{path:"/bias",element:(0,$d.jsx)(dm,{})}),(0,$d.jsx)(Do,{path:"/villkor",element:(0,$d.jsx)(zm,{})}),(0,$d.jsx)(Do,{path:"/integritet",element:(0,$d.jsx)(Em,{})}),(0,$d.jsx)(Do,{path:"/cookies",element:(0,$d.jsx)(_m,{})}),(0,$d.jsx)(Do,{path:"/testa-faktura",element:(0,$d.jsx)(Ig,{})}),(0,$d.jsx)(Do,{path:"/portfolio",element:(0,$d.jsx)(Hx,{})}),(0,$d.jsx)(Do,{path:"/admin",element:(0,$d.jsx)(fv,{})}),(0,$d.jsx)(Do,{path:"/utfall",element:(0,$d.jsx)(zv,{})}),(0,$d.jsx)(Do,{path:"/arvo-score",element:(0,$d.jsx)(eb,{})}),(0,$d.jsx)(Do,{path:"/briefing/:token",element:(0,$d.jsx)(ly,{})}),(0,$d.jsx)(Do,{path:"/intelligence",element:(0,$d.jsx)(uk,{})}),(0,$d.jsx)(Do,{path:"/aktivera",element:(0,$d.jsx)(tj,{})}),(0,$d.jsx)(Do,{path:"/prospect/:token",element:(0,$d.jsx)(ow,{})}),(0,$d.jsx)(Do,{path:"*",element:(0,$d.jsx)(To,{to:"/",replace:!0})})]})]})})]});!function(){var e;const t={NODE_ENV:"production",PUBLIC_URL:"/flow",WDS_SOCKET_HOST:void 0,WDS_SOCKET_PATH:void 0,WDS_SOCKET_PORT:void 0,FAST_REFRESH:!0}.REACT_APP_SENTRY_DSN;t&&ri({dsn:t,environment:null!==(e="production")?e:"production",release:{NODE_ENV:"production",PUBLIC_URL:"/flow",WDS_SOCKET_HOST:void 0,WDS_SOCKET_PATH:void 0,WDS_SOCKET_PORT:void 0,FAST_REFRESH:!0}.REACT_APP_VERSION,tracesSampleRate:.1,beforeSend(e){var t,r,n,a;const i=null!==(t=null===(r=e.exception)||void 0===r||null===(n=r.values)||void 0===n||null===(a=n[0])||void 0===a?void 0:a.value)&&void 0!==t?t:"";return i.includes("Network request failed")||i.includes("Load failed")?null:e}})}();(0,i.createRoot)(document.getElementById("root")).render((0,$d.jsx)(sw,{}))})();
//# sourceMappingURL=main.4be29826.js.map