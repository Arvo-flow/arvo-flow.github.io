/*! For license information please see main.4af173e7.js.LICENSE.txt */
...
`;function Lm(e){let{finding:t,extraCount:r=0,variant:a="light",eyebrow:i}=e;const[o,s]=(0,n.useState)(!1),[l,d]=(0,n.useState)(!1);if(!t||!t.title)return null;const c="watch"===t.tone?"watch":"leak",u=null!==i&&void 0!==i?i:"watch"===c?"Avtalsbevakning":"dossier"===a?"Fynd p\xe5 era fakturor":"Fynd p\xe5 er faktura",p=t.annualImpact>0;return(0,$c.jsxs)(Pm,{$variant:a,$tone:c,children:[(0,$c.jsx)("div",{className:"fc-eyebrow",children:u}),(0,$c.jsxs)("div",{className:"fc-row",children:[(0,$c.jsx)("div",{className:"fc-title",children:t.title}),p?(0,$c.jsxs)("div",{className:"fc-impact",children:[Om(t.annualImpact)," kr/\xe5r"]}):t.metricText?(0,$c.jsx)("div",{className:"fc-impact",children:t.metricText}):null]}),t.lineDescription&&(0,$c.jsxs)("div",{className:"fc-line",children:["\u201d",t.lineDescription,"\u201d"]}),t.overpaidToDate>0&&(0,$c.jsxs)("div",{className:"fc-claim",children:[(0,$c.jsx)("span",{className:"fc-claim-k",children:"Att beg\xe4ra tillbaka"}),(0,$c.jsxs)("span",{className:"fc-claim-v",children:[Om(t.overpaidToDate)," kr"]}),t.letter&&(0,$c.jsx)("button",{type:"button",className:"fc-claim-b",onClick:()=>{var e;o?null===(e=navigator.clipboard)||void 0===e||e.writeText(`${t.letter.subject}\n\n${t.letter.body}`).then(()=>{d(!0),setTimeout(()=>d(!1),2200)}).catch(()=>{}):s(!0)},children:o?l?"Kopierat \u2713":"Kopiera brevet":"Vi skrev brevet \u2192"})]}),o&&t.letter&&(0,$c.jsxs)("div",{className:"fc-letter",children:[t.letter.subject,"\n\n",t.letter.body]}),(0,$c.jsx)("p",{className:"fc-text",children:t.text}),r>0&&(0,$c.jsxs)("p",{className:"fc-more",children:[(0,$c.jsxs)("strong",{children:["+",r," fler fynd"]})," p\xe5 fakturan \u2014 vi g\xe5r igenom dem i er genomg\xe5ng."]})]})}const Rm=jc`
  from { opacity: 0; transform: translateY(14px); }
  to { opacity: 1; transform: translateY(0); }
`,Im=jc`
...
//# sourceMappingURL=main.4af173e7.js.map