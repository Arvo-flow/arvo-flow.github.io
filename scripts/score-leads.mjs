...
import { getDnsPosture, getDomainRegistered, getCtOnboarding } from '../lib/domain-intel.js';
...
// DNS/RDAP/crt.sh-logiken bor nu i lib/domain-intel.js (regel 1 — EN sanning,
// delad med api/reveal). getDnsPosture/getDomainRegistered/getCtOnboarding importeras ovan.
