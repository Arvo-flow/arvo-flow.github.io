// scripts/mock-landing-salj-v3.mjs — DESIGNMOCKUP v3: dossiern som FÖREMÅL (grundarens spaltkritik: mörkret var full-bleed medan heron var smal — nu ligger rummet som ett mörkt objekt PÅ sidan, i samma spalt). Lärdomar ur v1-kritiken:
...
mkdirSync('/tmp/landing-salj-v3', { recursive: true });
...
for (const [w, tag] of [[390, 'mobil'], [1600, 'desktop']]) {
  ...
  await p.screenshot({ path: `/tmp/landing-salj-v3/${tag}.png`, fullPage: true });
  console.log('✓', tag);
}
await b.close();
